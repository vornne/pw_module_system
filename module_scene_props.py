...
scene_props = [
  ...
  ("interior_castle_x",0,"interior_castle_y","bo_interior_castle_x", []),
  ("interior_castle_y",0,"interior_castle_x","bo_interior_castle_y", []),
  ...
  ("pw_tree_e1",spr_tree_flags(),"tree_e_1","bo_tree_e_1_fixed", spr_tree_triggers(full_hp=2500, fell_hp=1200, resource_imod=imod_battered)),
  ("pw_tree_e2",spr_tree_flags(),"tree_e_2","bo_tree_e_2_fixed", spr_tree_triggers(full_hp=2100, fell_hp=800, resource_imod=imod_battered)),
  ("pw_tree_e3",spr_tree_flags(),"tree_e_3","bo_tree_e_3_fixed", spr_tree_triggers(full_hp=2300, fell_hp=900, resource_imod=imod_battered)),
  ...
  ("pw_tree_2a",spr_tree_flags(),"tree_2_a","bo_tree_1_a_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_2b",spr_tree_flags(),"tree_2_b","bo_tree_1_b_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ...
  ("pw_tree_8a",spr_tree_flags(),"tree_8_a","bo_tree_8_a_fixed", spr_tree_triggers(full_hp=2400, fell_hp=1800, resource_imod=imod_battered)),
  ("pw_tree_8b",spr_tree_flags(),"tree_8_b","bo_tree_8_b_fixed", spr_tree_triggers(full_hp=2700, fell_hp=1700, resource_imod=imod_battered)),
  ("pw_tree_8c",spr_tree_flags(),"tree_8_c","bo_tree_8_c_fixed", spr_tree_triggers(full_hp=2600, fell_hp=1300, resource_imod=imod_battered)),
  ...
  ("pw_stockpile_salt_sack",spr_use_time(1),"pw_salt_sack","bo_weapon_small", spr_stockpile_resource_triggers("itm_salt_sack")),
  ("pw_stockpile_salted_fish",spr_use_time(1),"pw_fish","bo_weapon_small", spr_stockpile_resource_triggers("itm_salted_fish")),
  ("pw_stockpile_salted_meat",spr_use_time(1),"pw_meat_salted","bo_weapon", spr_stockpile_resource_triggers("itm_salted_meat")),
  ...
  ("pw_export_salt_sack",spr_use_time(8),"pw_salt_sack","bo_weapon_small", spr_export_item_triggers("itm_salt_sack")),
  ("pw_export_salted_fish",spr_use_time(5),"pw_fish","bo_weapon_small", spr_export_item_triggers("itm_salted_fish")),
  ("pw_export_salted_meat",spr_use_time(7),"pw_meat_salted","bo_weapon_small", spr_export_item_triggers("itm_salted_meat")),
  ...
  ("pw_process_preserve",spr_use_time(10),"table_small","bo_table_small", spr_process_resource_triggers("script_cf_process_preserve", use_string="str_process_preserve")),
  ...
  ("pw_buy_straw_hat",spr_buy_item_flags(3),"straw_hat_new","bo_armor_head", spr_buy_item_triggers("itm_straw_hat", resources=["itm_wheat_sheaf"], tailoring=1)),
  ("pw_buy_head_wrappings",spr_buy_item_flags(1),"head_wrapping","bo_armor_head", spr_buy_item_triggers("itm_head_wrappings", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_headcloth",spr_buy_item_flags(2),"headcloth_a_new","bo_armor_head", spr_buy_item_triggers("itm_headcloth", resources=["itm_linen_cloth_small"], tailoring=1, tableau="tableau_colored_helmets_new_d")),
  ("pw_buy_woolen_cap",spr_buy_item_flags(3),"woolen_cap_new","bo_armor_head", spr_buy_item_triggers("itm_woolen_cap", resources=["itm_linen_cloth_small"], tailoring=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_sarranid_felt_hat",spr_buy_item_flags(4),"sar_helmet3","bo_armor_head", spr_buy_item_triggers("itm_sarranid_felt_hat", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_sarranid_felt_head_cloth",spr_buy_item_flags(4),"common_tulbent","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_sarranid_felt_head_cloth_b",spr_buy_item_flags(4),"common_tulbent_b","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth_b", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_bride_crown",spr_buy_item_flags(7),"bride_crown","bo_armor_head_armature", spr_buy_item_triggers("itm_bride_crown", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_khergit_lady_hat",spr_buy_item_flags(5),"khergit_lady_hat","bo_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_khergit_lady_hat_b",spr_buy_item_flags(5),"khergit_lady_hat_b","bo_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat_b", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_sarranid_head_cloth",spr_buy_item_flags(2),"tulbent","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_sarranid_head_cloth_b",spr_buy_item_flags(2),"tulbent_b","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth_b", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_wimple_a",spr_buy_item_flags(4),"wimple_a_new","bo_armor_head", spr_buy_item_triggers("itm_wimple_a", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_wimple_b",spr_buy_item_flags(4),"wimple_b_new","bo_armor_head", spr_buy_item_triggers("itm_wimple_b", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_barbette",spr_buy_item_flags(4),"barbette_new","bo_armor_head", spr_buy_item_triggers("itm_barbette", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_arming_cap",spr_buy_item_flags(4),"arming_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_arming_cap", resources=["itm_linen_cloth_small"], tailoring=1, tableau="tableau_colored_helmets_new_d")),
  ("pw_buy_ladys_hood",spr_buy_item_flags(3),"ladys_hood_new","bo_armor_head", spr_buy_item_triggers("itm_ladys_hood", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_fur_hat",spr_buy_item_flags(5),"fur_hat_a_new","bo_armor_head", spr_buy_item_triggers("itm_fur_hat", resources=["itm_leather_piece"], tailoring=1)),
  ("pw_buy_felt_hat",spr_buy_item_flags(4),"felt_hat_a_new","bo_armor_head", spr_buy_item_triggers("itm_felt_hat", resources=["itm_linen_cloth_small"], tailoring=1, tableau="tableau_colored_helmets_new_b")),
  ("pw_buy_felt_hat_b",spr_buy_item_flags(5),"felt_hat_b_new","bo_armor_head", spr_buy_item_triggers("itm_felt_hat_b", resources=["itm_linen_cloth_small"], tailoring=2, tableau="tableau_colored_helmets_new_b")),
  ("pw_buy_leather_cap",spr_buy_item_flags(7),"leather_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_leather_cap", resources=["itm_leather_piece"], tailoring=2)),
  ("pw_buy_common_hood",spr_buy_item_flags(4),"hood_new","bo_armor_head", spr_buy_item_triggers("itm_common_hood", resources=["itm_linen_cloth_small"], tailoring=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_hood_b",spr_buy_item_flags(4),"hood_b","bo_armor_head", spr_buy_item_triggers("itm_hood_b", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_hood_c",spr_buy_item_flags(4),"hood_c","bo_armor_head", spr_buy_item_triggers("itm_hood_c", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_hood_d",spr_buy_item_flags(4),"hood_d","bo_armor_head", spr_buy_item_triggers("itm_hood_d", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_nomad_cap",spr_buy_item_flags(8),"nomad_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_nomad_cap", resources=["itm_iron_piece","itm_leather_piece"], tailoring=2, engineer=2)),
  ("pw_buy_nomad_cap_b",spr_buy_item_flags(7),"nomad_cap_b_new","bo_armor_head", spr_buy_item_triggers("itm_nomad_cap_b", resources=["itm_leather_piece"], tailoring=2)),
  ("pw_buy_black_hood",spr_buy_item_flags(5),"hood_black","bo_armor_head", spr_buy_item_triggers("itm_black_hood", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_pilgrim_hood",spr_buy_item_flags(4),"pilgrim_hood","bo_armor_head", spr_buy_item_triggers("itm_pilgrim_hood", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_padded_coif",spr_buy_item_flags(8),"padded_coif_a_new","bo_armor_head", spr_buy_item_triggers("itm_padded_coif", resources=["itm_linen_cloth_small"], tailoring=2, tableau="tableau_colored_helmets_new_b")),
  ("pw_buy_turban",spr_buy_item_flags(4),"tuareg_open","bo_armor_head", spr_buy_item_triggers("itm_turban", resources=[("itm_linen_cloth_small", 2)], tailoring=1)),
  ("pw_buy_leather_steppe_cap_a",spr_buy_item_flags(5),"leather_steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_a", resources=["itm_leather_piece"], tailoring=2)),
  ("pw_buy_leather_steppe_cap_b",spr_buy_item_flags(6),"tattered_steppe_cap_b_new","bo_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_b", resources=["itm_leather_piece","itm_iron_piece"], tailoring=2, engineer=2)),
  ("pw_buy_nordic_archer_helmet",spr_buy_item_flags(8),"Helmet_A_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_archer_helmet", resources=["itm_leather_piece","itm_iron_piece"], engineer=2)),
  ("pw_buy_vaegir_fur_cap",spr_buy_item_flags(8),"vaeg_helmet3","bo_armor_head", spr_buy_item_triggers("itm_vaegir_fur_cap", resources=["itm_leather_piece","itm_iron_piece"], engineer=2)),
  ("pw_buy_steppe_cap",spr_buy_item_flags(8),"steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_steppe_cap", resources=["itm_leather_piece","itm_iron_piece"], engineer=2)),
  ("pw_buy_leather_warrior_cap",spr_buy_item_flags(9),"skull_cap_new_b","bo_armor_head", spr_buy_item_triggers("itm_leather_warrior_cap", resources=["itm_leather_piece"], engineer=2, tailoring=3)),
  ("pw_buy_sarranid_warrior_cap",spr_buy_item_flags(7),"tuareg_helmet","bo_armor_head", spr_buy_item_triggers("itm_sarranid_warrior_cap", resources=["itm_iron_piece","itm_linen_cloth_small"], engineer=2)),
  ("pw_buy_nordic_veteran_archer_helmet",spr_buy_item_flags(9),"Helmet_A","bo_armor_head", spr_buy_item_triggers("itm_nordic_veteran_archer_helmet", resources=["itm_iron_piece","itm_leather_piece"], engineer=2)),
  ("pw_buy_skullcap",spr_buy_item_flags(10),"skull_cap_new_a","bo_armor_head", spr_buy_item_triggers("itm_skullcap", resources=["itm_iron_piece","itm_leather_piece"], engineer=2)),
  ("pw_buy_vaegir_fur_helmet",spr_buy_item_flags(10),"vaeg_helmet2","bo_armor_head", spr_buy_item_triggers("itm_vaegir_fur_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=2)),
  ("pw_buy_mail_coif",spr_buy_item_flags(12),"mail_coif_new","bo_armor_head", spr_buy_item_triggers("itm_mail_coif", resources=["itm_iron_piece"], engineer=3)),
  ("pw_buy_footman_helmet",spr_buy_item_flags(10),"skull_cap_new","bo_armor_head", spr_buy_item_triggers("itm_footman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=2)),
  ("pw_buy_sarranid_horseman_helmet",spr_buy_item_flags(13),"sar_helmet2","bo_armor_head", spr_buy_item_triggers("itm_sarranid_horseman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=3)),
  ("pw_buy_norman_helmet",spr_buy_item_flags(10),"norman_helmet_a","bo_armor_head", spr_buy_item_triggers("itm_norman_helmet", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=2)),
  ("pw_buy_nordic_footman_helmet",spr_buy_item_flags(14),"Helmet_B_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_footman_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=3)),
  ("pw_buy_khergit_war_helmet",spr_buy_item_flags(15),"tattered_steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_khergit_war_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=3)),
  ("pw_buy_segmented_helmet",spr_buy_item_flags(14),"segmented_helm_new","bo_armor_head", spr_buy_item_triggers("itm_segmented_helmet", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=3)),
  ("pw_buy_vaegir_spiked_helmet",spr_buy_item_flags(16),"vaeg_helmet1","bo_armor_head", spr_buy_item_triggers("itm_vaegir_spiked_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("pw_buy_helmet_with_neckguard",spr_buy_item_flags(13),"neckguard_helm_new","bo_armor_head", spr_buy_item_triggers("itm_helmet_with_neckguard", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=3)),
  ("pw_buy_flat_topped_helmet",spr_buy_item_flags(16),"flattop_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_flat_topped_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("pw_buy_nordic_fighter_helmet",spr_buy_item_flags(17),"Helmet_B","bo_armor_head", spr_buy_item_triggers("itm_nordic_fighter_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("pw_buy_kettle_hat",spr_buy_item_flags(18),"kettle_hat_new","bo_armor_head", spr_buy_item_triggers("itm_kettle_hat", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("pw_buy_sarranid_helmet1",spr_buy_item_flags(15),"sar_helmet1","bo_armor_head", spr_buy_item_triggers("itm_sarranid_helmet1", resources=["itm_iron_bar_short","itm_linen_cloth_small"], engineer=4)),
  ("pw_buy_vaegir_lamellar_helmet",spr_buy_item_flags(18),"vaeg_helmet4","bo_armor_head", spr_buy_item_triggers("itm_vaegir_lamellar_helmet", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=4)),
  ("pw_buy_spiked_helmet",spr_buy_item_flags(19),"spiked_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_spiked_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=4)),
  ("pw_buy_sarranid_mail_coif",spr_buy_item_flags(17),"tuareg_helmet2","bo_armor_head", spr_buy_item_triggers("itm_sarranid_mail_coif", resources=["itm_iron_bar_short","itm_iron_piece","itm_linen_cloth_small"], engineer=4)),
  ("pw_buy_nordic_huscarl_helmet",spr_buy_item_flags(21),"Helmet_C_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_huscarl_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=5)),
  ("pw_buy_bascinet",spr_buy_item_flags(23),"bascinet_avt_new","bo_armor_head", spr_buy_item_triggers("itm_bascinet", resources=["itm_iron_bar_short","itm_leather_piece"], engineer=5)),
  ("pw_buy_bascinet_2",spr_buy_item_flags(23),"bascinet_new_a","bo_armor_head", spr_buy_item_triggers("itm_bascinet_2", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_bascinet_3",spr_buy_item_flags(23),"bascinet_new_b","bo_armor_head", spr_buy_item_triggers("itm_bascinet_3", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_vaegir_noble_helmet",spr_buy_item_flags(25),"vaeg_helmet7","bo_armor_head", spr_buy_item_triggers("itm_vaegir_noble_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=5)),
  ("pw_buy_guard_helmet",spr_buy_item_flags(24),"reinf_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_guard_helmet", resources=["itm_iron_bar_short","itm_iron_piece"], engineer=5)),
  ("pw_buy_sarranid_veiled_helmet",spr_buy_item_flags(25),"sar_helmet4","bo_armor_head", spr_buy_item_triggers("itm_sarranid_veiled_helmet", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_vaegir_war_helmet",spr_buy_item_flags(24),"vaeg_helmet6","bo_armor_head", spr_buy_item_triggers("itm_vaegir_war_helmet", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_nordic_warlord_helmet",spr_buy_item_flags(26),"Helmet_C","bo_armor_head", spr_buy_item_triggers("itm_nordic_warlord_helmet", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_full_helm",spr_buy_item_flags(27),"great_helmet_new_b","bo_armor_head", spr_buy_item_triggers("itm_full_helm", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("pw_buy_vaegir_mask",spr_buy_item_flags(28),"vaeg_helmet8","bo_armor_head", spr_buy_item_triggers("itm_vaegir_mask", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("pw_buy_vaegir_mask_b",spr_buy_item_flags(29),"vaeg_helmet9","bo_armor_head", spr_buy_item_triggers("itm_vaegir_mask_b", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ("pw_buy_great_helmet",spr_buy_item_flags(30),"great_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_great_helmet", resources=["itm_iron_bar"], engineer=6)),
  ("pw_buy_winged_great_helmet",spr_buy_item_flags(32),"maciejowski_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_winged_great_helmet", resources=["itm_iron_bar","itm_iron_bar_short"], engineer=6)),
  ("pw_buy_black_helmet",spr_buy_item_flags(30),"black_helm","bo_armor_head", spr_buy_item_triggers("itm_black_helmet", resources=["itm_iron_bar"], engineer=6)),

  ("pw_buy_shirt",spr_buy_item_flags(3),"shirt","bo_armor_body", spr_buy_item_triggers("itm_shirt", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_linen_tunic",spr_buy_item_flags(5),"shirt_a","bo_armor_body", spr_buy_item_triggers("itm_linen_tunic", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_black_robe",spr_buy_item_flags(7),"robe","bo_armor_body", spr_buy_item_triggers("itm_black_robe", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_dress",spr_buy_item_flags(8),"dress","bo_armor_body", spr_buy_item_triggers("itm_dress", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_blue_dress",spr_buy_item_flags(8),"blue_dress_new","bo_armor_body", spr_buy_item_triggers("itm_blue_dress", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_peasant_dress",spr_buy_item_flags(8),"peasant_dress_b_new","bo_armor_body", spr_buy_item_triggers("itm_peasant_dress", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_woolen_dress",spr_buy_item_flags(8),"woolen_dress","bo_armor_body", spr_buy_item_triggers("itm_woolen_dress", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_sarranid_common_dress",spr_buy_item_flags(6),"sarranid_common_dress","bo_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_sarranid_common_dress_b",spr_buy_item_flags(6),"sarranid_common_dress_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress_b", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_lady_dress_ruby",spr_buy_item_flags(13),"lady_dress_r","bo_armor_body", spr_buy_item_triggers("itm_lady_dress_ruby", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_lady_dress_green",spr_buy_item_flags(13),"lady_dress_g","bo_armor_body", spr_buy_item_triggers("itm_lady_dress_green", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_lady_dress_blue",spr_buy_item_flags(13),"lady_dress_b","bo_armor_body", spr_buy_item_triggers("itm_lady_dress_blue", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_court_dress",spr_buy_item_flags(14),"court_dress","bo_armor_body", spr_buy_item_triggers("itm_court_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_red_dress",spr_buy_item_flags(12),"red_dress","bo_armor_body", spr_buy_item_triggers("itm_red_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_brown_dress",spr_buy_item_flags(12),"brown_dress","bo_armor_body", spr_buy_item_triggers("itm_brown_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_green_dress",spr_buy_item_flags(12),"green_dress","bo_armor_body", spr_buy_item_triggers("itm_green_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_sarranid_lady_dress",spr_buy_item_flags(11),"sarranid_lady_dress","bo_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_sarranid_lady_dress_b",spr_buy_item_flags(11),"sarranid_lady_dress_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress_b", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_khergit_lady_dress",spr_buy_item_flags(16),"khergit_lady_dress","bo_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_khergit_lady_dress_b",spr_buy_item_flags(18),"khergit_lady_dress_b","bo_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress_b", resources=["itm_leather_roll"], tailoring=2)),
  ("pw_buy_bride_dress",spr_buy_item_flags(26),"bride_dress","bo_armor_body", spr_buy_item_triggers("itm_bride_dress", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_tunic_with_green_cape",spr_buy_item_flags(10),"peasant_man_a","bo_armor_body", spr_buy_item_triggers("itm_tunic_with_green_cape", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_rough_tunic",spr_buy_item_flags(7),"cvl_costume_a","bo_armor_body", spr_buy_item_triggers("itm_rough_tunic", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_red_shirt",spr_buy_item_flags(9),"rich_tunic_a","bo_armor_body", spr_buy_item_triggers("itm_red_shirt", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_pelt_coat",spr_buy_item_flags(6),"thick_coat_a","bo_armor_body", spr_buy_item_triggers("itm_pelt_coat", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_sarranid_cloth_robe",spr_buy_item_flags(5),"sar_robe","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_sarranid_cloth_robe_b",spr_buy_item_flags(5),"sar_robe_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe_b", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_rawhide_coat",spr_buy_item_flags(7),"coat_of_plates_b","bo_armor_body", spr_buy_item_triggers("itm_rawhide_coat", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_coarse_tunic",spr_buy_item_flags(6),"coarse_tunic_a","bo_armor_body", spr_buy_item_triggers("itm_coarse_tunic", resources=["itm_linen_cloth"], tailoring=1)),
  ("pw_buy_leather_apron",spr_buy_item_flags(7),"leather_apron","bo_armor_body", spr_buy_item_triggers("itm_leather_apron", resources=[("itm_leather_piece",2),"itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_fur_coat",spr_buy_item_flags(8),"fur_coat","bo_armor_body", spr_buy_item_triggers("itm_fur_coat", resources=["itm_leather_roll"], tailoring=2)),
  ("pw_buy_skirmisher_armor",spr_buy_item_flags(9),"skirmisher_armor","bo_armor_body", spr_buy_item_triggers("itm_skirmisher_armor", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_rich_outfit",spr_buy_item_flags(12),"merchant_outf","bo_armor_body", spr_buy_item_triggers("itm_rich_outfit", resources=["itm_linen_cloth"], tailoring=2)),
  ("pw_buy_tabard",spr_buy_item_flags(10),"tabard_b","bo_armor_body", spr_buy_item_triggers("itm_tabard", resources=["itm_linen_cloth"], tailoring=2, tableau="tableau_heraldic_tabard_b")),
  ("pw_buy_khergit_armor",spr_buy_item_flags(9),"khergit_armor_new","bo_armor_body", spr_buy_item_triggers("itm_khergit_armor", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=1)),
  ("pw_buy_leather_vest",spr_buy_item_flags(13),"leather_vest_a","bo_armor_body", spr_buy_item_triggers("itm_leather_vest", resources=["itm_leather_roll"], tailoring=2, tableau="tableau_heraldic_leather_vest_a")),
  ("pw_buy_leather_jacket",spr_buy_item_flags(15),"leather_jacket_new","bo_armor_body", spr_buy_item_triggers("itm_leather_jacket", resources=["itm_leather_roll"], tailoring=2)),
  ("pw_buy_arena_tunic",spr_buy_item_flags(12),"arena_tunicW_new","bo_armor_body", spr_buy_item_triggers("itm_arena_tunic", resources=["itm_linen_cloth"], tailoring=2, tableau="tableau_colored_arena_tunic")),
  ("pw_buy_steppe_armor",spr_buy_item_flags(14),"lamellar_leather","bo_armor_body", spr_buy_item_triggers("itm_steppe_armor", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=2, engineer=2, tableau="tableau_colored_lamellar_leather")),
  ("pw_buy_leather_armor",spr_buy_item_flags(15),"tattered_leather_armor_a","bo_armor_body", spr_buy_item_triggers("itm_leather_armor", resources=["itm_leather_roll","itm_linen_cloth_small","itm_iron_piece"], engineer=2)),
  ("pw_buy_pilgrim_disguise",spr_buy_item_flags(12),"pilgrim_outfit","bo_armor_body", spr_buy_item_triggers("itm_pilgrim_disguise", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=1)),
  ("pw_buy_red_gambeson",spr_buy_item_flags(16),"red_gambeson_a","bo_armor_body", spr_buy_item_triggers("itm_red_gambeson", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3, engineer=2)),
  ("pw_buy_padded_cloth",spr_buy_item_flags(15),"padded_cloth_a","bo_armor_body", spr_buy_item_triggers("itm_padded_cloth", resources=["itm_linen_cloth"], tailoring=3, engineer=2, tableau="tableau_heraldic_padded_cloth_a")),
  ("pw_buy_aketon_green",spr_buy_item_flags(15),"padded_cloth_b","bo_armor_body", spr_buy_item_triggers("itm_aketon_green", resources=["itm_linen_cloth"], tailoring=3, engineer=2, tableau="tableau_heraldic_padded_cloth_b")),
  ("pw_buy_archers_vest",spr_buy_item_flags(14),"archers_vest","bo_armor_body", spr_buy_item_triggers("itm_archers_vest", resources=["itm_linen_cloth"], tailoring=2, engineer=2)),
  ("pw_buy_nomad_vest",spr_buy_item_flags(14),"nomad_vest_new","bo_armor_body", spr_buy_item_triggers("itm_nomad_vest", resources=["itm_leather_roll"], tailoring=3, engineer=2)),
  ("pw_buy_ragged_outfit",spr_buy_item_flags(11),"ragged_outfit_a_new","bo_armor_body", spr_buy_item_triggers("itm_ragged_outfit", resources=["itm_linen_cloth"], tailoring=2, engineer=2)),
  ("pw_buy_nomad_armor",spr_buy_item_flags(15),"nomad_armor_new","bo_armor_body", spr_buy_item_triggers("itm_nomad_armor", resources=["itm_leather_roll"], tailoring=2, engineer=2)),
  ("pw_buy_nomad_robe",spr_buy_item_flags(17),"nomad_robe_a","bo_armor_body", spr_buy_item_triggers("itm_nomad_robe", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3, engineer=2)),
  ("pw_buy_light_leather",spr_buy_item_flags(18),"light_leather","bo_armor_body", spr_buy_item_triggers("itm_light_leather", resources=["itm_leather_roll"], tailoring=3, engineer=2)),
  ("pw_buy_leather_jerkin",spr_buy_item_flags(17),"ragged_leather_jerkin","bo_armor_body", spr_buy_item_triggers("itm_leather_jerkin", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=3, engineer=2)),
  ("pw_buy_padded_leather",spr_buy_item_flags(18),"leather_armor_b","bo_armor_body", spr_buy_item_triggers("itm_padded_leather", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=3, engineer=2)),
  ("pw_buy_arena_armor",spr_buy_item_flags(19),"arena_armorW_new","bo_armor_body", spr_buy_item_triggers("itm_arena_armor", resources=["itm_linen_cloth","itm_iron_bar_short"], engineer=2, tableau="tableau_colored_arena_armor")),
  ("pw_buy_tribal_warrior_outfit",spr_buy_item_flags(17),"tribal_warrior_outfit_a_new","bo_armor_body", spr_buy_item_triggers("itm_tribal_warrior_outfit", resources=["itm_leather_roll"], tailoring=3, engineer=3)),
  ("pw_buy_sarranid_leather_armor",spr_buy_item_flags(21),"sarranid_leather_armor","bo_armor_body", spr_buy_item_triggers("itm_sarranid_leather_armor", resources=["itm_leather_roll"], engineer=3)),
  ("pw_buy_courtly_outfit",spr_buy_item_flags(20),"nobleman_outf","bo_armor_body", spr_buy_item_triggers("itm_courtly_outfit", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3)),
  ("pw_buy_nobleman_outfit",spr_buy_item_flags(23),"nobleman_outfit_b_new","bo_armor_body", spr_buy_item_triggers("itm_nobleman_outfit", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=3)),
  ("pw_buy_sarranid_cavalry_robe",spr_buy_item_flags(20),"arabian_armor_a","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cavalry_robe", resources=["itm_linen_cloth","itm_iron_bar_short"], engineer=3)),
  ("pw_buy_studded_leather_coat",spr_buy_item_flags(21),"leather_armor_a","bo_armor_body", spr_buy_item_triggers("itm_studded_leather_coat", resources=["itm_leather_roll","itm_linen_cloth_small","itm_iron_bar_short"], engineer=3)),
  ("pw_buy_byrnie",spr_buy_item_flags(23),"byrnie_a_new","bo_armor_body", spr_buy_item_triggers("itm_byrnie", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=3)),
  ("pw_buy_haubergeon",spr_buy_item_flags(24),"haubergeon_c","bo_armor_body", spr_buy_item_triggers("itm_haubergeon", resources=[("itm_iron_bar_short",2)], engineer=3)),
  ("pw_buy_arabian_armor_b",spr_buy_item_flags(23),"arabian_armor_b","bo_armor_body", spr_buy_item_triggers("itm_arabian_armor_b", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], engineer=4)),
  ("pw_buy_lamellar_vest",spr_buy_item_flags(20),"lamellar_vest_a","bo_armor_body", spr_buy_item_triggers("itm_lamellar_vest", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=4)),
  ("pw_buy_lamellar_vest_khergit",spr_buy_item_flags(21),"lamellar_vest_b","bo_armor_body", spr_buy_item_triggers("itm_lamellar_vest_khergit", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=4, tableau="tableau_colored_lamellar_vest_b")),
  ("pw_buy_mail_shirt",spr_buy_item_flags(24),"mail_shirt_a","bo_armor_body", spr_buy_item_triggers("itm_mail_shirt", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=4)),
  ("pw_buy_mail_hauberk",spr_buy_item_flags(25),"hauberk_a_new","bo_armor_body", spr_buy_item_triggers("itm_mail_hauberk", resources=[("itm_iron_bar_short",2)], engineer=4)),
  ("pw_buy_sarranid_mail_shirt",spr_buy_item_flags(26),"sarranian_mail_shirt","bo_armor_body", spr_buy_item_triggers("itm_sarranid_mail_shirt", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=5)),
  ("pw_buy_mail_with_surcoat",spr_buy_item_flags(23),"mail_long_surcoat_new","bo_armor_body", spr_buy_item_triggers("itm_mail_with_surcoat", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=5, tableau="tableau_heraldic_mail_long_surcoat")),
  ("pw_buy_surcoat_over_mail",spr_buy_item_flags(24),"surcoat_over_mail_new","bo_armor_body", spr_buy_item_triggers("itm_surcoat_over_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=5, tableau="tableau_heraldic_surcoat_over_mail")),
  ("pw_buy_brigandine_red",spr_buy_item_flags(28),"brigandine_b","bo_armor_body", spr_buy_item_triggers("itm_brigandine_red", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], engineer=6, tableau="tableau_heraldic_brigandine_b")),
  ("pw_buy_mamluke_mail",spr_buy_item_flags(29),"sarranid_elite_cavalary","bo_armor_body", spr_buy_item_triggers("itm_mamluke_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], engineer=6)),
  ("pw_buy_lamellar_armor",spr_buy_item_flags(30),"lamellar_armor_b","bo_armor_body", spr_buy_item_triggers("itm_lamellar_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_scale_armor",spr_buy_item_flags(28),"lamellar_armor_e","bo_armor_body", spr_buy_item_triggers("itm_scale_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_banded_armor",spr_buy_item_flags(30),"banded_armor_a","bo_armor_body", spr_buy_item_triggers("itm_banded_armor", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], engineer=6)),
  ("pw_buy_cuir_bouilli",spr_buy_item_flags(31),"cuir_bouilli_a","bo_armor_body", spr_buy_item_triggers("itm_cuir_bouilli", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], engineer=6)),
  ("pw_buy_coat_of_plates",spr_buy_item_flags(32),"coat_of_plates_a","bo_armor_body", spr_buy_item_triggers("itm_coat_of_plates", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], engineer=6)),
  ("pw_buy_coat_of_plates_red",spr_buy_item_flags(33),"coat_of_plates_red","bo_armor_body", spr_buy_item_triggers("itm_coat_of_plates_red", resources=[("itm_iron_bar_short",2),"itm_leather_roll"], engineer=6, tableau="tableau_heraldic_coat_of_plates")),
  ("pw_buy_khergit_elite_armor",spr_buy_item_flags(35),"lamellar_armor_d","bo_armor_body", spr_buy_item_triggers("itm_khergit_elite_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth_small"], engineer=6, tableau="tableau_heraldic_lamellar_armor_d")),
  ("pw_buy_vaegir_elite_armor",spr_buy_item_flags(35),"lamellar_armor_c","bo_armor_body", spr_buy_item_triggers("itm_vaegir_elite_armor", resources=[("itm_iron_bar",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_sarranid_elite_armor",spr_buy_item_flags(35),"tunic_armor_a","bo_armor_body", spr_buy_item_triggers("itm_sarranid_elite_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_plate_armor",spr_buy_item_flags(40),"full_plate_armor","bo_armor_body", spr_buy_item_triggers("itm_plate_armor", resources=[("itm_iron_bar_long", 4)], engineer=7)),
  ("pw_buy_black_armor",spr_buy_item_flags(43),"black_armor","bo_armor_body", spr_buy_item_triggers("itm_black_armor", resources=[("itm_iron_bar_long", 4)], engineer=7)),
  ("pw_buy_light_heraldic_mail",spr_buy_item_flags(16),"heraldic_armor_new_c","bo_armor_body", spr_buy_item_triggers("itm_light_heraldic_mail", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4, tableau="tableau_heraldic_armor_c")),
  ("pw_buy_heraldic_mail_with_tunic",spr_buy_item_flags(19),"heraldic_armor_new_b","bo_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_tunic", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=4, tableau="tableau_heraldic_armor_b")),
  ("pw_buy_heraldic_mail_with_tabard",spr_buy_item_flags(23),"heraldic_armor_new_d","bo_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_tabard", resources=[("itm_iron_bar_short",3),"itm_linen_cloth"], engineer=5, tableau="tableau_heraldic_armor_d")),
  ("pw_buy_heraldic_mail_with_surcoat",spr_buy_item_flags(26),"heraldic_armor_new_a","bo_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_surcoat", resources=[("itm_iron_bar_short",3),"itm_linen_cloth"], engineer=6, tableau="tableau_heraldic_armor_a")),

  ("pw_buy_wrapping_boots",spr_buy_item_flags(2),"wrapping_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_wrapping_boots", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_woolen_hose",spr_buy_item_flags(4),"woolen_hose_a","bo_armor_foot", spr_buy_item_triggers("itm_woolen_hose", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_blue_hose",spr_buy_item_flags(4),"blue_hose_a","bo_armor_foot", spr_buy_item_triggers("itm_blue_hose", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pw_buy_bride_shoes",spr_buy_item_flags(8),"bride_shoes","bo_armor_foot", spr_buy_item_triggers("itm_bride_shoes", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pw_buy_sarranid_boots_a",spr_buy_item_flags(3),"sarranid_shoes","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_a", resources=[("itm_linen_cloth_small",2)], tailoring=1)),
  ("pw_buy_hunter_boots",spr_buy_item_flags(5),"hunter_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_hunter_boots", resources=[("itm_leather_piece",2)], tailoring=2)),
  ("pw_buy_hide_boots",spr_buy_item_flags(7),"hide_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_hide_boots", resources=[("itm_leather_piece",2)], tailoring=2)),
  ("pw_buy_ankle_boots",spr_buy_item_flags(8),"ankle_boots_a_new","bo_armor_foot", spr_buy_item_triggers("itm_ankle_boots", resources=[("itm_linen_cloth_small",2)], tailoring=2)),
  ("pw_buy_nomad_boots",spr_buy_item_flags(7),"nomad_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_nomad_boots", resources=["itm_linen_cloth_small","itm_leather_piece"], tailoring=2)),
  ("pw_buy_light_leather_boots",spr_buy_item_flags(10),"light_leather_boots","bo_armor_foot", spr_buy_item_triggers("itm_light_leather_boots", resources=[("itm_leather_piece",2)], tailoring=2)),
  ("pw_buy_leather_boots",spr_buy_item_flags(12),"leather_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_leather_boots", resources=[("itm_leather_piece",2)], tailoring=2)),
  ("pw_buy_sarranid_boots_b",spr_buy_item_flags(13),"sarranid_boots","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_b", resources=[("itm_leather_piece",2)], tailoring=3)),
  ("pw_buy_khergit_leather_boots",spr_buy_item_flags(14),"khergit_leather_boots","bo_armor_foot", spr_buy_item_triggers("itm_khergit_leather_boots", resources=[("itm_leather_piece",2)], tailoring=3)),
  ("pw_buy_sarranid_boots_c",spr_buy_item_flags(14),"sarranid_camel_boots","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_c", resources=[("itm_leather_piece",2),"itm_iron_piece"], tailoring=3, engineer=3)),
  ("pw_buy_splinted_leather_greaves",spr_buy_item_flags(15),"leather_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_splinted_leather_greaves", resources=[("itm_leather_piece",2),"itm_iron_piece"], engineer=3)),
  ("pw_buy_mail_chausses",spr_buy_item_flags(17),"mail_chausses_a","bo_armor_foot", spr_buy_item_triggers("itm_mail_chausses", resources=["itm_leather_piece",("itm_iron_piece",2)], engineer=4)),
  ("pw_buy_splinted_greaves",spr_buy_item_flags(16),"splinted_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_splinted_greaves", resources=["itm_linen_cloth_small",("itm_iron_piece",2)], engineer=4)),
  ("pw_buy_sarranid_boots_d",spr_buy_item_flags(19),"sarranid_mail_chausses","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_d", resources=["itm_leather_piece",("itm_iron_piece",2)], engineer=5)),
  ("pw_buy_mail_boots",spr_buy_item_flags(20),"mail_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_mail_boots", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_iron_greaves",spr_buy_item_flags(25),"iron_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_iron_greaves", resources=[("itm_iron_bar_short",3)], engineer=6)),
  ("pw_buy_plate_boots",spr_buy_item_flags(27),"plate_boots","bo_armor_foot", spr_buy_item_triggers("itm_plate_boots", resources=[("itm_iron_bar",2)], engineer=6)),
  ("pw_buy_black_greaves",spr_buy_item_flags(28),"black_greaves","bo_armor_foot", spr_buy_item_triggers("itm_black_greaves", resources=[("itm_iron_bar",2)], engineer=6)),

  ("pw_buy_leather_gloves",spr_buy_item_flags(6),"leather_gloves_L","bo_armor_hand", spr_buy_item_triggers("itm_leather_gloves", resources=["itm_leather_piece"], tailoring=2)),
  ("pw_buy_mail_mittens",spr_buy_item_flags(10),"mail_mittens_L","bo_armor_hand", spr_buy_item_triggers("itm_mail_mittens", resources=["itm_iron_piece"], engineer=3)),
  ("pw_buy_lamellar_gauntlets",spr_buy_item_flags(12),"scale_gauntlets_a_L","bo_armor_hand", spr_buy_item_triggers("itm_lamellar_gauntlets", resources=["itm_leather_piece","itm_iron_piece"], engineer=4)),
  ("pw_buy_scale_gauntlets",spr_buy_item_flags(13),"scale_gauntlets_b_L","bo_armor_hand", spr_buy_item_triggers("itm_scale_gauntlets", resources=["itm_leather_piece","itm_iron_piece"], engineer=5)),
  ("pw_buy_gauntlets",spr_buy_item_flags(18),"gauntlets_L","bo_armor_hand", spr_buy_item_triggers("itm_gauntlets", resources=[("itm_iron_bar_short",2)], engineer=6)),

  ("pw_buy_practice_sword",spr_buy_item_flags(3),"pw_practice_sword","bo_weapon", spr_buy_item_triggers("itm_practice_sword", resources=["itm_wood_pole_short"], engineer=2)),
  ("pw_buy_heavy_practice_sword",spr_buy_item_flags(5),"pw_heavy_practice_sword","bo_weapon", spr_buy_item_triggers("itm_heavy_practice_sword", resources=["itm_wood_pole_short"], engineer=2)),
  ("pw_buy_winged_mace",spr_buy_item_flags(6),"flanged_mace","bo_weapon_small", spr_buy_item_triggers("itm_winged_mace", resources=["itm_iron_bar"], engineer=2)),
  ("pw_buy_spiked_mace",spr_buy_item_flags(4),"spiked_mace_new","bo_weapon_small", spr_buy_item_triggers("itm_spiked_mace", resources=["itm_iron_bar"], engineer=2)),
  ("pw_buy_mace_2",spr_buy_item_flags(3),"mace_a","bo_weapon_small", spr_buy_item_triggers("itm_mace_2", resources=["itm_iron_piece", "itm_stick"], engineer=1)),
  ("pw_buy_mace_4",spr_buy_item_flags(4),"mace_b","bo_weapon_small", spr_buy_item_triggers("itm_mace_4", resources=["itm_iron_piece", "itm_stick"], engineer=1)),
  ("pw_buy_club_with_spike_head",spr_buy_item_flags(5),"mace_e","bo_weapon", spr_buy_item_triggers("itm_club_with_spike_head", resources=["itm_iron_bar_short", "itm_wood_pole_short"], engineer=2)),
  ("pw_buy_long_spiked_club",spr_buy_item_flags(6),"mace_long_c","bo_weapon_big", spr_buy_item_triggers("itm_long_spiked_club", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_long_hafted_spiked_mace",spr_buy_item_flags(9),"mace_long_b","bo_weapon_big", spr_buy_item_triggers("itm_long_hafted_spiked_mace", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
  ("pw_buy_fighting_pick",spr_buy_item_flags(8),"fighting_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_fighting_pick", resources=["itm_iron_bar_short", "itm_stick"], engineer=2)),
  ("pw_buy_military_pick",spr_buy_item_flags(11),"steel_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_military_pick", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_military_sickle",spr_buy_item_flags(10),"military_sickle_a","bo_weapon_small", spr_buy_item_triggers("itm_military_sickle", resources=["itm_iron_bar_short", "itm_stick"], engineer=2)),
  ("pw_buy_military_hammer",spr_buy_item_flags(9),"military_hammer","bo_weapon_small", spr_buy_item_triggers("itm_military_hammer", resources=["itm_iron_bar_short", "itm_stick"], engineer=3)),
  ("pw_buy_morningstar",spr_buy_item_flags(26),"mace_morningstar_new","bo_weapon", spr_buy_item_triggers("itm_morningstar", resources=["itm_iron_bar_long", "itm_iron_bar_short"], engineer=4)),
  ("pw_buy_falchion",spr_buy_item_flags(9),"falchion_new","bo_weapon_small", spr_buy_item_triggers("itm_falchion", resources=["itm_iron_bar"], engineer=2)),
  ("pw_buy_curved_sword",spr_buy_item_flags(12),"khergit_sword","bo_weapon", spr_buy_item_triggers("itm_curved_sword", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_medieval_a",spr_buy_item_flags(14),"sword_medieval_a","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_a", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_medieval_b_small",spr_buy_item_flags(13),"sword_medieval_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_b_small", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_medieval_c_long",spr_buy_item_flags(19),"sword_medieval_c_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_c_long", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_medieval_d_long",spr_buy_item_flags(21),"sword_medieval_d_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_d_long", resources=["itm_iron_bar"], engineer=4)),
  ("pw_buy_sword_viking_c",spr_buy_item_flags(13),"sword_viking_c","bo_weapon", spr_buy_item_triggers("itm_sword_viking_c", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_viking_b_small",spr_buy_item_flags(12),"sword_viking_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_viking_b_small", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sword_viking_a_long",spr_buy_item_flags(17),"sword_viking_a_long","bo_weapon", spr_buy_item_triggers("itm_sword_viking_a_long", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_scimitar",spr_buy_item_flags(18),"scimitar_a","bo_weapon", spr_buy_item_triggers("itm_scimitar", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_scimitar_b",spr_buy_item_flags(20),"scimitar_b","bo_weapon", spr_buy_item_triggers("itm_scimitar_b", resources=["itm_iron_bar"], engineer=4)),
  ("pw_buy_khergit_sword_c",spr_buy_item_flags(17),"khergit_sword_c","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_c", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_khergit_sword_d",spr_buy_item_flags(22),"khergit_sword_d","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_d", resources=["itm_iron_bar"], engineer=4)),
  ("pw_buy_khergit_sword_two_handed_a",spr_buy_item_flags(27),"khergit_sword_two_handed_a","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_two_handed_a", resources=["itm_iron_bar_long"], engineer=6)),
  ("pw_buy_two_handed_cleaver",spr_buy_item_flags(18),"military_cleaver_a","bo_weapon", spr_buy_item_triggers("itm_two_handed_cleaver", resources=["itm_iron_bar_long"], engineer=4)),
  ("pw_buy_military_cleaver_b",spr_buy_item_flags(8),"military_cleaver_b","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_b", resources=["itm_iron_bar"], engineer=2)),
  ("pw_buy_military_cleaver_c",spr_buy_item_flags(9),"military_cleaver_c","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_c", resources=["itm_iron_bar"], engineer=2)),
  ("pw_buy_bastard_sword_a",spr_buy_item_flags(20),"bastard_sword_a","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_a", resources=["itm_iron_bar_long"], engineer=5)),
  ("pw_buy_bastard_sword_b",spr_buy_item_flags(24),"bastard_sword_b","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_b", resources=["itm_iron_bar_long"], engineer=5)),
  ("pw_buy_sword_two_handed_b",spr_buy_item_flags(26),"sword_two_handed_b","bo_weapon", spr_buy_item_triggers("itm_sword_two_handed_b", resources=["itm_iron_bar_long"], engineer=6)),
  ("pw_buy_sword_two_handed_a",spr_buy_item_flags(30),"sword_two_handed_a","bo_weapon", spr_buy_item_triggers("itm_sword_two_handed_a", resources=["itm_iron_bar_long"], engineer=7)),
  ("pw_buy_one_handed_war_axe_b",spr_buy_item_flags(6),"one_handed_war_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_war_axe_b", resources=["itm_iron_bar_short", "itm_stick"], engineer=2)),
  ("pw_buy_one_handed_battle_axe_a",spr_buy_item_flags(6),"one_handed_battle_axe_a","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_a", resources=["itm_iron_bar_short", "itm_stick"], engineer=2)),
  ("pw_buy_one_handed_battle_axe_b",spr_buy_item_flags(8),"one_handed_battle_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_b", resources=["itm_iron_bar_short", "itm_stick"], engineer=3)),
  ("pw_buy_one_handed_battle_axe_c",spr_buy_item_flags(8),"one_handed_battle_axe_c","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_c", resources=["itm_iron_bar_short", "itm_stick"], engineer=3)),
  ("pw_buy_sarranid_axe_a",spr_buy_item_flags(12),"one_handed_battle_axe_g","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_a", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_sarranid_axe_b",spr_buy_item_flags(13),"one_handed_battle_axe_h","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_b", resources=["itm_iron_bar"], engineer=3)),
  ("pw_buy_two_handed_axe",spr_buy_item_flags(15),"two_handed_battle_axe_a","bo_weapon", spr_buy_item_triggers("itm_two_handed_axe", resources=["itm_wood_pole_short", "itm_iron_bar"], engineer=3)),
  ("pw_buy_two_handed_battle_axe",spr_buy_item_flags(18),"two_handed_battle_axe_b","bo_weapon", spr_buy_item_triggers("itm_two_handed_battle_axe", resources=["itm_wood_pole_short", "itm_iron_bar"], engineer=4)),
  ("pw_buy_shortened_voulge",spr_buy_item_flags(21),"two_handed_battle_axe_c","bo_weapon", spr_buy_item_triggers("itm_shortened_voulge", resources=["itm_wood_pole_short", "itm_iron_bar"], engineer=5)),
  ("pw_buy_bardiche",spr_buy_item_flags(23),"two_handed_battle_axe_d","bo_weapon", spr_buy_item_triggers("itm_bardiche", resources=["itm_wood_pole_short", "itm_iron_bar"], engineer=5)),
  ("pw_buy_shortened_military_scythe",spr_buy_item_flags(19),"two_handed_battle_scythe_a","bo_weapon", spr_buy_item_triggers("itm_shortened_military_scythe", resources=["itm_iron_bar_long", "itm_stick"], engineer=3)),
  ("pw_buy_sarranid_two_handed_axe_a",spr_buy_item_flags(19),"two_handed_battle_axe_g","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_a", resources=["itm_iron_bar_long"], engineer=5)),
  ("pw_buy_sarranid_two_handed_axe_b",spr_buy_item_flags(22),"two_handed_battle_axe_h","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_b", resources=["itm_iron_bar_long"], engineer=6)),
  ("pw_buy_long_axe_a",spr_buy_item_flags(25),"long_axe_a","bo_weapon", spr_buy_item_triggers("itm_long_axe_a", resources=["itm_wood_pole", "itm_iron_bar"], engineer=5)),
  ("pw_buy_glaive",spr_buy_item_flags(13),"glaive_b","bo_weapon_big", spr_buy_item_triggers("itm_glaive", resources=["itm_wood_pole", "itm_iron_bar"], engineer=3)),
  ("pw_buy_staff",spr_buy_item_flags(1),"wooden_staff","bo_weapon_big", spr_buy_item_triggers("itm_staff", resources=["itm_wood_pole"], engineer=0)),
  ("pw_buy_quarter_staff",spr_buy_item_flags(2),"quarter_staff","bo_weapon_big", spr_buy_item_triggers("itm_quarter_staff", resources=["itm_wood_pole"], engineer=1)),
  ("pw_buy_iron_staff",spr_buy_item_flags(5),"iron_staff","bo_weapon_big", spr_buy_item_triggers("itm_iron_staff", resources=["itm_iron_bar_long"], engineer=2)),
  ("pw_buy_shortened_spear",spr_buy_item_flags(3),"spear_g_1-9m","bo_weapon", spr_buy_item_triggers("itm_shortened_spear", resources=["itm_wood_pole", "itm_iron_piece"], engineer=1)),
  ("pw_buy_spear",spr_buy_item_flags(3),"spear_h_2-15m","bo_weapon_big", spr_buy_item_triggers("itm_spear", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_bamboo_spear",spr_buy_item_flags(7),"arabian_spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_bamboo_spear", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_war_spear",spr_buy_item_flags(4),"spear_i_2-3m","bo_weapon_big", spr_buy_item_triggers("itm_war_spear", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_light_lance",spr_buy_item_flags(4),"spear_b_2-75m","bo_weapon_big", spr_buy_item_triggers("itm_light_lance", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_lance",spr_buy_item_flags(5),"spear_d_2-8m","bo_weapon_big", spr_buy_item_triggers("itm_lance", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_heavy_lance",spr_buy_item_flags(6),"spear_f_2-9m","bo_weapon_big", spr_buy_item_triggers("itm_heavy_lance", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_great_lance",spr_buy_item_flags(6),"pw_great_lance","bo_weapon_big", spr_buy_item_triggers("itm_great_lance", resources=["itm_wood_pole", ("itm_iron_piece", 2)], engineer=3)),
  ("pw_buy_jousting_lance",spr_buy_item_flags(6),"pw_jousting_lance","bo_weapon_big", spr_buy_item_triggers("itm_jousting_lance", resources=["itm_wood_pole", ("itm_iron_piece", 2)], engineer=3)),
  ("pw_buy_awlpike",spr_buy_item_flags(7),"awl_pike_b","bo_weapon_big", spr_buy_item_triggers("itm_awlpike", resources=["itm_wood_pole", "itm_iron_bar_short"], engineer=2)),
  ("pw_buy_awlpike_long",spr_buy_item_flags(8),"awl_pike_a","bo_weapon_big", spr_buy_item_triggers("itm_awlpike_long", resources=["itm_wood_pole", "itm_iron_bar_short"], engineer=2)),
  ("pw_buy_pike",spr_buy_item_flags(9),"spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_pike", resources=["itm_wood_pole", "itm_iron_piece"], engineer=3)),
  ("pw_buy_bec_de_corbin_a",spr_buy_item_flags(17),"bec_de_corbin_a","bo_weapon", spr_buy_item_triggers("itm_bec_de_corbin_a", resources=["itm_wood_pole", "itm_iron_bar_short"], engineer=4)),
  ("pw_buy_hunting_bow",spr_buy_item_flags(4),"hunting_bow","bo_weapon", spr_buy_item_triggers("itm_hunting_bow", resources=["itm_wood_pole_short"], engineer=2)),
  ("pw_buy_short_bow",spr_buy_item_flags(5),"short_bow","bo_weapon", spr_buy_item_triggers("itm_short_bow", resources=["itm_wood_pole_short"], engineer=2)),
  ("pw_buy_nomad_bow",spr_buy_item_flags(7),"nomad_bow","bo_weapon", spr_buy_item_triggers("itm_nomad_bow", resources=["itm_wood_pole_short"], engineer=3)),
  ("pw_buy_long_bow",spr_buy_item_flags(12),"long_bow","bo_weapon", spr_buy_item_triggers("itm_long_bow", resources=["itm_wood_pole"], engineer=3)),
  ("pw_buy_khergit_bow",spr_buy_item_flags(14),"khergit_bow","bo_weapon", spr_buy_item_triggers("itm_khergit_bow", resources=["itm_wood_pole_short"], engineer=3)),
  ("pw_buy_strong_bow",spr_buy_item_flags(18),"strong_bow","bo_weapon", spr_buy_item_triggers("itm_strong_bow", resources=["itm_wood_pole_short"], engineer=4)),
  ("pw_buy_war_bow",spr_buy_item_flags(20),"war_bow","bo_weapon", spr_buy_item_triggers("itm_war_bow", resources=["itm_wood_pole"], engineer=5)),
  ("pw_buy_arrows",spr_buy_item_flags(1),"arrow_b","bo_weapon", spr_buy_item_triggers("itm_arrows", resources=[], engineer=1)),
  ("pw_buy_barbed_arrows",spr_buy_item_flags(1),"barbed_arrow","bo_weapon", spr_buy_item_triggers("itm_barbed_arrows", resources=[], engineer=1)),
  ("pw_buy_khergit_arrows",spr_buy_item_flags(2),"arrow","bo_weapon", spr_buy_item_triggers("itm_khergit_arrows", resources=[], engineer=1)),
  ("pw_buy_bodkin_arrows",spr_buy_item_flags(2),"piercing_arrow","bo_weapon", spr_buy_item_triggers("itm_bodkin_arrows", resources=[], engineer=1)),
  ("pw_buy_hunting_crossbow",spr_buy_item_flags(10),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_hunting_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], engineer=3)),
  ("pw_buy_light_crossbow",spr_buy_item_flags(12),"crossbow_b","bo_weapon_small", spr_buy_item_triggers("itm_light_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], engineer=3)),
  ("pw_buy_crossbow",spr_buy_item_flags(15),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], engineer=4)),
  ("pw_buy_heavy_crossbow",spr_buy_item_flags(20),"crossbow_c","bo_weapon_small", spr_buy_item_triggers("itm_heavy_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], engineer=5)),
  ("pw_buy_sniper_crossbow",spr_buy_item_flags(30),"crossbow_c","bo_weapon_small", spr_buy_item_triggers("itm_sniper_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], engineer=6)),
  ("pw_buy_bolts",spr_buy_item_flags(1),"bolt","bo_weapon_small", spr_buy_item_triggers("itm_bolts", resources=[], engineer=1)),
  ("pw_buy_steel_bolts",spr_buy_item_flags(2),"bolt","bo_weapon_small", spr_buy_item_triggers("itm_steel_bolts", resources=[], engineer=1)),
  ("pw_buy_practice_shield",spr_buy_item_flags(2),"tableau_shield_round_5","bo_shield_round", spr_buy_item_triggers("itm_practice_shield", resources=["itm_board"], engineer=1, tableau="tableau_round_shield_5")),
  ("pw_buy_tab_shield_round_b",spr_buy_item_flags(8),"tableau_shield_round_3","bo_shield_round", spr_buy_item_triggers("itm_tab_shield_round_b", resources=["itm_board"], engineer=1, tableau="tableau_round_shield_3")),
  ("pw_buy_tab_shield_round_c",spr_buy_item_flags(11),"tableau_shield_round_2","bo_shield_round", spr_buy_item_triggers("itm_tab_shield_round_c", resources=["itm_board", "itm_iron_piece"], engineer=2, tableau="tableau_round_shield_2")),
  ("pw_buy_tab_shield_round_d",spr_buy_item_flags(15),"tableau_shield_round_1","bo_shield_round", spr_buy_item_triggers("itm_tab_shield_round_d", resources=["itm_board", ("itm_iron_piece", 2)], engineer=3, tableau="tableau_round_shield_1")),
  ("pw_buy_tab_shield_kite_b",spr_buy_item_flags(7),"tableau_shield_kite_3","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_b", resources=[("itm_board", 2)], engineer=1, tableau="tableau_kite_shield_3")),
  ("pw_buy_tab_shield_kite_c",spr_buy_item_flags(9),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_c", resources=[("itm_board", 2), "itm_iron_piece"], engineer=2, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_d",spr_buy_item_flags(12),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_d", resources=[("itm_board", 2), "itm_iron_piece"], engineer=3, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_cav_a",spr_buy_item_flags(7),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_a", resources=["itm_board", "itm_iron_piece"], engineer=2, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_kite_cav_b",spr_buy_item_flags(10),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_b", resources=["itm_board", "itm_iron_piece"], engineer=3, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_heater_b",spr_buy_item_flags(8),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_b", resources=[("itm_board", 2), "itm_iron_piece"], engineer=2, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_c",spr_buy_item_flags(10),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_c", resources=[("itm_board", 2), "itm_iron_piece"], engineer=2, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_d",spr_buy_item_flags(13),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_d", resources=[("itm_board", 2), "itm_iron_piece"], engineer=3, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_cav_a",spr_buy_item_flags(7),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_a", resources=["itm_board", "itm_iron_piece"], engineer=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_heater_cav_b",spr_buy_item_flags(10),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_b", resources=["itm_board", "itm_iron_piece"], engineer=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_pavise_b",spr_buy_item_flags(10),"tableau_shield_pavise_2","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_b", resources=[("itm_board", 3)], engineer=1, tableau="tableau_pavise_shield_2")),
  ("pw_buy_tab_shield_pavise_c",spr_buy_item_flags(15),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_c", resources=[("itm_board", 3), "itm_iron_piece"], engineer=2, tableau="tableau_pavise_shield_1")),
  ("pw_buy_tab_shield_pavise_d",spr_buy_item_flags(20),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_d", resources=[("itm_board", 3), "itm_iron_piece"], engineer=3, tableau="tableau_pavise_shield_1")),
  ("pw_buy_tab_shield_small_round_a",spr_buy_item_flags(5),"tableau_shield_small_round_3","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_a", resources=["itm_board"], engineer=2, tableau="tableau_small_round_shield_3")),
  ("pw_buy_tab_shield_small_round_b",spr_buy_item_flags(7),"tableau_shield_small_round_1","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_b", resources=["itm_board", "itm_iron_piece"], engineer=2, tableau="tableau_small_round_shield_1")),
  ("pw_buy_tab_shield_small_round_c",spr_buy_item_flags(15),"tableau_shield_small_round_2","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_c", resources=["itm_board", "itm_iron_piece"], engineer=3, tableau="tableau_small_round_shield_2")),
  ("pw_buy_steel_shield",spr_buy_item_flags(30),"shield_dragon","bo_shield_round", spr_buy_item_triggers("itm_steel_shield", resources=["itm_iron_bar"], engineer=6)),

  ("pw_buy_sumpter_horse",spr_buy_item_flags(5),"sumpter_horse","bo_horse", spr_buy_item_triggers("itm_sumpter_horse", resources=["itm_board", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_cart_horse",spr_buy_item_flags(7),"sumpter_horse","bo_horse", spr_buy_item_triggers("itm_cart_horse", resources=["itm_board", ("itm_wheat_sheaf", 2)], herding=1)),
  ("pw_buy_saddle_horse",spr_buy_item_flags(10),"saddle_horse","bo_horse", spr_buy_item_triggers("itm_saddle_horse", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_steppe_horse",spr_buy_item_flags(13),"steppe_horse","bo_horse", spr_buy_item_triggers("itm_steppe_horse", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pw_buy_arabian_horse_a",spr_buy_item_flags(14),"arabian_horse_a","bo_horse", spr_buy_item_triggers("itm_arabian_horse_a", resources=["itm_saddle", "itm_wheat_sheaf"], herding=2)),
  ("pw_buy_arabian_horse_b",spr_buy_item_flags(17),"arabian_horse_b","bo_horse", spr_buy_item_triggers("itm_arabian_horse_b", resources=["itm_saddle", "itm_wheat_sheaf"], herding=2)),
  ("pw_buy_courser",spr_buy_item_flags(20),"courser","bo_horse", spr_buy_item_triggers("itm_courser", resources=["itm_saddle", "itm_wheat_sheaf"], herding=3)),
  ("pw_buy_hunter",spr_buy_item_flags(25),"hunting_horse","bo_horse", spr_buy_item_triggers("itm_hunter", resources=["itm_saddle", "itm_wheat_sheaf"], herding=2)),
  ("pw_buy_warhorse",spr_buy_item_flags(30),"warhorse_chain","bo_horse", spr_buy_item_triggers("itm_warhorse", resources=["itm_saddle", "itm_horse_armor", "itm_wheat_sheaf"], herding=3)),
  ("pw_buy_warhorse_steppe",spr_buy_item_flags(30),"warhorse_steppe","bo_horse", spr_buy_item_triggers("itm_warhorse_steppe", resources=["itm_saddle", "itm_horse_armor", "itm_wheat_sheaf"], herding=3)),
  ("pw_buy_warhorse_sarranid",spr_buy_item_flags(30),"warhorse_sarranid","bo_horse", spr_buy_item_triggers("itm_warhorse_sarranid", resources=["itm_saddle", "itm_horse_armor", ("itm_wheat_sheaf", 2)], herding=3)),
  ("pw_buy_charger",spr_buy_item_flags(35),"charger_new","bo_horse", spr_buy_item_triggers("itm_charger", resources=["itm_saddle", "itm_horse_armor", ("itm_wheat_sheaf", 2)], herding=3)),
  ("pw_buy_plated_charger",spr_buy_item_flags(40),"plated_charger","bo_horse", spr_buy_item_triggers("itm_plated_charger", resources=["itm_saddle", "itm_horse_armor", ("itm_wheat_sheaf", 2)], herding=3)),
  ("pw_buy_saddle",spr_buy_item_flags(10),"pw_saddle","bo_pw_saddle", spr_buy_item_triggers("itm_saddle", pos_offset=(0,0,20), resources=["itm_leather_roll", "itm_board"], engineer=2)),
  ...
  ("pw_buy_woodcutter_axe",spr_buy_item_flags(8),"pw_wood_axe","bo_weapon", spr_buy_item_triggers("itm_woodcutter_axe", resources=["itm_iron_bar_short", "itm_wood_pole_short"], engineer=2)),
  ("pw_buy_mining_pick",spr_buy_item_flags(10),"pw_mining_pick","bo_weapon", spr_buy_item_triggers("itm_mining_pick", resources=["itm_iron_bar", "itm_wood_pole_short"], engineer=2)),
  ("pw_buy_repair_hammer",spr_buy_item_flags(7),"pw_repair_hammer","bo_weapon_small", spr_buy_item_triggers("itm_repair_hammer", resources=["itm_iron_piece", "itm_stick"], engineer=2)),
  ("pw_buy_lock_pick",spr_buy_item_flags(24),"pw_lock_pick","bo_weapon_small", spr_buy_item_triggers("itm_lock_pick", resources=["itm_iron_piece"], engineer=3)),
  ("pw_buy_bucket",spr_buy_item_flags(10),"pw_bucket_ground","bo_pw_bucket", spr_buy_item_triggers("itm_bucket", pos_offset=(0,0,20), resources=[("itm_board", 2), "itm_iron_piece"], engineer=2)),
  ("pw_buy_fishing_spear",spr_buy_item_flags(9),"pw_fishing_spear","bo_weapon_big", spr_buy_item_triggers("itm_fishing_spear", resources=["itm_wood_pole", "itm_iron_bar_short"], engineer=2)),
  ("pw_buy_fishing_net",spr_buy_item_flags(33),"pw_fishing_net_b","bo_pw_fishing_net_b", spr_buy_item_triggers("itm_fishing_net", pos_offset=(150,-100,0), rotate=(0,-90,0), resources=[("itm_wood_pole_short", 2), ("itm_linen_thread", 2)], engineer=2)),
  ("pw_buy_sickle",spr_buy_item_flags(6),"pw_sickle","bo_weapon_small", spr_buy_item_triggers("itm_sickle", resources=["itm_iron_bar_short", "itm_stick"], engineer=2)),
  ("pw_buy_scythe",spr_buy_item_flags(14),"pw_scythe","bo_weapon_big", spr_buy_item_triggers("itm_scythe", resources=["itm_iron_bar", "itm_wood_pole"], engineer=2)),
  ("pw_buy_wheat_sack",spr_buy_item_flags(3),"pw_wheat_sack","bo_weapon_small", spr_buy_item_triggers("itm_wheat_sack", pos_offset=(0,0,-20), resources=["itm_wheat_sheaf"], engineer=1)),
  ("pw_buy_kitchen_knife",spr_buy_item_flags(2),"pw_kitchen_knife","bo_weapon_small", spr_buy_item_triggers("itm_kitchen_knife", resources=["itm_iron_piece"], engineer=2)),
  ("pw_buy_cleaver",spr_buy_item_flags(4),"cleaver_new","bo_weapon_small", spr_buy_item_triggers("itm_cleaver", resources=["itm_iron_bar_short"], engineer=2)),
  ("pw_buy_knife",spr_buy_item_flags(3),"peasant_knife_new","bo_weapon_small", spr_buy_item_triggers("itm_knife", resources=["itm_iron_bar_short"], engineer=2)),
  ("pw_buy_butchering_knife",spr_buy_item_flags(5),"khyber_knife_new","bo_weapon_small", spr_buy_item_triggers("itm_butchering_knife", resources=["itm_iron_bar_short"], engineer=3)),
  ("pw_buy_broom",spr_buy_item_flags(2),"pw_broom","bo_weapon", spr_buy_item_triggers("itm_broom", resources=["itm_wood_pole_short", "itm_flax_bundle"], engineer=0)),
  ("pw_buy_herding_crook",spr_buy_item_flags(4),"pw_herding_crook","bo_weapon_big", spr_buy_item_triggers("itm_herding_crook", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pw_buy_surgeon_scalpel",spr_buy_item_flags(30),"dagger_b_scabbard","bo_weapon_small", spr_buy_item_triggers("itm_surgeon_scalpel", resources=["itm_iron_piece"], engineer=4)),
  ("pw_buy_dagger",spr_buy_item_flags(7),"scab_dagger","bo_weapon_small", spr_buy_item_triggers("itm_dagger", resources=["itm_iron_bar_short"], engineer=3)),
  ("pw_buy_poisoned_dagger",spr_buy_item_flags(45),"scab_dagger","bo_weapon_small", spr_buy_item_triggers("itm_poisoned_dagger", resources=["itm_dagger", "itm_poison_herb"], engineer=4)),
  ("pw_buy_torch",spr_use_time(1),"pw_torch","bo_weapon_small", spr_buy_item_triggers("itm_torch", resources=["itm_stick"], engineer=1)),
  ...
  ("pw_buy_book_a",spr_buy_item_flags(45),"pw_book_a","bo_weapon_small", spr_buy_item_triggers("itm_book_a", resources=["itm_linen_cloth_small","itm_leather_piece"], engineer=2)),
  ("pw_buy_book_b",spr_buy_item_flags(70),"pw_book_b","bo_weapon_small", spr_buy_item_triggers("itm_book_b", resources=["itm_linen_cloth_small","itm_leather_piece"], engineer=2)),
  ("pw_buy_book_c",spr_buy_item_flags(75),"pw_book_c","bo_weapon_small", spr_buy_item_triggers("itm_book_c", resources=["itm_linen_cloth_small","itm_leather_piece"], engineer=2)),
  ("pw_buy_book_d",spr_buy_item_flags(20),"pw_book_d","bo_weapon_small", spr_buy_item_triggers("itm_book_d", resources=["itm_linen_cloth_small","itm_leather_piece"], engineer=2)),
  ...
  ("pw_buy_die",spr_buy_item_flags(6),"pw_die","bo_weapon_small", spr_buy_item_triggers("itm_die", pos_offset=(7,7,0), resources=["itm_stick"], engineer=2)),
  ...
  ("pw_rest_bed_e",spr_use_time(40),"bed_e","bo_bed_e", spr_rest_triggers(50, min_health_pct=30)),
  ...
  ("pw_rest_pillow_a",spr_use_time(25),"pillow_a","bo_pillow", spr_rest_triggers(20, min_health_pct=45)),
  ("pw_rest_pillow_b",spr_use_time(32),"pillow_b","bo_pillow", spr_rest_triggers(30, min_health_pct=40)),
  ...
  ("pw_change_troop_huntsman",spr_use_time(30),"short_bow","bo_weapon", spr_change_troop_triggers("trp_huntsman", cost=500)),
  ("pw_change_troop_craftsman",spr_use_time(50),"pw_repair_hammer","bo_weapon_small", spr_change_troop_triggers("trp_craftsman", cost=800)),
  ...
  ("pw_change_troop_crossbowman",spr_use_time(60),"crossbow_a","bo_weapon", spr_change_troop_triggers("trp_crossbowman", cost=1200)),
  ("pw_change_troop_lancer",spr_use_time(70),"arena_lance","bo_weapon_big", spr_change_troop_triggers("trp_lancer", cost=1500)),
  ...
  ("pw_change_troop_mercenary",spr_use_time(50),"spiked_mace","bo_weapon", spr_change_troop_triggers("trp_mercenary", cost=700, mercenary=True, after_respawn=True, use_string="str_troop_become_for")),
  ...
  ("pw_wooden_palisade_build",spr_build_flags(),"pw_build_wall","bo_build", spr_build_wall_triggers()),
  ...
  ("pw_back_basket",sokf_moveable|spr_use_time(2),"pw_back_basket","bo_pw_back_basket", spr_cart_triggers(detach_offset=-12, inventory_count=5, max_item_length=95, access_distance=40)),
