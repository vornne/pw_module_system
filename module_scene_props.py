...
scene_props = [
  ...
  ("pw_buy_leather_boots",spr_buy_item_flags(4),"leather_boots_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_leather_boots", resources=[("itm_leather_piece",2)], tailoring=2)),
  ...
  ("pw_buy_mining_pick",spr_buy_item_flags(5),"pw_mining_pick","bo_pw_weapon", spr_buy_item_triggers("itm_mining_pick", resources=["itm_iron_bar", "itm_wood_pole_short"], engineer=2)),
