...
scene_props = [
  ...
  ("pw_tree_a1",spr_tree_flags(),"tree_a01","bo_tree_a01", spr_tree_triggers(full_hp=3500, fell_hp=1200)),
  ("pw_tree_a2",spr_tree_flags(),"tree_a02","bo_tree_a02", spr_tree_triggers(full_hp=4000, fell_hp=1700)),
  ("pw_tree_b1",spr_tree_flags(),"tree_b01","bo_tree_b01", spr_tree_triggers(full_hp=3000, fell_hp=1500)),
  ("pw_tree_b2",spr_tree_flags(),"tree_b02","bo_tree_b02", spr_tree_triggers(full_hp=3200, fell_hp=1500)),
  ("pw_tree_c1",spr_tree_flags(),"tree_c01","bo_tree_c01", spr_tree_triggers(full_hp=2500, fell_hp=1100)),
  ("pw_tree_c2",spr_tree_flags(),"tree_c02","bo_tree_c02", spr_tree_triggers(full_hp=3000, fell_hp=1300)),
  ("pw_tree_e1",spr_tree_flags(),"tree_e_1","bo_tree_e_1", spr_tree_triggers(full_hp=2500, fell_hp=1200, resource_imod=imod_cracked)),
  ("pw_tree_e2",spr_tree_flags(),"tree_e_2","bo_tree_e_2", spr_tree_triggers(full_hp=2100, fell_hp=800, resource_imod=imod_cracked)),
  ("pw_tree_e3",spr_tree_flags(),"tree_e_3","bo_tree_e_3", spr_tree_triggers(full_hp=2300, fell_hp=900, resource_imod=imod_cracked)),
  ("pw_tree_f1",spr_tree_flags(),"tree_f_1","bo_tree_f_1", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_f2",spr_tree_flags(),"tree_f_2","bo_tree_f_1", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_f3",spr_tree_flags(),"tree_f_3","bo_tree_f_1", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ...
  ("pw_tree_pine_1a",spr_tree_flags(),"pine_1_a","bo_pine_1_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_pine_1b",spr_tree_flags(),"pine_1_b","bo_pine_1_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_pine_2a",spr_tree_flags(),"pine_2_a","bo_pine_2_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_pine_3a",spr_tree_flags(),"pine_3_a","bo_pine_3_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_pine_4a",spr_tree_flags(),"pine_4_a","bo_pine_4_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_pine_6a",spr_tree_flags(),"pine_6_a","bo_pine_6_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_hp=200, resource_imod=imod_bent)),
  ("pw_tree_plane_a",spr_tree_flags(),"tree_plane_a","bo_tree_plane_a", spr_tree_triggers(full_hp=3500, fell_hp=1400)),
  ("pw_tree_plane_b",spr_tree_flags(),"tree_plane_b","bo_tree_plane_b", spr_tree_triggers(full_hp=3000, fell_hp=1000)),
  ("pw_tree_plane_c",spr_tree_flags(),"tree_plane_c","bo_tree_plane_c", spr_tree_triggers(full_hp=2500, fell_hp=1000)),
  ("pw_tree_plane_d",spr_tree_flags(),"plane_d","bo_plane_d", spr_tree_triggers(full_hp=1700, fell_hp=600)),
  ("pw_tree_beech_d",spr_tree_flags(),"beech_d","bo_beech_d", spr_tree_triggers(full_hp=3500, fell_hp=1500, resource_imod=imod_cracked)),
  ("pw_tree_beech_e",spr_tree_flags(),"beech_e","bo_beech_e", spr_tree_triggers(full_hp=3800, fell_hp=1700, resource_imod=imod_cracked)),
  ("pw_tree_tall_a",spr_tree_flags(),"tall_tree_a","bo_tall_tree_a", spr_tree_triggers(full_hp=3000, fell_hp=1300, resource_hp=200)),
  ("pw_tree_snowy_a",spr_tree_flags(),"tree_snowy_a","bo_tree_snowy_a", spr_tree_triggers(full_hp=6000, fell_hp=1900, resource_imod=imod_bent)),
  ("pw_tree_snowy_b",spr_tree_flags(),"snowy_pine_2","bo_snowy_pine_2", spr_tree_triggers(full_hp=6000, fell_hp=2000, resource_imod=imod_bent)),
  ("pw_tree_1a",spr_tree_flags(),"tree_1_a","bo_tree_1_a", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_1b",spr_tree_flags(),"tree_1_b","bo_tree_1_b", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_2a",spr_tree_flags(),"tree_2_a","bo_tree_2_a", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_2b",spr_tree_flags(),"tree_2_b","bo_tree_2_b", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_3a",spr_tree_flags(),"tree_3_a","bo_tree_3_a", spr_tree_triggers(full_hp=2500, fell_hp=1300)),
  ("pw_tree_3b",spr_tree_flags(),"tree_3_b","bo_tree_3_b", spr_tree_triggers(full_hp=2700, fell_hp=1400)),
  ("pw_tree_4a",spr_tree_flags(),"tree_4_a","bo_tree_4_a", spr_tree_triggers(full_hp=2500, fell_hp=1500)),
  ("pw_tree_4b",spr_tree_flags(),"tree_4_b","bo_tree_4_b", spr_tree_triggers(full_hp=2100, fell_hp=1000)),
  ("pw_tree_5a",spr_tree_flags(),"tree_5_a","bo_tree_5_a", spr_tree_triggers(full_hp=2000, fell_hp=700)),
  ("pw_tree_5b",spr_tree_flags(),"tree_5_b","bo_tree_5_b", spr_tree_triggers(full_hp=1800, fell_hp=700)),
  ("pw_tree_5c",spr_tree_flags(),"tree_5_c","bo_tree_5_c", spr_tree_triggers(full_hp=1700, fell_hp=650)),
  ("pw_tree_5d",spr_tree_flags(),"tree_5_d","bo_tree_5_d", spr_tree_triggers(full_hp=1800, fell_hp=800)),
  ("pw_tree_6a",spr_tree_flags(),"tree_6_a","bo_tree_6_a", spr_tree_triggers(full_hp=2000, fell_hp=900)),
  ("pw_tree_6b",spr_tree_flags(),"tree_6_b","bo_tree_6_b", spr_tree_triggers(full_hp=2300, fell_hp=1100)),
  ("pw_tree_6c",spr_tree_flags(),"tree_6_c","bo_tree_6_c", spr_tree_triggers(full_hp=1800, fell_hp=1000)),
  ("pw_tree_6d",spr_tree_flags(),"tree_6_d","bo_tree_6_d", spr_tree_triggers(full_hp=2100, fell_hp=1100)),
  ("pw_tree_7a",spr_tree_flags(),"tree_7_a","bo_tree_7_a", spr_tree_triggers(full_hp=2000, fell_hp=1000)),
  ("pw_tree_7b",spr_tree_flags(),"tree_7_b","bo_tree_7_b", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pw_tree_7c",spr_tree_flags(),"tree_7_c","bo_tree_7_c", spr_tree_triggers(full_hp=2300, fell_hp=1300)),
  ("pw_tree_8a",spr_tree_flags(),"tree_8_a","bo_tree_8_a", spr_tree_triggers(full_hp=2400, fell_hp=1800, resource_imod=imod_cracked)),
  ("pw_tree_8b",spr_tree_flags(),"tree_8_b","bo_tree_8_b", spr_tree_triggers(full_hp=2700, fell_hp=1700, resource_imod=imod_cracked)),
  ("pw_tree_8c",spr_tree_flags(),"tree_8_c","bo_tree_8_c", spr_tree_triggers(full_hp=2600, fell_hp=1300, resource_imod=imod_cracked)),
  ("pw_tree_9a",spr_tree_flags(),"tree_9_a","bo_tree_9_a", spr_tree_triggers(full_hp=2100, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_9b",spr_tree_flags(),"tree_9_b","bo_tree_9_a", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_9c",spr_tree_flags(),"tree_9_c","bo_tree_9_a", spr_tree_triggers(full_hp=2400, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_10a",spr_tree_flags(),"tree_10_a","bo_tree_10_a", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_10b",spr_tree_flags(),"tree_10_b","bo_tree_10_a", spr_tree_triggers(full_hp=1900, fell_hp=900, resource_imod=imod_cracked)),
  ("pw_tree_10c",spr_tree_flags(),"tree_10_c","bo_tree_10_a", spr_tree_triggers(full_hp=1700, fell_hp=700, resource_imod=imod_cracked)),
  ("pw_tree_11a",spr_tree_flags(),"tree_11_a","bo_tree_11_a", spr_tree_triggers(full_hp=2200, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_11b",spr_tree_flags(),"tree_11_b","bo_tree_11_a", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_11c",spr_tree_flags(),"tree_11_c","bo_tree_11_a", spr_tree_triggers(full_hp=2000, fell_hp=1100, resource_imod=imod_cracked)),
  ("pw_tree_12a",spr_tree_flags(),"tree_12_a","bo_tree_12_a", spr_tree_triggers(full_hp=1800, fell_hp=700, resource_imod=imod_cracked)),
  ("pw_tree_12b",spr_tree_flags(),"tree_12_b","bo_tree_12_b", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_12c",spr_tree_flags(),"tree_12_c","bo_tree_12_c", spr_tree_triggers(full_hp=1700, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_14a",spr_tree_flags(),"tree_14_a","bo_tree_14_a", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pw_tree_14b",spr_tree_flags(),"tree_14_b","bo_tree_14_b", spr_tree_triggers(full_hp=2400, fell_hp=1200)),
  ("pw_tree_14c",spr_tree_flags(),"tree_14_c","bo_tree_14_c", spr_tree_triggers(full_hp=2500, fell_hp=1200)),
  ("pw_tree_15a",spr_tree_flags(),"tree_15_a","bo_tree_15_a", spr_tree_triggers(full_hp=2500, fell_hp=1100)),
  ("pw_tree_15b",spr_tree_flags(),"tree_15_b","bo_tree_15_b", spr_tree_triggers(full_hp=2300, fell_hp=1100)),
  ("pw_tree_15c",spr_tree_flags(),"tree_15_c","bo_tree_15_c", spr_tree_triggers(full_hp=2000, fell_hp=900)),
  ("pw_tree_16a",spr_tree_flags(),"tree_16_a","bo_tree_16_a", spr_tree_triggers(full_hp=3000, fell_hp=1600)),
  ("pw_tree_16b",spr_tree_flags(),"tree_16_b","bo_tree_16_b", spr_tree_triggers(full_hp=2200, fell_hp=1300)),
  ("pw_tree_17a",spr_tree_flags(),"tree_17_a","bo_tree_17_a", spr_tree_triggers(full_hp=1400, fell_hp=500)),
  ("pw_tree_17b",spr_tree_flags(),"tree_17_b","bo_tree_17_b", spr_tree_triggers(full_hp=1500, fell_hp=600)),
  ("pw_tree_17c",spr_tree_flags(),"tree_17_c","bo_tree_17_c", spr_tree_triggers(full_hp=1500, fell_hp=700)),
  ("pw_tree_17d",spr_tree_flags(),"tree_17_d","bo_tree_17_d", spr_tree_triggers(full_hp=1400, fell_hp=600)),
  ("pw_tree_18a",spr_tree_flags(),"tree_18_a","bo_tree_18_a", spr_tree_triggers(full_hp=2000, fell_hp=900, resource_imod=imod_cracked)),
  ("pw_tree_18b",spr_tree_flags(),"tree_18_b","bo_tree_18_b", spr_tree_triggers(full_hp=2000, fell_hp=800, resource_imod=imod_cracked)),
  ("pw_tree_19a",spr_tree_flags(),"tree_19_a","bo_tree_19_a", spr_tree_triggers(full_hp=2500, fell_hp=1500, resource_imod=imod_cracked)),
  ("pw_tree_20a",spr_tree_flags(),"tree_20_a","bo_tree_20_a", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ("pw_tree_20b",spr_tree_flags(),"tree_20_b","bo_tree_20_b", spr_tree_triggers(full_hp=2200, fell_hp=1000)),
  ...
  ("pw_buy_headcloth",spr_buy_item_flags(1),"headcloth_a_new","bo_armor_head", spr_buy_item_triggers("itm_headcloth", resources=[], skill_required=1, tableau="tableau_colored_helmets_new_d")),
  ("pw_buy_woolen_cap",spr_buy_item_flags(1),"woolen_cap_new","bo_armor_head", spr_buy_item_triggers("itm_woolen_cap", resources=[], skill_required=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_sarranid_felt_hat",spr_buy_item_flags(1),"sar_helmet3","bo_armor_head", spr_buy_item_triggers("itm_sarranid_felt_hat", resources=[], skill_required=1)),
  ("pw_buy_sarranid_felt_head_cloth",spr_buy_item_flags(1),"common_tulbent","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth", resources=[], skill_required=1)),
  ("pw_buy_sarranid_felt_head_cloth_b",spr_buy_item_flags(1),"common_tulbent_b","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_felt_head_cloth_b", resources=[], skill_required=1)),
  ("pw_buy_bride_crown",spr_buy_item_flags(1),"bride_crown","bo_armor_head_armature", spr_buy_item_triggers("itm_bride_crown", resources=[], skill_required=1)),
  ("pw_buy_khergit_lady_hat",spr_buy_item_flags(1),"khergit_lady_hat","bo_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat", resources=[], skill_required=1)),
  ("pw_buy_khergit_lady_hat_b",spr_buy_item_flags(1),"khergit_lady_hat_b","bo_armor_head", spr_buy_item_triggers("itm_khergit_lady_hat_b", resources=[], skill_required=1)),
  ("pw_buy_sarranid_head_cloth",spr_buy_item_flags(1),"tulbent","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth", resources=[], skill_required=1)),
  ("pw_buy_sarranid_head_cloth_b",spr_buy_item_flags(1),"tulbent_b","bo_armor_head_armature", spr_buy_item_triggers("itm_sarranid_head_cloth_b", resources=[], skill_required=1)),
  ("pw_buy_wimple_a",spr_buy_item_flags(1),"wimple_a_new","bo_armor_head", spr_buy_item_triggers("itm_wimple_a", resources=[], skill_required=1)),
  ("pw_buy_wimple_b",spr_buy_item_flags(1),"wimple_b_new","bo_armor_head", spr_buy_item_triggers("itm_wimple_b", resources=[], skill_required=1)),
  ...
  ("pw_buy_common_hood",spr_buy_item_flags(1),"hood_new","bo_armor_head", spr_buy_item_triggers("itm_common_hood", resources=[], skill_required=1, tableau="tableau_colored_helmets_new_e")),
  ("pw_buy_hood_b",spr_buy_item_flags(1),"hood_b","bo_armor_head", spr_buy_item_triggers("itm_hood_b", resources=[], skill_required=1)),
  ("pw_buy_hood_c",spr_buy_item_flags(1),"hood_c","bo_armor_head", spr_buy_item_triggers("itm_hood_c", resources=[], skill_required=1)),
  ("pw_buy_hood_d",spr_buy_item_flags(1),"hood_d","bo_armor_head", spr_buy_item_triggers("itm_hood_d", resources=[], skill_required=1)),
  ("pw_buy_nomad_cap",spr_buy_item_flags(1),"nomad_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_nomad_cap", resources=[], skill_required=1)),
  ("pw_buy_nomad_cap_b",spr_buy_item_flags(1),"nomad_cap_b_new","bo_armor_head", spr_buy_item_triggers("itm_nomad_cap_b", resources=[], skill_required=1)),
  ("pw_buy_black_hood",spr_buy_item_flags(1),"hood_black","bo_armor_head", spr_buy_item_triggers("itm_black_hood", resources=[], skill_required=1)),
  ("pw_buy_pilgrim_hood",spr_buy_item_flags(1),"pilgrim_hood","bo_armor_head", spr_buy_item_triggers("itm_pilgrim_hood", resources=[], skill_required=1)),
  ("pw_buy_padded_coif",spr_buy_item_flags(1),"padded_coif_a_new","bo_armor_head", spr_buy_item_triggers("itm_padded_coif", resources=[], skill_required=1, tableau="tableau_colored_helmets_new_b")),
  ("pw_buy_turban",spr_buy_item_flags(1),"tuareg_open","bo_armor_head", spr_buy_item_triggers("itm_turban", resources=[], skill_required=1)),
  ("pw_buy_leather_steppe_cap_a",spr_buy_item_flags(1),"leather_steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_a", resources=[], skill_required=1)),
  ("pw_buy_leather_steppe_cap_b",spr_buy_item_flags(1),"tattered_steppe_cap_b_new","bo_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_b", resources=[], skill_required=1)),
  ("pw_buy_nordic_archer_helmet",spr_buy_item_flags(1),"Helmet_A_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_archer_helmet", resources=[], skill_required=1)),
  ("pw_buy_vaegir_fur_cap",spr_buy_item_flags(1),"vaeg_helmet3","bo_armor_head", spr_buy_item_triggers("itm_vaegir_fur_cap", resources=[], skill_required=1)),
  ("pw_buy_steppe_cap",spr_buy_item_flags(1),"steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_steppe_cap", resources=[], skill_required=1)),
  ("pw_buy_leather_warrior_cap",spr_buy_item_flags(1),"skull_cap_new_b","bo_armor_head", spr_buy_item_triggers("itm_leather_warrior_cap", resources=[], skill_required=1)),
  ("pw_buy_sarranid_warrior_cap",spr_buy_item_flags(1),"tuareg_helmet","bo_armor_head", spr_buy_item_triggers("itm_sarranid_warrior_cap", resources=[], skill_required=1)),
  ("pw_buy_nordic_veteran_archer_helmet",spr_buy_item_flags(1),"Helmet_A","bo_armor_head", spr_buy_item_triggers("itm_nordic_veteran_archer_helmet", resources=[], skill_required=1)),
  ("pw_buy_skullcap",spr_buy_item_flags(1),"skull_cap_new_a","bo_armor_head", spr_buy_item_triggers("itm_skullcap", resources=[], skill_required=1)),
  ("pw_buy_vaegir_fur_helmet",spr_buy_item_flags(1),"vaeg_helmet2","bo_armor_head", spr_buy_item_triggers("itm_vaegir_fur_helmet", resources=[], skill_required=1)),
  ("pw_buy_mail_coif",spr_buy_item_flags(1),"mail_coif_new","bo_armor_head", spr_buy_item_triggers("itm_mail_coif", resources=[], skill_required=1)),
  ("pw_buy_footman_helmet",spr_buy_item_flags(1),"skull_cap_new","bo_armor_head", spr_buy_item_triggers("itm_footman_helmet", resources=[], skill_required=1)),
  ("pw_buy_sarranid_horseman_helmet",spr_buy_item_flags(1),"sar_helmet2","bo_armor_head", spr_buy_item_triggers("itm_sarranid_horseman_helmet", resources=[], skill_required=1)),
  ("pw_buy_norman_helmet",spr_buy_item_flags(1),"norman_helmet_a","bo_armor_head", spr_buy_item_triggers("itm_norman_helmet", resources=[], skill_required=1)),
  ("pw_buy_nordic_footman_helmet",spr_buy_item_flags(1),"Helmet_B_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_footman_helmet", resources=[], skill_required=1)),
  ("pw_buy_khergit_war_helmet",spr_buy_item_flags(1),"tattered_steppe_cap_a_new","bo_armor_head", spr_buy_item_triggers("itm_khergit_war_helmet", resources=[], skill_required=1)),
  ("pw_buy_segmented_helmet",spr_buy_item_flags(1),"segmented_helm_new","bo_armor_head", spr_buy_item_triggers("itm_segmented_helmet", resources=[], skill_required=1)),
  ("pw_buy_vaegir_spiked_helmet",spr_buy_item_flags(1),"vaeg_helmet1","bo_armor_head", spr_buy_item_triggers("itm_vaegir_spiked_helmet", resources=[], skill_required=1)),
  ("pw_buy_helmet_with_neckguard",spr_buy_item_flags(1),"neckguard_helm_new","bo_armor_head", spr_buy_item_triggers("itm_helmet_with_neckguard", resources=[], skill_required=1)),
  ("pw_buy_flat_topped_helmet",spr_buy_item_flags(1),"flattop_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_flat_topped_helmet", resources=[], skill_required=1)),
  ("pw_buy_nordic_fighter_helmet",spr_buy_item_flags(1),"Helmet_B","bo_armor_head", spr_buy_item_triggers("itm_nordic_fighter_helmet", resources=[], skill_required=1)),
  ("pw_buy_kettle_hat",spr_buy_item_flags(1),"kettle_hat_new","bo_armor_head", spr_buy_item_triggers("itm_kettle_hat", resources=[], skill_required=1)),
  ("pw_buy_sarranid_helmet1",spr_buy_item_flags(1),"sar_helmet1","bo_armor_head", spr_buy_item_triggers("itm_sarranid_helmet1", resources=[], skill_required=1)),
  ("pw_buy_vaegir_lamellar_helmet",spr_buy_item_flags(1),"vaeg_helmet4","bo_armor_head", spr_buy_item_triggers("itm_vaegir_lamellar_helmet", resources=[], skill_required=1)),
  ("pw_buy_spiked_helmet",spr_buy_item_flags(1),"spiked_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_spiked_helmet", resources=[], skill_required=1)),
  ("pw_buy_sarranid_mail_coif",spr_buy_item_flags(1),"tuareg_helmet2","bo_armor_head", spr_buy_item_triggers("itm_sarranid_mail_coif", resources=[], skill_required=1)),
  ("pw_buy_nordic_huscarl_helmet",spr_buy_item_flags(1),"Helmet_C_vs2","bo_armor_head", spr_buy_item_triggers("itm_nordic_huscarl_helmet", resources=[], skill_required=1)),
  ("pw_buy_bascinet",spr_buy_item_flags(1),"bascinet_avt_new","bo_armor_head", spr_buy_item_triggers("itm_bascinet", resources=[], skill_required=1)),
  ("pw_buy_bascinet_2",spr_buy_item_flags(1),"bascinet_new_a","bo_armor_head", spr_buy_item_triggers("itm_bascinet_2", resources=[], skill_required=1)),
  ("pw_buy_bascinet_3",spr_buy_item_flags(1),"bascinet_new_b","bo_armor_head", spr_buy_item_triggers("itm_bascinet_3", resources=[], skill_required=1)),
  ("pw_buy_vaegir_noble_helmet",spr_buy_item_flags(1),"vaeg_helmet7","bo_armor_head", spr_buy_item_triggers("itm_vaegir_noble_helmet", resources=[], skill_required=1)),
  ("pw_buy_guard_helmet",spr_buy_item_flags(1),"reinf_helmet_new","bo_armor_head", spr_buy_item_triggers("itm_guard_helmet", resources=[], skill_required=1)),
  ("pw_buy_sarranid_veiled_helmet",spr_buy_item_flags(1),"sar_helmet4","bo_armor_head", spr_buy_item_triggers("itm_sarranid_veiled_helmet", resources=[], skill_required=1)),
  ("pw_buy_vaegir_war_helmet",spr_buy_item_flags(1),"vaeg_helmet6","bo_armor_head", spr_buy_item_triggers("itm_vaegir_war_helmet", resources=[], skill_required=1)),
  ...
  ("pw_buy_shirt",spr_buy_item_flags(1),"shirt","bo_armor_body", spr_buy_item_triggers("itm_shirt", resources=[], skill_required=1)),
  ("pw_buy_linen_tunic",spr_buy_item_flags(1),"shirt_a","bo_armor_body", spr_buy_item_triggers("itm_linen_tunic", resources=[], skill_required=1)),
  ("pw_buy_black_robe",spr_buy_item_flags(1),"robe","bo_armor_body", spr_buy_item_triggers("itm_black_robe", resources=[], skill_required=1)),
  ("pw_buy_dress",spr_buy_item_flags(1),"dress","bo_armor_body", spr_buy_item_triggers("itm_dress", resources=[], skill_required=1)),
  ("pw_buy_blue_dress",spr_buy_item_flags(1),"blue_dress_new","bo_armor_body", spr_buy_item_triggers("itm_blue_dress", resources=[], skill_required=1)),
  ("pw_buy_peasant_dress",spr_buy_item_flags(1),"peasant_dress_b_new","bo_armor_body", spr_buy_item_triggers("itm_peasant_dress", resources=[], skill_required=1)),
  ("pw_buy_woolen_dress",spr_buy_item_flags(1),"woolen_dress","bo_armor_body", spr_buy_item_triggers("itm_woolen_dress", resources=[], skill_required=1)),
  ("pw_buy_sarranid_common_dress",spr_buy_item_flags(1),"sarranid_common_dress","bo_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress", resources=[], skill_required=1)),
  ("pw_buy_sarranid_common_dress_b",spr_buy_item_flags(1),"sarranid_common_dress_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_common_dress_b", resources=[], skill_required=1)),
  ...
  ("pw_buy_sarranid_lady_dress",spr_buy_item_flags(1),"sarranid_lady_dress","bo_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress", resources=[], skill_required=1)),
  ("pw_buy_sarranid_lady_dress_b",spr_buy_item_flags(1),"sarranid_lady_dress_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_lady_dress_b", resources=[], skill_required=1)),
  ("pw_buy_khergit_lady_dress",spr_buy_item_flags(1),"khergit_lady_dress","bo_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress", resources=[], skill_required=1)),
  ("pw_buy_khergit_lady_dress_b",spr_buy_item_flags(1),"khergit_lady_dress_b","bo_armor_body", spr_buy_item_triggers("itm_khergit_lady_dress_b", resources=[], skill_required=1)),
  ("pw_buy_bride_dress",spr_buy_item_flags(1),"bride_dress","bo_armor_body", spr_buy_item_triggers("itm_bride_dress", resources=[], skill_required=1)),
  ("pw_buy_tunic_with_green_cape",spr_buy_item_flags(1),"peasant_man_a","bo_armor_body", spr_buy_item_triggers("itm_tunic_with_green_cape", resources=[], skill_required=1)),
  ("pw_buy_rough_tunic",spr_buy_item_flags(1),"cvl_costume_a","bo_armor_body", spr_buy_item_triggers("itm_rough_tunic", resources=[], skill_required=1)),
  ("pw_buy_red_shirt",spr_buy_item_flags(1),"rich_tunic_a","bo_armor_body", spr_buy_item_triggers("itm_red_shirt", resources=[], skill_required=1)),
  ("pw_buy_pelt_coat",spr_buy_item_flags(1),"thick_coat_a","bo_armor_body", spr_buy_item_triggers("itm_pelt_coat", resources=[], skill_required=1)),
  ("pw_buy_sarranid_cloth_robe",spr_buy_item_flags(1),"sar_robe","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe", resources=[], skill_required=1)),
  ("pw_buy_sarranid_cloth_robe_b",spr_buy_item_flags(1),"sar_robe_b","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cloth_robe_b", resources=[], skill_required=1)),
  ("pw_buy_rawhide_coat",spr_buy_item_flags(1),"coat_of_plates_b","bo_armor_body", spr_buy_item_triggers("itm_rawhide_coat", resources=[], skill_required=1)),
  ("pw_buy_coarse_tunic",spr_buy_item_flags(1),"coarse_tunic_a","bo_armor_body", spr_buy_item_triggers("itm_coarse_tunic", resources=[], skill_required=1)),
  ("pw_buy_leather_apron",spr_buy_item_flags(1),"leather_apron","bo_armor_body", spr_buy_item_triggers("itm_leather_apron", resources=[], skill_required=1)),
  ("pw_buy_fur_coat",spr_buy_item_flags(1),"fur_coat","bo_armor_body", spr_buy_item_triggers("itm_fur_coat", resources=[], skill_required=1)),
  ("pw_buy_skirmisher_armor",spr_buy_item_flags(1),"skirmisher_armor","bo_armor_body", spr_buy_item_triggers("itm_skirmisher_armor", resources=[], skill_required=1)),
  ("pw_buy_rich_outfit",spr_buy_item_flags(1),"merchant_outf","bo_armor_body", spr_buy_item_triggers("itm_rich_outfit", resources=[], skill_required=1)),
  ("pw_buy_tabard",spr_buy_item_flags(1),"tabard_b","bo_armor_body", spr_buy_item_triggers("itm_tabard", resources=[], skill_required=1, tableau="tableau_heraldic_tabard_b")),
  ("pw_buy_khergit_armor",spr_buy_item_flags(1),"khergit_armor_new","bo_armor_body", spr_buy_item_triggers("itm_khergit_armor", resources=[], skill_required=1)),
  ("pw_buy_leather_vest",spr_buy_item_flags(1),"leather_vest_a","bo_armor_body", spr_buy_item_triggers("itm_leather_vest", resources=[], skill_required=1, tableau="tableau_heraldic_leather_vest_a")),
  ("pw_buy_leather_jacket",spr_buy_item_flags(1),"leather_jacket_new","bo_armor_body", spr_buy_item_triggers("itm_leather_jacket", resources=[], skill_required=1)),
  ("pw_buy_arena_tunic",spr_buy_item_flags(1),"arena_tunicW_new","bo_armor_body", spr_buy_item_triggers("itm_arena_tunic", resources=[], skill_required=1, tableau="tableau_colored_arena_tunic")),
  ("pw_buy_steppe_armor",spr_buy_item_flags(1),"lamellar_leather","bo_armor_body", spr_buy_item_triggers("itm_steppe_armor", resources=[], skill_required=1, tableau="tableau_colored_lamellar_leather")),
  ("pw_buy_leather_armor",spr_buy_item_flags(1),"tattered_leather_armor_a","bo_armor_body", spr_buy_item_triggers("itm_leather_armor", resources=[], skill_required=1)),
  ("pw_buy_pilgrim_disguise",spr_buy_item_flags(1),"pilgrim_outfit","bo_armor_body", spr_buy_item_triggers("itm_pilgrim_disguise", resources=[], skill_required=1)),
  ("pw_buy_red_gambeson",spr_buy_item_flags(1),"red_gambeson_a","bo_armor_body", spr_buy_item_triggers("itm_red_gambeson", resources=[], skill_required=1)),
  ("pw_buy_padded_cloth",spr_buy_item_flags(1),"padded_cloth_a","bo_armor_body", spr_buy_item_triggers("itm_padded_cloth", resources=[], skill_required=1, tableau="tableau_heraldic_padded_cloth_a")),
  ("pw_buy_aketon_green",spr_buy_item_flags(1),"padded_cloth_b","bo_armor_body", spr_buy_item_triggers("itm_aketon_green", resources=[], skill_required=1, tableau="tableau_heraldic_padded_cloth_b")),
  ("pw_buy_archers_vest",spr_buy_item_flags(1),"archers_vest","bo_armor_body", spr_buy_item_triggers("itm_archers_vest", resources=[], skill_required=1)),
  ("pw_buy_nomad_vest",spr_buy_item_flags(1),"nomad_vest_new","bo_armor_body", spr_buy_item_triggers("itm_nomad_vest", resources=[], skill_required=1)),
  ("pw_buy_ragged_outfit",spr_buy_item_flags(1),"ragged_outfit_a_new","bo_armor_body", spr_buy_item_triggers("itm_ragged_outfit", resources=[], skill_required=1)),
  ("pw_buy_nomad_armor",spr_buy_item_flags(1),"nomad_armor_new","bo_armor_body", spr_buy_item_triggers("itm_nomad_armor", resources=[], skill_required=1)),
  ("pw_buy_nomad_robe",spr_buy_item_flags(1),"nomad_robe_a","bo_armor_body", spr_buy_item_triggers("itm_nomad_robe", resources=[], skill_required=1)),
  ("pw_buy_light_leather",spr_buy_item_flags(1),"light_leather","bo_armor_body", spr_buy_item_triggers("itm_light_leather", resources=[], skill_required=1)),
  ("pw_buy_leather_jerkin",spr_buy_item_flags(1),"ragged_leather_jerkin","bo_armor_body", spr_buy_item_triggers("itm_leather_jerkin", resources=[], skill_required=1)),
  ("pw_buy_padded_leather",spr_buy_item_flags(1),"leather_armor_b","bo_armor_body", spr_buy_item_triggers("itm_padded_leather", resources=[], skill_required=1)),
  ("pw_buy_arena_armor",spr_buy_item_flags(1),"arena_armorW_new","bo_armor_body", spr_buy_item_triggers("itm_arena_armor", resources=[], skill_required=1, tableau="tableau_colored_arena_armor")),
  ("pw_buy_tribal_warrior_outfit",spr_buy_item_flags(1),"tribal_warrior_outfit_a_new","bo_armor_body", spr_buy_item_triggers("itm_tribal_warrior_outfit", resources=[], skill_required=1)),
  ("pw_buy_sarranid_leather_armor",spr_buy_item_flags(1),"sarranid_leather_armor","bo_armor_body", spr_buy_item_triggers("itm_sarranid_leather_armor", resources=[], skill_required=1)),
  ("pw_buy_courtly_outfit",spr_buy_item_flags(1),"nobleman_outf","bo_armor_body", spr_buy_item_triggers("itm_courtly_outfit", resources=[], skill_required=1)),
  ("pw_buy_nobleman_outfit",spr_buy_item_flags(1),"nobleman_outfit_b_new","bo_armor_body", spr_buy_item_triggers("itm_nobleman_outfit", resources=[], skill_required=1)),
  ("pw_buy_sarranid_cavalry_robe",spr_buy_item_flags(1),"arabian_armor_a","bo_armor_body", spr_buy_item_triggers("itm_sarranid_cavalry_robe", resources=[], skill_required=1)),
  ("pw_buy_studded_leather_coat",spr_buy_item_flags(1),"leather_armor_a","bo_armor_body", spr_buy_item_triggers("itm_studded_leather_coat", resources=[], skill_required=1)),
  ("pw_buy_byrnie",spr_buy_item_flags(1),"byrnie_a_new","bo_armor_body", spr_buy_item_triggers("itm_byrnie", resources=[], skill_required=1)),
  ("pw_buy_haubergeon",spr_buy_item_flags(1),"haubergeon_c","bo_armor_body", spr_buy_item_triggers("itm_haubergeon", resources=[], skill_required=1)),
  ("pw_buy_arabian_armor_b",spr_buy_item_flags(1),"arabian_armor_b","bo_armor_body", spr_buy_item_triggers("itm_arabian_armor_b", resources=[], skill_required=1)),
  ("pw_buy_lamellar_vest",spr_buy_item_flags(1),"lamellar_vest_a","bo_armor_body", spr_buy_item_triggers("itm_lamellar_vest", resources=[], skill_required=1)),
  ("pw_buy_lamellar_vest_khergit",spr_buy_item_flags(1),"lamellar_vest_b","bo_armor_body", spr_buy_item_triggers("itm_lamellar_vest_khergit", tableau="tableau_colored_lamellar_vest_b")),
  ("pw_buy_mail_shirt",spr_buy_item_flags(1),"mail_shirt_a","bo_armor_body", spr_buy_item_triggers("itm_mail_shirt", resources=[], skill_required=1)),
  ("pw_buy_mail_hauberk",spr_buy_item_flags(1),"hauberk_a_new","bo_armor_body", spr_buy_item_triggers("itm_mail_hauberk", resources=[], skill_required=1)),
  ("pw_buy_sarranid_mail_shirt",spr_buy_item_flags(1),"sarranian_mail_shirt","bo_armor_body", spr_buy_item_triggers("itm_sarranid_mail_shirt", resources=[], skill_required=1)),
  ("pw_buy_mail_with_surcoat",spr_buy_item_flags(1),"mail_long_surcoat_new","bo_armor_body", spr_buy_item_triggers("itm_mail_with_surcoat", tableau="tableau_heraldic_mail_long_surcoat")),
  ("pw_buy_surcoat_over_mail",spr_buy_item_flags(1),"surcoat_over_mail_new","bo_armor_body", spr_buy_item_triggers("itm_surcoat_over_mail", tableau="tableau_heraldic_surcoat_over_mail")),
  ("pw_buy_brigandine_red",spr_buy_item_flags(1),"brigandine_b","bo_armor_body", spr_buy_item_triggers("itm_brigandine_red", resources=[], skill_required=1, tableau="tableau_heraldic_brigandine_b")),
  ("pw_buy_mamluke_mail",spr_buy_item_flags(1),"sarranid_elite_cavalary","bo_armor_body", spr_buy_item_triggers("itm_mamluke_mail", resources=[], skill_required=1)),
  ("pw_buy_lamellar_armor",spr_buy_item_flags(1),"lamellar_armor_b","bo_armor_body", spr_buy_item_triggers("itm_lamellar_armor", resources=[], skill_required=1)),
  ("pw_buy_scale_armor",spr_buy_item_flags(1),"lamellar_armor_e","bo_armor_body", spr_buy_item_triggers("itm_scale_armor", resources=[], skill_required=1)),
  ("pw_buy_banded_armor",spr_buy_item_flags(1),"banded_armor_a","bo_armor_body", spr_buy_item_triggers("itm_banded_armor", resources=[], skill_required=1)),
  ("pw_buy_cuir_bouilli",spr_buy_item_flags(1),"cuir_bouilli_a","bo_armor_body", spr_buy_item_triggers("itm_cuir_bouilli", resources=[], skill_required=1)),
  ("pw_buy_coat_of_plates",spr_buy_item_flags(1),"coat_of_plates_a","bo_armor_body", spr_buy_item_triggers("itm_coat_of_plates", resources=[], skill_required=1)),
  ("pw_buy_coat_of_plates_red",spr_buy_item_flags(1),"coat_of_plates_red","bo_armor_body", spr_buy_item_triggers("itm_coat_of_plates_red", tableau="tableau_heraldic_coat_of_plates")),
  ("pw_buy_khergit_elite_armor",spr_buy_item_flags(1),"lamellar_armor_d","bo_armor_body", spr_buy_item_triggers("itm_khergit_elite_armor", tableau="tableau_heraldic_lamellar_armor_d")),
  ("pw_buy_vaegir_elite_armor",spr_buy_item_flags(1),"lamellar_armor_c","bo_armor_body", spr_buy_item_triggers("itm_vaegir_elite_armor", resources=[], skill_required=1)),
  ("pw_buy_sarranid_elite_armor",spr_buy_item_flags(1),"tunic_armor_a","bo_armor_body", spr_buy_item_triggers("itm_sarranid_elite_armor", resources=[], skill_required=1)),
  ("pw_buy_plate_armor",spr_buy_item_flags(1),"full_plate_armor","bo_armor_body", spr_buy_item_triggers("itm_plate_armor", resources=[], skill_required=1)),
  ("pw_buy_black_armor",spr_buy_item_flags(1),"black_armor","bo_armor_body", spr_buy_item_triggers("itm_black_armor", resources=[], skill_required=1)),
  ...
  ("pw_buy_wrapping_boots",spr_buy_item_flags(1),"wrapping_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_wrapping_boots", resources=[], skill_required=1)),
  ("pw_buy_woolen_hose",spr_buy_item_flags(1),"woolen_hose_a","bo_armor_foot", spr_buy_item_triggers("itm_woolen_hose", resources=[], skill_required=1)),
  ("pw_buy_blue_hose",spr_buy_item_flags(1),"blue_hose_a","bo_armor_foot", spr_buy_item_triggers("itm_blue_hose", resources=[], skill_required=1)),
  ("pw_buy_bride_shoes",spr_buy_item_flags(1),"bride_shoes","bo_armor_foot", spr_buy_item_triggers("itm_bride_shoes", resources=[], skill_required=1)),
  ("pw_buy_sarranid_boots_a",spr_buy_item_flags(1),"sarranid_shoes","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_a", resources=[], skill_required=1)),
  ("pw_buy_hunter_boots",spr_buy_item_flags(1),"hunter_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_hunter_boots", resources=[], skill_required=1)),
  ("pw_buy_hide_boots",spr_buy_item_flags(1),"hide_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_hide_boots", resources=[], skill_required=1)),
  ("pw_buy_ankle_boots",spr_buy_item_flags(1),"ankle_boots_a_new","bo_armor_foot", spr_buy_item_triggers("itm_ankle_boots", resources=[], skill_required=1)),
  ("pw_buy_nomad_boots",spr_buy_item_flags(1),"nomad_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_nomad_boots", resources=[], skill_required=1)),
  ("pw_buy_light_leather_boots",spr_buy_item_flags(1),"light_leather_boots","bo_armor_foot", spr_buy_item_triggers("itm_light_leather_boots", resources=[], skill_required=1)),
  ("pw_buy_leather_boots",spr_buy_item_flags(1),"leather_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_leather_boots", resources=[], skill_required=1)),
  ("pw_buy_sarranid_boots_b",spr_buy_item_flags(1),"sarranid_boots","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_b", resources=[], skill_required=1)),
  ("pw_buy_khergit_leather_boots",spr_buy_item_flags(1),"khergit_leather_boots","bo_armor_foot", spr_buy_item_triggers("itm_khergit_leather_boots", resources=[], skill_required=1)),
  ("pw_buy_sarranid_boots_c",spr_buy_item_flags(1),"sarranid_camel_boots","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_c", resources=[], skill_required=1)),
  ("pw_buy_splinted_leather_greaves",spr_buy_item_flags(1),"leather_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_splinted_leather_greaves", resources=[], skill_required=1)),
  ("pw_buy_mail_chausses",spr_buy_item_flags(1),"mail_chausses_a","bo_armor_foot", spr_buy_item_triggers("itm_mail_chausses", resources=[], skill_required=1)),
  ("pw_buy_splinted_greaves",spr_buy_item_flags(1),"splinted_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_splinted_greaves", resources=[], skill_required=1)),
  ("pw_buy_sarranid_boots_d",spr_buy_item_flags(1),"sarranid_mail_chausses","bo_armor_foot", spr_buy_item_triggers("itm_sarranid_boots_d", resources=[], skill_required=1)),
  ("pw_buy_mail_boots",spr_buy_item_flags(1),"mail_boots_a","bo_armor_foot", spr_buy_item_triggers("itm_mail_boots", resources=[], skill_required=1)),
  ("pw_buy_iron_greaves",spr_buy_item_flags(1),"iron_greaves_a","bo_armor_foot", spr_buy_item_triggers("itm_iron_greaves", resources=[], skill_required=1)),
  ("pw_buy_plate_boots",spr_buy_item_flags(1),"plate_boots","bo_armor_foot", spr_buy_item_triggers("itm_plate_boots", resources=[], skill_required=1)),
  ("pw_buy_black_greaves",spr_buy_item_flags(1),"black_greaves","bo_armor_foot", spr_buy_item_triggers("itm_black_greaves", resources=[], skill_required=1)),

  ("pw_buy_leather_gloves",spr_buy_item_flags(1),"leather_gloves_L","bo_armor_hand", spr_buy_item_triggers("itm_leather_gloves", resources=[], skill_required=1)),
  ("pw_buy_mail_mittens",spr_buy_item_flags(1),"mail_mittens_L","bo_armor_hand", spr_buy_item_triggers("itm_mail_mittens", resources=[], skill_required=1)),
  ("pw_buy_lamellar_gauntlets",spr_buy_item_flags(1),"scale_gauntlets_a_L","bo_armor_hand", spr_buy_item_triggers("itm_lamellar_gauntlets", resources=[], skill_required=1)),
  ...
  ("pw_buy_mace_2",spr_buy_item_flags(3),"mace_a","bo_weapon_small", spr_buy_item_triggers("itm_mace_2", resources=["itm_iron_piece", "itm_stick"], skill_required=1)),
  ("pw_buy_mace_4",spr_buy_item_flags(4),"mace_b","bo_weapon_small", spr_buy_item_triggers("itm_mace_4", resources=["itm_iron_piece", "itm_stick"], skill_required=1)),
  ("pw_buy_club_with_spike_head",spr_buy_item_flags(5),"mace_e","bo_weapon", spr_buy_item_triggers("itm_club_with_spike_head", resources=["itm_iron_bar_short", "itm_wood_pole_short"], skill_required=2)),
  ("pw_buy_long_spiked_club",spr_buy_item_flags(6),"mace_long_c","bo_weapon_big", spr_buy_item_triggers("itm_long_spiked_club", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_long_hafted_spiked_mace",spr_buy_item_flags(9),"mace_long_b","bo_weapon_big", spr_buy_item_triggers("itm_long_hafted_spiked_mace", resources=["itm_iron_bar_short", "itm_wood_pole"], skill_required=3)),
  ("pw_buy_fighting_pick",spr_buy_item_flags(8),"fighting_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_fighting_pick", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
  ("pw_buy_military_pick",spr_buy_item_flags(11),"steel_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_military_pick", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_military_sickle",spr_buy_item_flags(10),"military_sickle_a","bo_weapon_small", spr_buy_item_triggers("itm_military_sickle", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
  ("pw_buy_military_hammer",spr_buy_item_flags(9),"military_hammer","bo_weapon_small", spr_buy_item_triggers("itm_military_hammer", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
  ("pw_buy_morningstar",spr_buy_item_flags(26),"mace_morningstar_new","bo_weapon", spr_buy_item_triggers("itm_morningstar", resources=["itm_iron_bar_long", "itm_iron_bar_short"], skill_required=4)),
  ("pw_buy_falchion",spr_buy_item_flags(9),"falchion_new","bo_weapon_small", spr_buy_item_triggers("itm_falchion", resources=["itm_iron_bar"], skill_required=1)),
  ("pw_buy_curved_sword",spr_buy_item_flags(12),"khergit_sword","bo_weapon", spr_buy_item_triggers("itm_curved_sword", resources=["itm_iron_bar"], skill_required=1)),
  ("pw_buy_sword_medieval_a",spr_buy_item_flags(14),"sword_medieval_a","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_a", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_medieval_b_small",spr_buy_item_flags(13),"sword_medieval_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_b_small", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_medieval_c_long",spr_buy_item_flags(16),"sword_medieval_c_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_c_long", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_medieval_d_long",spr_buy_item_flags(15),"sword_medieval_d_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_d_long", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_viking_c",spr_buy_item_flags(13),"sword_viking_c","bo_weapon", spr_buy_item_triggers("itm_sword_viking_c", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_viking_b_small",spr_buy_item_flags(12),"sword_viking_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_viking_b_small", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_sword_viking_a_long",spr_buy_item_flags(15),"sword_viking_a_long","bo_weapon", spr_buy_item_triggers("itm_sword_viking_a_long", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_scimitar",spr_buy_item_flags(18),"scimitar_a","bo_weapon", spr_buy_item_triggers("itm_scimitar", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_scimitar_b",spr_buy_item_flags(20),"scimitar_b","bo_weapon", spr_buy_item_triggers("itm_scimitar_b", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_khergit_sword_c",spr_buy_item_flags(17),"khergit_sword_c","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_c", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_khergit_sword_d",spr_buy_item_flags(22),"khergit_sword_d","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_d", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_khergit_sword_two_handed_a",spr_buy_item_flags(27),"khergit_sword_two_handed_a","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_two_handed_a", resources=["itm_iron_bar_long"], skill_required=5)),
  ("pw_buy_two_handed_cleaver",spr_buy_item_flags(16),"military_cleaver_a","bo_weapon", spr_buy_item_triggers("itm_two_handed_cleaver", resources=["itm_iron_bar_long"], skill_required=4)),
  ("pw_buy_military_cleaver_b",spr_buy_item_flags(8),"military_cleaver_b","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_b", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_military_cleaver_c",spr_buy_item_flags(9),"military_cleaver_c","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_c", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_bastard_sword_a",spr_buy_item_flags(20),"bastard_sword_a","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_a", resources=["itm_iron_bar_long"], skill_required=3)),
  ("pw_buy_bastard_sword_b",spr_buy_item_flags(24),"bastard_sword_b","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_b", resources=["itm_iron_bar_long"], skill_required=3)),
  ("pw_buy_sword_two_handed_b",spr_buy_item_flags(26),"sword_two_handed_b","bo_weapon", spr_buy_item_triggers("itm_sword_two_handed_b", resources=["itm_iron_bar_long"], skill_required=4)),
  ("pw_buy_sword_two_handed_a",spr_buy_item_flags(30),"sword_two_handed_a","bo_weapon", spr_buy_item_triggers("itm_sword_two_handed_a", resources=["itm_iron_bar_long"], skill_required=5)),
  ("pw_buy_one_handed_war_axe_b",spr_buy_item_flags(6),"one_handed_war_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_war_axe_b", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
  ("pw_buy_one_handed_battle_axe_a",spr_buy_item_flags(6),"one_handed_battle_axe_a","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_a", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
  ("pw_buy_one_handed_battle_axe_b",spr_buy_item_flags(8),"one_handed_battle_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_b", resources=["itm_iron_bar_short", "itm_stick"], skill_required=3)),
  ("pw_buy_one_handed_battle_axe_c",spr_buy_item_flags(8),"one_handed_battle_axe_c","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_c", resources=["itm_iron_bar_short", "itm_stick"], skill_required=3)),
  ("pw_buy_sarranid_axe_a",spr_buy_item_flags(12),"one_handed_battle_axe_g","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_a", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sarranid_axe_b",spr_buy_item_flags(13),"one_handed_battle_axe_h","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_b", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_two_handed_axe",spr_buy_item_flags(15),"two_handed_battle_axe_a","bo_weapon", spr_buy_item_triggers("itm_two_handed_axe", resources=["itm_wood_pole_short", "itm_iron_bar"], skill_required=3)),
  ("pw_buy_two_handed_battle_axe",spr_buy_item_flags(18),"two_handed_battle_axe_b","bo_weapon", spr_buy_item_triggers("itm_two_handed_battle_axe", resources=["itm_wood_pole_short", "itm_iron_bar"], skill_required=4)),
  ("pw_buy_shortened_voulge",spr_buy_item_flags(21),"two_handed_battle_axe_c","bo_weapon", spr_buy_item_triggers("itm_shortened_voulge", resources=["itm_wood_pole_short", "itm_iron_bar"], skill_required=5)),
  ("pw_buy_bardiche",spr_buy_item_flags(23),"two_handed_battle_axe_d","bo_weapon", spr_buy_item_triggers("itm_bardiche", resources=["itm_wood_pole_short", "itm_iron_bar"], skill_required=5)),
  ("pw_buy_shortened_military_scythe",spr_buy_item_flags(19),"two_handed_battle_scythe_a","bo_weapon", spr_buy_item_triggers("itm_shortened_military_scythe", resources=["itm_iron_bar_long", "itm_stick"], skill_required=3)),
  ("pw_buy_sarranid_two_handed_axe_a",spr_buy_item_flags(19),"two_handed_battle_axe_g","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_a", resources=["itm_iron_bar_long"], skill_required=4)),
  ("pw_buy_sarranid_two_handed_axe_b",spr_buy_item_flags(22),"two_handed_battle_axe_h","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_b", resources=["itm_iron_bar_long"], skill_required=5)),
  ("pw_buy_long_axe_a",spr_buy_item_flags(25),"long_axe_a","bo_weapon", spr_buy_item_triggers("itm_long_axe_a", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=4)),
  ("pw_buy_glaive",spr_buy_item_flags(13),"glaive_b","bo_weapon_big", spr_buy_item_triggers("itm_glaive", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=3)),
  ("pw_buy_staff",spr_buy_item_flags(1),"wooden_staff","bo_weapon_big", spr_buy_item_triggers("itm_staff", resources=["itm_wood_pole"], skill_required=0)),
  ("pw_buy_quarter_staff",spr_buy_item_flags(2),"quarter_staff","bo_weapon_big", spr_buy_item_triggers("itm_quarter_staff", resources=["itm_wood_pole"], skill_required=0)),
  ("pw_buy_iron_staff",spr_buy_item_flags(5),"iron_staff","bo_weapon_big", spr_buy_item_triggers("itm_iron_staff", resources=["itm_iron_bar_long"], skill_required=1)),
  ("pw_buy_shortened_spear",spr_buy_item_flags(3),"spear_g_1-9m","bo_weapon", spr_buy_item_triggers("itm_shortened_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=1)),
  ("pw_buy_spear",spr_buy_item_flags(3),"spear_h_2-15m","bo_weapon_big", spr_buy_item_triggers("itm_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=1)),
  ("pw_buy_bamboo_spear",spr_buy_item_flags(7),"arabian_spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_bamboo_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=1)),
  ("pw_buy_war_spear",spr_buy_item_flags(4),"spear_i_2-3m","bo_weapon_big", spr_buy_item_triggers("itm_war_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_light_lance",spr_buy_item_flags(4),"spear_b_2-75m","bo_weapon_big", spr_buy_item_triggers("itm_light_lance", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=1)),
  ("pw_buy_lance",spr_buy_item_flags(5),"spear_d_2-8m","bo_weapon_big", spr_buy_item_triggers("itm_lance", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_heavy_lance",spr_buy_item_flags(6),"spear_f_2-9m","bo_weapon_big", spr_buy_item_triggers("itm_heavy_lance", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_great_lance",spr_buy_item_flags(6),"pw_great_lance","bo_weapon_big", spr_buy_item_triggers("itm_great_lance", resources=["itm_wood_pole", ("itm_iron_piece", 2)], skill_required=3)),
  ("pw_buy_jousting_lance",spr_buy_item_flags(6),"pw_jousting_lance","bo_weapon_big", spr_buy_item_triggers("itm_jousting_lance", resources=["itm_wood_pole", ("itm_iron_piece", 2)], skill_required=3)),
  ("pw_buy_awlpike",spr_buy_item_flags(7),"awl_pike_b","bo_weapon_big", spr_buy_item_triggers("itm_awlpike", resources=["itm_wood_pole", "itm_iron_bar_short"], skill_required=2)),
  ("pw_buy_awlpike_long",spr_buy_item_flags(8),"awl_pike_a","bo_weapon_big", spr_buy_item_triggers("itm_awlpike_long", resources=["itm_wood_pole", "itm_iron_bar_short"], skill_required=2)),
  ("pw_buy_pike",spr_buy_item_flags(9),"spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_pike", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_bec_de_corbin_a",spr_buy_item_flags(17),"bec_de_corbin_a","bo_weapon", spr_buy_item_triggers("itm_bec_de_corbin_a", resources=["itm_wood_pole", "itm_iron_bar_short"], skill_required=3)),
  ("pw_buy_hunting_bow",spr_buy_item_flags(4),"hunting_bow","bo_weapon", spr_buy_item_triggers("itm_hunting_bow", resources=["itm_wood_pole_short"], skill_required=1)),
  ("pw_buy_short_bow",spr_buy_item_flags(5),"short_bow","bo_weapon", spr_buy_item_triggers("itm_short_bow", resources=["itm_wood_pole_short"], skill_required=1)),
  ("pw_buy_nomad_bow",spr_buy_item_flags(7),"nomad_bow","bo_weapon", spr_buy_item_triggers("itm_nomad_bow", resources=["itm_wood_pole_short"], skill_required=2)),
  ("pw_buy_long_bow",spr_buy_item_flags(12),"long_bow","bo_weapon", spr_buy_item_triggers("itm_long_bow", resources=["itm_wood_pole"], skill_required=3)),
  ("pw_buy_khergit_bow",spr_buy_item_flags(14),"khergit_bow","bo_weapon", spr_buy_item_triggers("itm_khergit_bow", resources=["itm_wood_pole_short"], skill_required=3)),
  ("pw_buy_strong_bow",spr_buy_item_flags(18),"strong_bow","bo_weapon", spr_buy_item_triggers("itm_strong_bow", resources=["itm_wood_pole_short"], skill_required=4)),
  ("pw_buy_war_bow",spr_buy_item_flags(20),"war_bow","bo_weapon", spr_buy_item_triggers("itm_war_bow", resources=["itm_wood_pole"], skill_required=5)),
  ("pw_buy_arrows",spr_buy_item_flags(1),"arrow_b","bo_weapon", spr_buy_item_triggers("itm_arrows", resources=[], skill_required=1)),
  ...
  ("pw_buy_hunting_crossbow",spr_buy_item_flags(10),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_hunting_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=1)),
  ("pw_buy_light_crossbow",spr_buy_item_flags(12),"crossbow_b","bo_weapon_small", spr_buy_item_triggers("itm_light_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=2)),
  ("pw_buy_crossbow",spr_buy_item_flags(15),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=3)),
  ("pw_buy_heavy_crossbow",spr_buy_item_flags(20),"crossbow_c","bo_weapon_small", spr_buy_item_triggers("itm_heavy_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=4)),
  ...
  ("pw_buy_tab_shield_kite_b",spr_buy_item_flags(7),"tableau_shield_kite_3","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_b", resources=[("itm_board", 2)], skill_required=1, tableau="tableau_kite_shield_3")),
  ("pw_buy_tab_shield_kite_c",spr_buy_item_flags(9),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_c", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=2, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_d",spr_buy_item_flags(12),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_d", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=3, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_cav_a",spr_buy_item_flags(7),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_a", resources=["itm_board", "itm_iron_piece"], skill_required=2, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_kite_cav_b",spr_buy_item_flags(10),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_b", resources=["itm_board", "itm_iron_piece"], skill_required=3, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_heater_b",spr_buy_item_flags(8),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_b", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=1, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_c",spr_buy_item_flags(10),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_c", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=2, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_d",spr_buy_item_flags(13),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_d", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=3, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_cav_a",spr_buy_item_flags(7),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_a", resources=["itm_board", "itm_iron_piece"], skill_required=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_heater_cav_b",spr_buy_item_flags(10),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_b", resources=["itm_board", "itm_iron_piece"], skill_required=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_pavise_b",spr_buy_item_flags(10),"tableau_shield_pavise_2","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_b", resources=[("itm_board", 3)], skill_required=1, tableau="tableau_pavise_shield_2")),
  ("pw_buy_tab_shield_pavise_c",spr_buy_item_flags(15),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_c", resources=[("itm_board", 3), "itm_iron_piece"], skill_required=2, tableau="tableau_pavise_shield_1")),
  ("pw_buy_tab_shield_pavise_d",spr_buy_item_flags(20),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_d", resources=[("itm_board", 3), "itm_iron_piece"], skill_required=3, tableau="tableau_pavise_shield_1")),
  ("pw_buy_tab_shield_small_round_a",spr_buy_item_flags(5),"tableau_shield_small_round_3","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_a", resources=["itm_board"], skill_required=1, tableau="tableau_small_round_shield_3")),
  ("pw_buy_tab_shield_small_round_b",spr_buy_item_flags(7),"tableau_shield_small_round_1","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_b", resources=["itm_board", "itm_iron_piece"], skill_required=2, tableau="tableau_small_round_shield_1")),
  ("pw_buy_tab_shield_small_round_c",spr_buy_item_flags(15),"tableau_shield_small_round_2","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_c", resources=["itm_board", "itm_iron_piece"], skill_required=3, tableau="tableau_small_round_shield_2")),
  ("pw_buy_steel_shield",spr_buy_item_flags(30),"shield_dragon","bo_shield_round", spr_buy_item_triggers("itm_steel_shield", resources=["itm_iron_bar"], skill_required=5)),

  ("pw_buy_sumpter_horse",spr_buy_item_flags(5),"sumpter_horse","bo_horse", spr_buy_item_triggers("itm_sumpter_horse")),
  ("pw_buy_cart_horse",spr_buy_item_flags(7),"sumpter_horse","bo_horse", spr_buy_item_triggers("itm_cart_horse")),
  ("pw_buy_saddle_horse",spr_buy_item_flags(10),"saddle_horse","bo_horse", spr_buy_item_triggers("itm_saddle_horse")),
  ("pw_buy_steppe_horse",spr_buy_item_flags(13),"steppe_horse","bo_horse", spr_buy_item_triggers("itm_steppe_horse")),
  ("pw_buy_arabian_horse_a",spr_buy_item_flags(14),"arabian_horse_a","bo_horse", spr_buy_item_triggers("itm_arabian_horse_a")),
  ("pw_buy_arabian_horse_b",spr_buy_item_flags(17),"arabian_horse_b","bo_horse", spr_buy_item_triggers("itm_arabian_horse_b")),
  ("pw_buy_courser",spr_buy_item_flags(20),"courser","bo_horse", spr_buy_item_triggers("itm_courser")),
  ("pw_buy_hunter",spr_buy_item_flags(25),"hunting_horse","bo_horse", spr_buy_item_triggers("itm_hunter")),
  ("pw_buy_warhorse",spr_buy_item_flags(30),"warhorse_chain","bo_horse", spr_buy_item_triggers("itm_warhorse")),
  ("pw_buy_warhorse_steppe",spr_buy_item_flags(30),"warhorse_steppe","bo_horse", spr_buy_item_triggers("itm_warhorse_steppe")),
  ...
  ("pw_buy_dagger",spr_buy_item_flags(7),"scab_dagger","bo_weapon_small", spr_buy_item_triggers("itm_dagger", resources=["itm_iron_bar_short"], skill_required=2)),
  ...
  ("pw_rest_bed_a",spr_use_time(40),"bed_a","bo_bed_a", spr_rest_triggers(40, min_health_pct=20)),
  ("pw_rest_bed_b",spr_use_time(25),"bed_b","bo_bed_b", spr_rest_triggers(20, min_health_pct=40)),
  ("pw_rest_bed_c",spr_use_time(30),"bed_c","bo_bed_c", spr_rest_triggers(30, min_health_pct=20)),
  ("pw_rest_bed_e",spr_use_time(40),"bed_e","bo_bed_e", spr_rest_triggers(50, min_health_pct=20)),
  ("pw_rest_bed_f",spr_use_time(20),"bed_f","bo_bed_f", spr_rest_triggers(15, min_health_pct=40)),
