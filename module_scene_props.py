...
scene_props = [
  ...
  ("pw_buy_military_pick",spr_buy_item_flags(11),"steel_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_military_pick", resources=["itm_iron_bar_short", "itm_stick"], skill_required=2)),
