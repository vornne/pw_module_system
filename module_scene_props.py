...
scene_props = [
  ...
  ("pw_buy_nomad_cap",spr_buy_item_flags(8),"nomad_cap_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_nomad_cap", resources=["itm_iron_piece","itm_leather_piece"], tailoring=2, engineer=2)),
  ...
  ("pw_buy_padded_coif",spr_buy_item_flags(8),"padded_coif_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_padded_coif", resources=["itm_linen_cloth_small"], tailoring=2, tableau="tableau_colored_helmets_new_b")),
  ...
  ("pw_buy_leather_steppe_cap_a",spr_buy_item_flags(5),"leather_steppe_cap_a_new","bo_pw_armor_head", spr_buy_item_triggers("itm_leather_steppe_cap_a", resources=["itm_leather_piece"], tailoring=2)),
  ...
  ("pw_buy_leather_warrior_cap",spr_buy_item_flags(9),"skull_cap_new_b","bo_pw_armor_head", spr_buy_item_triggers("itm_leather_warrior_cap", resources=["itm_leather_piece"], engineer=2, tailoring=3)),
  ...
  ("pw_buy_full_helm",spr_buy_item_flags(27),"great_helmet_new_b","bo_pw_armor_head", spr_buy_item_triggers("itm_full_helm", resources=[("itm_iron_bar_short",2),"itm_iron_piece"], engineer=6)),
  ...
  ("pw_buy_great_helmet",spr_buy_item_flags(30),"great_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_great_helmet", resources=["itm_iron_bar"], engineer=6)),
  ("pw_buy_winged_great_helmet",spr_buy_item_flags(32),"maciejowski_helmet_new","bo_pw_armor_head", spr_buy_item_triggers("itm_winged_great_helmet", resources=["itm_iron_bar","itm_iron_bar_short"], engineer=6)),
  ("pw_buy_black_helmet",spr_buy_item_flags(30),"black_helm","bo_pw_armor_head", spr_buy_item_triggers("itm_black_helmet", resources=["itm_iron_bar"], engineer=6)),
  ...
  ("pw_buy_leather_armor",spr_buy_item_flags(15),"tattered_leather_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_leather_armor", resources=["itm_leather_roll","itm_linen_cloth_small","itm_iron_piece"], engineer=2)),
  ...
  ("pw_buy_haubergeon",spr_buy_item_flags(24),"haubergeon_c","bo_pw_armor_body", spr_buy_item_triggers("itm_haubergeon", resources=[("itm_iron_bar_short",2)], engineer=3)),
  ...
  ("pw_buy_mail_hauberk",spr_buy_item_flags(25),"hauberk_a_new","bo_pw_armor_body", spr_buy_item_triggers("itm_mail_hauberk", resources=[("itm_iron_bar_short",2)], engineer=4)),
  ...
  ("pw_buy_mamluke_mail",spr_buy_item_flags(29),"sarranid_elite_cavalary","bo_pw_armor_body", spr_buy_item_triggers("itm_mamluke_mail", resources=[("itm_iron_bar_short",2),"itm_linen_cloth_small"], engineer=6)),
  ...
  ("pw_buy_khergit_elite_armor",spr_buy_item_flags(35),"lamellar_armor_d","bo_pw_armor_body", spr_buy_item_triggers("itm_khergit_elite_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth_small"], engineer=6, tableau="tableau_heraldic_lamellar_armor_d")),
  ("pw_buy_vaegir_elite_armor",spr_buy_item_flags(35),"lamellar_armor_c","bo_pw_armor_body", spr_buy_item_triggers("itm_vaegir_elite_armor", resources=[("itm_iron_bar",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_sarranid_elite_armor",spr_buy_item_flags(35),"tunic_armor_a","bo_pw_armor_body", spr_buy_item_triggers("itm_sarranid_elite_armor", resources=[("itm_iron_bar_short",2),"itm_linen_cloth"], engineer=6)),
  ("pw_buy_plate_armor",spr_buy_item_flags(40),"full_plate_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_plate_armor", resources=[("itm_iron_bar_long", 4)], engineer=7)),
  ("pw_buy_black_armor",spr_buy_item_flags(43),"black_armor","bo_pw_armor_body", spr_buy_item_triggers("itm_black_armor", resources=[("itm_iron_bar_long", 4)], engineer=7)),
  ...
  ("pw_buy_heraldic_mail_with_surcoat",spr_buy_item_flags(26),"heraldic_armor_new_a","bo_pw_armor_body", spr_buy_item_triggers("itm_heraldic_mail_with_surcoat", resources=[("itm_iron_bar_short",3),"itm_linen_cloth"], engineer=6, tableau="tableau_heraldic_armor_a")),
  ...
  ("pw_buy_bishop_chausses",spr_buy_item_flags(16),"pw_bishop_chausses","bo_pw_armor_foot", spr_buy_item_triggers("itm_bishop_chausses", resources=[("itm_iron_piece",2)], engineer=3)),
  ...
  ("pw_buy_mail_boots",spr_buy_item_flags(20),"mail_boots_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_mail_boots", resources=[("itm_iron_bar_short",2)], engineer=5)),
  ("pw_buy_iron_greaves",spr_buy_item_flags(25),"iron_greaves_a","bo_pw_armor_foot", spr_buy_item_triggers("itm_iron_greaves", resources=[("itm_iron_bar_short",3)], engineer=6)),
  ("pw_buy_plate_boots",spr_buy_item_flags(27),"plate_boots","bo_pw_armor_foot", spr_buy_item_triggers("itm_plate_boots", resources=[("itm_iron_bar",2)], engineer=6)),
  ("pw_buy_black_greaves",spr_buy_item_flags(28),"black_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_black_greaves", resources=[("itm_iron_bar",2)], engineer=6)),
  ...
  ("pw_buy_gauntlets",spr_buy_item_flags(18),"gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_gauntlets", resources=[("itm_iron_bar_short",2)], engineer=6)),
