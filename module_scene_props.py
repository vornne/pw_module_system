...
scene_props = [
  ...
  ("pw_buy_club_with_spike_head",spr_buy_item_flags(5),"mace_e","bo_weapon", spr_buy_item_triggers("itm_club_with_spike_head", resources=["itm_iron_bar", "itm_wood_pole"], skill_required=2)),
  ...
  ("pw_buy_curved_sword",spr_buy_item_flags(12),"khergit_sword","bo_weapon", spr_buy_item_triggers("itm_curved_sword", resources=["itm_iron_bar_med"], skill_required=1)),
  ("pw_buy_sword_medieval_a",spr_buy_item_flags(14),"sword_medieval_a","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_a", resources=["itm_iron_bar_med"], skill_required=2)),
  ...
  ("pw_buy_sword_medieval_c_long",spr_buy_item_flags(16),"sword_medieval_c_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_c_long", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_sword_medieval_d_long",spr_buy_item_flags(15),"sword_medieval_d_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_d_long", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_sword_viking_c",spr_buy_item_flags(13),"sword_viking_c","bo_weapon", spr_buy_item_triggers("itm_sword_viking_c", resources=["itm_iron_bar_med"], skill_required=2)),
  ...
  ("pw_buy_sword_viking_a_long",spr_buy_item_flags(15),"sword_viking_a_long","bo_weapon", spr_buy_item_triggers("itm_sword_viking_a_long", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_scimitar",spr_buy_item_flags(22),"scimitar_a","bo_weapon", spr_buy_item_triggers("itm_scimitar", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_scimitar_b",spr_buy_item_flags(24),"scimitar_b","bo_weapon", spr_buy_item_triggers("itm_scimitar_b", resources=["itm_iron_bar_med"], skill_required=3)),
