...
scene_props = [
  ...
  ("pw_buy_winged_mace",spr_buy_item_flags(6),"flanged_mace","bo_weapon_small", spr_buy_item_triggers("itm_winged_mace", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_spiked_mace",spr_buy_item_flags(4),"spiked_mace_new","bo_weapon_small", spr_buy_item_triggers("itm_spiked_mace", resources=["itm_iron_bar"], skill_required=2)),
  ...
  ("pw_buy_military_pick",spr_buy_item_flags(11),"steel_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_military_pick", resources=["itm_iron_bar"], skill_required=3)),
  ...
  ("pw_buy_military_hammer",spr_buy_item_flags(9),"military_hammer","bo_weapon_small", spr_buy_item_triggers("itm_military_hammer", resources=["itm_iron_bar_short", "itm_stick"], skill_required=3)),
  ...
  ("pw_buy_falchion",spr_buy_item_flags(9),"falchion_new","bo_weapon_small", spr_buy_item_triggers("itm_falchion", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_curved_sword",spr_buy_item_flags(12),"khergit_sword","bo_weapon", spr_buy_item_triggers("itm_curved_sword", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_medieval_a",spr_buy_item_flags(14),"sword_medieval_a","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_a", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_medieval_b_small",spr_buy_item_flags(13),"sword_medieval_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_b_small", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_medieval_c_long",spr_buy_item_flags(16),"sword_medieval_c_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_c_long", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_medieval_d_long",spr_buy_item_flags(15),"sword_medieval_d_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_d_long", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_viking_c",spr_buy_item_flags(13),"sword_viking_c","bo_weapon", spr_buy_item_triggers("itm_sword_viking_c", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_viking_b_small",spr_buy_item_flags(12),"sword_viking_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_viking_b_small", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_sword_viking_a_long",spr_buy_item_flags(15),"sword_viking_a_long","bo_weapon", spr_buy_item_triggers("itm_sword_viking_a_long", resources=["itm_iron_bar"], skill_required=3)),
  ("pw_buy_scimitar",spr_buy_item_flags(18),"scimitar_a","bo_weapon", spr_buy_item_triggers("itm_scimitar", resources=["itm_iron_bar"], skill_required=3)),
  ...
  ("pw_buy_khergit_sword_d",spr_buy_item_flags(22),"khergit_sword_d","bo_weapon", spr_buy_item_triggers("itm_khergit_sword_d", resources=["itm_iron_bar"], skill_required=4)),
  ...
  ("pw_buy_bastard_sword_a",spr_buy_item_flags(20),"bastard_sword_a","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_a", resources=["itm_iron_bar_long"], skill_required=4)),
  ("pw_buy_bastard_sword_b",spr_buy_item_flags(24),"bastard_sword_b","bo_weapon", spr_buy_item_triggers("itm_bastard_sword_b", resources=["itm_iron_bar_long"], skill_required=4)),
  ...
  ("pw_buy_quarter_staff",spr_buy_item_flags(2),"quarter_staff","bo_weapon_big", spr_buy_item_triggers("itm_quarter_staff", resources=["itm_wood_pole"], skill_required=1)),
  ("pw_buy_iron_staff",spr_buy_item_flags(5),"iron_staff","bo_weapon_big", spr_buy_item_triggers("itm_iron_staff", resources=["itm_iron_bar_long"], skill_required=2)),
  ...
  ("pw_buy_spear",spr_buy_item_flags(3),"spear_h_2-15m","bo_weapon_big", spr_buy_item_triggers("itm_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ("pw_buy_bamboo_spear",spr_buy_item_flags(7),"arabian_spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_bamboo_spear", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ...
  ("pw_buy_light_lance",spr_buy_item_flags(4),"spear_b_2-75m","bo_weapon_big", spr_buy_item_triggers("itm_light_lance", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=2)),
  ...
  ("pw_buy_pike",spr_buy_item_flags(9),"spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_pike", resources=["itm_wood_pole", "itm_iron_piece"], skill_required=3)),
  ("pw_buy_bec_de_corbin_a",spr_buy_item_flags(17),"bec_de_corbin_a","bo_weapon", spr_buy_item_triggers("itm_bec_de_corbin_a", resources=["itm_wood_pole", "itm_iron_bar_short"], skill_required=4)),
  ("pw_buy_hunting_bow",spr_buy_item_flags(4),"hunting_bow","bo_weapon", spr_buy_item_triggers("itm_hunting_bow", resources=["itm_wood_pole_short"], skill_required=2)),
  ("pw_buy_short_bow",spr_buy_item_flags(5),"short_bow","bo_weapon", spr_buy_item_triggers("itm_short_bow", resources=["itm_wood_pole_short"], skill_required=2)),
  ("pw_buy_nomad_bow",spr_buy_item_flags(7),"nomad_bow","bo_weapon", spr_buy_item_triggers("itm_nomad_bow", resources=["itm_wood_pole_short"], skill_required=3)),
  ...
  ("pw_buy_hunting_crossbow",spr_buy_item_flags(10),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_hunting_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=3)),
  ("pw_buy_light_crossbow",spr_buy_item_flags(12),"crossbow_b","bo_weapon_small", spr_buy_item_triggers("itm_light_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=3)),
  ("pw_buy_crossbow",spr_buy_item_flags(15),"crossbow_a","bo_weapon_small", spr_buy_item_triggers("itm_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=4)),
  ("pw_buy_heavy_crossbow",spr_buy_item_flags(20),"crossbow_c","bo_weapon_small", spr_buy_item_triggers("itm_heavy_crossbow", pos_offset=(-5,0,0), resources=["itm_iron_piece", "itm_stick"], skill_required=5)),
  ...
  ("pw_buy_tab_shield_heater_b",spr_buy_item_flags(8),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_b", resources=[("itm_board", 2), "itm_iron_piece"], skill_required=2, tableau="tableau_heater_shield_1")),
  ...
  ("pw_buy_tab_shield_small_round_a",spr_buy_item_flags(5),"tableau_shield_small_round_3","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_a", resources=["itm_board"], skill_required=2, tableau="tableau_small_round_shield_3")),
