...
scene_props = [
  ...
  ("pw_tree_e1",spr_tree_flags(),"tree_e_1","bo_tree_e_1_fixed", spr_tree_triggers(full_hp=2500, fell_hp=1200, resource_imod=imod_cracked)),
  ("pw_tree_e2",spr_tree_flags(),"tree_e_2","bo_tree_e_2_fixed", spr_tree_triggers(full_hp=2100, fell_hp=800, resource_imod=imod_cracked)),
  ("pw_tree_e3",spr_tree_flags(),"tree_e_3","bo_tree_e_3_fixed", spr_tree_triggers(full_hp=2300, fell_hp=900, resource_imod=imod_cracked)),
  ...
  ("pw_tree_beech_d",spr_tree_flags(),"beech_d","bo_beech_d_fixed", spr_tree_triggers(full_hp=3500, fell_hp=1500, resource_imod=imod_cracked)),
  ("pw_tree_beech_e",spr_tree_flags(),"beech_e","bo_beech_e_fixed", spr_tree_triggers(full_hp=3800, fell_hp=1700, resource_imod=imod_cracked)),
  ...
  ("pw_tree_snowy_b",spr_tree_flags(),"snowy_pine_2","bo_snowy_pine_2_fixed", spr_tree_triggers(full_hp=6000, fell_hp=2000, resource_imod=imod_bent)),
  ...
  ("pw_tree_8a",spr_tree_flags(),"tree_8_a","bo_tree_8_a_fixed", spr_tree_triggers(full_hp=2400, fell_hp=1800, resource_imod=imod_cracked)),
  ("pw_tree_8b",spr_tree_flags(),"tree_8_b","bo_tree_8_b_fixed", spr_tree_triggers(full_hp=2700, fell_hp=1700, resource_imod=imod_cracked)),
  ("pw_tree_8c",spr_tree_flags(),"tree_8_c","bo_tree_8_c_fixed", spr_tree_triggers(full_hp=2600, fell_hp=1300, resource_imod=imod_cracked)),
  ("pw_tree_9a",spr_tree_flags(),"tree_9_a","bo_tree_9_a_fixed", spr_tree_triggers(full_hp=2100, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_9b",spr_tree_flags(),"tree_9_b","bo_tree_9_b_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_9c",spr_tree_flags(),"tree_9_c","bo_tree_9_a_fixed", spr_tree_triggers(full_hp=2400, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_10a",spr_tree_flags(),"tree_10_a","bo_tree_10_a_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_10b",spr_tree_flags(),"tree_10_b","bo_tree_10_b_fixed", spr_tree_triggers(full_hp=1900, fell_hp=900, resource_imod=imod_cracked)),
  ("pw_tree_10c",spr_tree_flags(),"tree_10_c","bo_tree_10_c_fixed", spr_tree_triggers(full_hp=1700, fell_hp=700, resource_imod=imod_cracked)),
  ("pw_tree_11a",spr_tree_flags(),"tree_11_a","bo_tree_11_a_fixed", spr_tree_triggers(full_hp=2200, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_11b",spr_tree_flags(),"tree_11_b","bo_tree_11_a_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_11c",spr_tree_flags(),"tree_11_c","bo_tree_11_a_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1100, resource_imod=imod_cracked)),
  ("pw_tree_12a",spr_tree_flags(),"tree_12_a","bo_tree_12_a_fixed", spr_tree_triggers(full_hp=1800, fell_hp=700, resource_imod=imod_cracked)),
  ("pw_tree_12b",spr_tree_flags(),"tree_12_b","bo_tree_12_b_fixed", spr_tree_triggers(full_hp=2000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_12c",spr_tree_flags(),"tree_12_c","bo_tree_12_c_fixed", spr_tree_triggers(full_hp=1700, fell_hp=1000, resource_imod=imod_cracked)),
  ...
  ("pw_tree_18a",spr_tree_flags(),"tree_18_a","bo_tree_18_a_fixed", spr_tree_triggers(full_hp=2000, fell_hp=900, resource_imod=imod_cracked)),
  ("pw_tree_18b",spr_tree_flags(),"tree_18_b","bo_tree_18_b_fixed", spr_tree_triggers(full_hp=2000, fell_hp=800, resource_imod=imod_cracked)),
  ("pw_tree_19a",spr_tree_flags(),"tree_19_a","bo_tree_19_a_fixed", spr_tree_triggers(full_hp=2500, fell_hp=1500, resource_imod=imod_cracked)),
  ...
  ("pw_ladder_6m",spr_ladder_flags(),"siege_ladder_move_6m","bo_siege_ladder_move_6m_fixed", spr_wall_triggers("pw_ladder_build", hit_points=400, height=600)),
  ("pw_ladder_8m",spr_ladder_flags(),"siege_ladder_move_8m","bo_siege_ladder_move_8m_fixed", spr_wall_triggers("pw_ladder_build", hit_points=440, height=800)),
  ("pw_ladder_10m",spr_ladder_flags(),"siege_ladder_move_10m","bo_siege_ladder_move_10m_fixed", spr_wall_triggers("pw_ladder_build", hit_points=480, height=1000)),
  ("pw_ladder_12m",spr_ladder_flags(),"siege_ladder_move_12m","bo_siege_ladder_move_12m_fixed", spr_wall_triggers("pw_ladder_build", hit_points=560, height=1200)),
  ("pw_ladder_14m",spr_ladder_flags(),"siege_ladder_move_14m","bo_siege_ladder_move_14m_fixed", spr_wall_triggers("pw_ladder_build", hit_points=600, height=2000)),
