...
scene_props = [
  ...
  ("pw_tree_a1",spr_tree_flags(),"tree_a01","bo_tree_a01", spr_tree_triggers(full_hp=7000, fell_hp=2000)),
  ("pw_tree_a2",spr_tree_flags(),"tree_a02","bo_tree_a02", spr_tree_triggers(full_hp=6000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_b1",spr_tree_flags(),"tree_b01","bo_tree_b01", spr_tree_triggers(full_hp=8000, fell_hp=3000)),
  ("pw_tree_b2",spr_tree_flags(),"tree_b02","bo_tree_b02", spr_tree_triggers(full_hp=8000, fell_hp=3000, resource_imod=imod_cracked)),
  ("pw_tree_c1",spr_tree_flags(),"tree_c01","bo_tree_c01", spr_tree_triggers(full_hp=7000, fell_hp=2000)),
  ("pw_tree_c2",spr_tree_flags(),"tree_c02","bo_tree_c02", spr_tree_triggers(full_hp=6000, fell_hp=2000)),
  ("pw_tree_e1",spr_tree_flags(),"tree_e_1","bo_tree_e_1", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_e2",spr_tree_flags(),"tree_e_2","bo_tree_e_2", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_e3",spr_tree_flags(),"tree_e_3","bo_tree_e_3", spr_tree_triggers(full_hp=5000, fell_hp=1500, resource_imod=imod_cracked)),
  ("pw_tree_f1",spr_tree_flags(),"tree_f_1","bo_tree_f_1", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_f2",spr_tree_flags(),"tree_f_2","bo_tree_f_1", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_f3",spr_tree_flags(),"tree_f_3","bo_tree_f_1", spr_tree_triggers(full_hp=4000, fell_hp=1200, resource_imod=imod_cracked)),
  ("pw_tree_aspen_a",spr_tree_flags(),"aspen_a","bo_aspen_a", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_aspen_b",spr_tree_flags(),"aspen_b","bo_aspen_b", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_aspen_c",spr_tree_flags(),"aspen_c","bo_aspen_c", spr_tree_triggers(full_hp=4000, fell_hp=1000, resource_imod=imod_cracked)),
  ("pw_tree_pine_1a",spr_tree_flags(),"pine_1_a","bo_pine_1_a", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_pine_1b",spr_tree_flags(),"pine_1_b","bo_pine_1_b", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_pine_2a",spr_tree_flags(),"pine_2_a","bo_pine_2_a", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_pine_3a",spr_tree_flags(),"pine_3_a","bo_pine_3_a", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_pine_4a",spr_tree_flags(),"pine_4_a","bo_pine_4_a", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_pine_6a",spr_tree_flags(),"pine_6_a","bo_pine_6_a", spr_tree_triggers(full_hp=10000, fell_hp=4000, resource_hp=300, resource_imod=imod_bent)),
  ("pw_tree_plane_a",spr_tree_flags(),"tree_plane_a","bo_tree_plane_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_plane_b",spr_tree_flags(),"tree_plane_b","bo_tree_plane_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_plane_c",spr_tree_flags(),"tree_plane_c","bo_tree_plane_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_plane_d",spr_tree_flags(),"plane_d","bo_plane_d", spr_tree_triggers(full_hp=5000, fell_hp=1700)),
  ("pw_tree_beech_d",spr_tree_flags(),"beech_d","bo_beech_d", spr_tree_triggers(full_hp=7000, fell_hp=2300)),
  ("pw_tree_beech_e",spr_tree_flags(),"beech_e","bo_beech_e", spr_tree_triggers(full_hp=8000, fell_hp=3000)),
  ("pw_tree_tall_a",spr_tree_flags(),"tall_tree_a","bo_tall_tree_a", spr_tree_triggers(full_hp=7000, fell_hp=3000, resource_hp=400)),
  ("pw_tree_snowy_a",spr_tree_flags(),"tree_snowy_a","bo_tree_snowy_a", spr_tree_triggers(full_hp=9000, fell_hp=3800, resource_imod=imod_cracked)),
  ("pw_tree_snowy_b",spr_tree_flags(),"snowy_pine_2","bo_snowy_pine_2", spr_tree_triggers(full_hp=9000, fell_hp=4000, resource_imod=imod_cracked)),
  ("pw_tree_1a",spr_tree_flags(),"tree_1_a","bo_tree_1_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_1b",spr_tree_flags(),"tree_1_b","bo_tree_1_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_2a",spr_tree_flags(),"tree_2_a","bo_tree_2_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_2b",spr_tree_flags(),"tree_2_b","bo_tree_2_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_3a",spr_tree_flags(),"tree_3_a","bo_tree_3_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_3b",spr_tree_flags(),"tree_3_b","bo_tree_3_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_4a",spr_tree_flags(),"tree_4_a","bo_tree_4_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_4b",spr_tree_flags(),"tree_4_b","bo_tree_4_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_5a",spr_tree_flags(),"tree_5_a","bo_tree_5_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_5b",spr_tree_flags(),"tree_5_b","bo_tree_5_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_5c",spr_tree_flags(),"tree_5_c","bo_tree_5_c", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_5d",spr_tree_flags(),"tree_5_d","bo_tree_5_d", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_6a",spr_tree_flags(),"tree_6_a","bo_tree_6_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_6b",spr_tree_flags(),"tree_6_b","bo_tree_6_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_6c",spr_tree_flags(),"tree_6_c","bo_tree_6_c", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_6d",spr_tree_flags(),"tree_6_d","bo_tree_6_d", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_7a",spr_tree_flags(),"tree_7_a","bo_tree_7_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_7b",spr_tree_flags(),"tree_7_b","bo_tree_7_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_7c",spr_tree_flags(),"tree_7_c","bo_tree_7_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_8a",spr_tree_flags(),"tree_8_a","bo_tree_8_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_8b",spr_tree_flags(),"tree_8_b","bo_tree_8_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_8c",spr_tree_flags(),"tree_8_c","bo_tree_8_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_9a",spr_tree_flags(),"tree_9_a","bo_tree_9_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_9b",spr_tree_flags(),"tree_9_b","bo_tree_9_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_9c",spr_tree_flags(),"tree_9_c","bo_tree_9_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_10a",spr_tree_flags(),"tree_10_a","bo_tree_10_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_10b",spr_tree_flags(),"tree_10_b","bo_tree_10_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_10c",spr_tree_flags(),"tree_10_c","bo_tree_10_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_11a",spr_tree_flags(),"tree_11_a","bo_tree_11_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_11b",spr_tree_flags(),"tree_11_b","bo_tree_11_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_11c",spr_tree_flags(),"tree_11_c","bo_tree_11_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_12a",spr_tree_flags(),"tree_12_a","bo_tree_12_a", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_12b",spr_tree_flags(),"tree_12_b","bo_tree_12_b", spr_tree_triggers(full_hp=5000, fell_hp=2000, resource_imod=imod_cracked)),
  ("pw_tree_12c",spr_tree_flags(),"tree_12_c","bo_tree_12_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_14a",spr_tree_flags(),"tree_14_a","bo_tree_14_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_14b",spr_tree_flags(),"tree_14_b","bo_tree_14_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_14c",spr_tree_flags(),"tree_14_c","bo_tree_14_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_15a",spr_tree_flags(),"tree_15_a","bo_tree_15_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_15b",spr_tree_flags(),"tree_15_b","bo_tree_15_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_15c",spr_tree_flags(),"tree_15_c","bo_tree_15_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_16a",spr_tree_flags(),"tree_16_a","bo_tree_16_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_16b",spr_tree_flags(),"tree_16_b","bo_tree_16_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_17a",spr_tree_flags(),"tree_17_a","bo_tree_17_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_17b",spr_tree_flags(),"tree_17_b","bo_tree_17_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_17c",spr_tree_flags(),"tree_17_c","bo_tree_17_c", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_17d",spr_tree_flags(),"tree_17_d","bo_tree_17_d", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_18a",spr_tree_flags(),"tree_18_a","bo_tree_18_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_18b",spr_tree_flags(),"tree_18_b","bo_tree_18_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_19a",spr_tree_flags(),"tree_19_a","bo_tree_19_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_20a",spr_tree_flags(),"tree_20_a","bo_tree_20_a", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_20b",spr_tree_flags(),"tree_20_b","bo_tree_20_b", spr_tree_triggers(full_hp=5000, fell_hp=2000)),
  ("pw_tree_palm_a",spr_tree_flags(),"palm_a","bo_palm_a", spr_tree_triggers(full_hp=4000, fell_hp=2000)),
  ("pw_tree_trunk_a",0,"pw_tree_trunk_a","bo_pw_tree_trunk_a", []),
  ("pw_tree_trunk_b",0,"pw_tree_trunk_b","bo_pw_tree_trunk_b", []),
  ("pw_stick_bush_2a",spr_resource_flags(),"bushes02_a","bo_bushes02_a", spr_hit_plant_triggers("itm_stick", full_hp=1000, resource_hp=50, skill="skl_labouring", regrow_interval=70, sound="snd_cut_wood_scratch")),
  ("pw_stick_bush_2b",spr_resource_flags(),"bushes02_b","bo_bushes02_b", spr_hit_plant_triggers("itm_stick", full_hp=700, resource_hp=50, regrow_interval=60, sound="snd_cut_wood_scratch")),
  ("pw_stick_bush_2c",spr_resource_flags(),"bushes02_c","bo_bushes02_c", spr_hit_plant_triggers("itm_stick", full_hp=1500, resource_hp=50, regrow_interval=120, sound="snd_cut_wood_scratch")),
  ...
  ("pw_buy_butchering_knife",spr_buy_item_flags(3),"khyber_knife_new","bo_weapon_small", spr_buy_item_triggers("itm_butchering_knife", resources=["itm_iron_bar"], skill_required=2)),
  ("pw_buy_winged_mace",spr_buy_item_flags(6),"flanged_mace","bo_weapon_small", spr_buy_item_triggers("itm_winged_mace", resources=["itm_iron_bar_med"], skill_required=1)),
  ("pw_buy_spiked_mace",spr_buy_item_flags(4),"spiked_mace_new","bo_weapon_small", spr_buy_item_triggers("itm_spiked_mace", resources=["itm_iron_bar_med"], skill_required=1)),
  ("pw_buy_mace_2",spr_buy_item_flags(3),"mace_a","bo_weapon_small", spr_buy_item_triggers("itm_mace_2", resources=["itm_iron_bar", "itm_stick"], skill_required=1)),
  ("pw_buy_mace_4",spr_buy_item_flags(4),"mace_b","bo_weapon_small", spr_buy_item_triggers("itm_mace_4", resources=["itm_iron_bar", "itm_stick"], skill_required=1)),
  ("pw_buy_club_with_spike_head",spr_buy_item_flags(5),"mace_e","bo_weapon", spr_buy_item_triggers("itm_club_with_spike_head", resources=["itm_iron_bar_med", "itm_wood_pole"], skill_required=2)),
  ("pw_buy_long_spiked_club",spr_buy_item_flags(6),"mace_long_c","bo_weapon_big", spr_buy_item_triggers("itm_long_spiked_club", resources=["itm_wood_pole"], skill_required=2)),
  ("pw_buy_long_hafted_spiked_mace",spr_buy_item_flags(9),"mace_long_b","bo_weapon_big", spr_buy_item_triggers("itm_long_hafted_spiked_mace", resources=["itm_iron_bar", "itm_wood_pole"], skill_required=3)),
  ("pw_buy_fighting_pick",spr_buy_item_flags(8),"fighting_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_fighting_pick", resources=["itm_iron_bar", "itm_stick"], skill_required=2)),
  ("pw_buy_military_pick",spr_buy_item_flags(11),"steel_pick_new","bo_weapon_small", spr_buy_item_triggers("itm_military_pick", resources=["itm_iron_bar", "itm_stick"], skill_required=2)),
  ("pw_buy_morningstar",spr_buy_item_flags(26),"mace_morningstar_new","bo_weapon", spr_buy_item_triggers("itm_morningstar", resources=["itm_iron_bar_long", "itm_iron_bar"], skill_required=4)),
  ("pw_buy_falchion",spr_buy_item_flags(9),"falchion_new","bo_weapon_small", spr_buy_item_triggers("itm_falchion", resources=["itm_iron_bar_med"], skill_required=1)),
  ("pw_buy_curved_sword",spr_buy_item_flags(12),"khergit_sword","bo_weapon", spr_buy_item_triggers("itm_curved_sword", resources=["itm_iron_bar_long"], skill_required=1)),
  ("pw_buy_sword_medieval_a",spr_buy_item_flags(14),"sword_medieval_a","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_a", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_sword_medieval_b_small",spr_buy_item_flags(13),"sword_medieval_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_b_small", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_sword_medieval_c_long",spr_buy_item_flags(16),"sword_medieval_c_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_c_long", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_sword_medieval_d_long",spr_buy_item_flags(15),"sword_medieval_d_long","bo_weapon", spr_buy_item_triggers("itm_sword_medieval_d_long", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_sword_viking_c",spr_buy_item_flags(13),"sword_viking_c","bo_weapon", spr_buy_item_triggers("itm_sword_viking_c", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_sword_viking_b_small",spr_buy_item_flags(12),"sword_viking_b_small","bo_weapon", spr_buy_item_triggers("itm_sword_viking_b_small", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_sword_viking_a_long",spr_buy_item_flags(15),"sword_viking_a_long","bo_weapon", spr_buy_item_triggers("itm_sword_viking_a_long", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_scimitar",spr_buy_item_flags(22),"scimitar_a","bo_weapon", spr_buy_item_triggers("itm_scimitar", resources=["itm_iron_bar_long"], skill_required=2)),
  ("pw_buy_scimitar_b",spr_buy_item_flags(24),"scimitar_b","bo_weapon", spr_buy_item_triggers("itm_scimitar_b", resources=["itm_iron_bar_long"], skill_required=3)),
  ...
  ("pw_buy_military_cleaver_b",spr_buy_item_flags(5),"military_cleaver_b","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_b", resources=["itm_iron_bar_med"], skill_required=2)),
  ("pw_buy_military_cleaver_c",spr_buy_item_flags(6),"military_cleaver_c","bo_weapon", spr_buy_item_triggers("itm_military_cleaver_c", resources=["itm_iron_bar_med"], skill_required=2)),
  ...
  ("pw_buy_one_handed_war_axe_b",spr_buy_item_flags(6),"one_handed_war_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_war_axe_b", resources=["itm_iron_bar", "itm_stick"], skill_required=2)),
  ("pw_buy_one_handed_battle_axe_a",spr_buy_item_flags(6),"one_handed_battle_axe_a","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_a", resources=["itm_iron_bar", "itm_stick"], skill_required=2)),
  ("pw_buy_one_handed_battle_axe_b",spr_buy_item_flags(7),"one_handed_battle_axe_b","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_b", resources=["itm_iron_bar", "itm_stick"], skill_required=3)),
  ("pw_buy_one_handed_battle_axe_c",spr_buy_item_flags(7),"one_handed_battle_axe_c","bo_weapon_small", spr_buy_item_triggers("itm_one_handed_battle_axe_c", resources=["itm_iron_bar", "itm_stick"], skill_required=3)),
  ("pw_buy_sarranid_axe_a",spr_buy_item_flags(7),"one_handed_battle_axe_g","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_a", resources=["itm_iron_bar_med"], skill_required=3)),
  ("pw_buy_sarranid_axe_b",spr_buy_item_flags(8),"one_handed_battle_axe_h","bo_weapon_small", spr_buy_item_triggers("itm_sarranid_axe_b", resources=["itm_iron_bar_med"], skill_required=3)),
  ("pw_buy_two_handed_axe",spr_buy_item_flags(15),"two_handed_battle_axe_a","bo_weapon", spr_buy_item_triggers("itm_two_handed_axe", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=3)),
  ("pw_buy_two_handed_battle_axe",spr_buy_item_flags(18),"two_handed_battle_axe_b","bo_weapon", spr_buy_item_triggers("itm_two_handed_battle_axe", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=4)),
  ("pw_buy_shortened_voulge",spr_buy_item_flags(21),"two_handed_battle_axe_c","bo_weapon", spr_buy_item_triggers("itm_shortened_voulge", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=5)),
  ("pw_buy_bardiche",spr_buy_item_flags(23),"two_handed_battle_axe_d","bo_weapon", spr_buy_item_triggers("itm_bardiche", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=5)),
  ...
  ("pw_buy_sarranid_two_handed_axe_a",spr_buy_item_flags(16),"two_handed_battle_axe_g","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_a", resources=["itm_iron_bar_long"], skill_required=4)),
  ("pw_buy_sarranid_two_handed_axe_b",spr_buy_item_flags(18),"two_handed_battle_axe_h","bo_weapon", spr_buy_item_triggers("itm_sarranid_two_handed_axe_b", resources=["itm_iron_bar_long"], skill_required=5)),
  ("pw_buy_glaive",spr_buy_item_flags(13),"glaive_b","bo_weapon_big", spr_buy_item_triggers("itm_glaive", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=3)),
  ...
  ("pw_buy_shortened_spear",spr_buy_item_flags(3),"spear_g_1-9m","bo_weapon", spr_buy_item_triggers("itm_shortened_spear", resources=["itm_wood_pole"], skill_required=1)),
  ("pw_buy_spear",spr_buy_item_flags(3),"spear_h_2-15m","bo_weapon_big", spr_buy_item_triggers("itm_spear", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=1)),
  ("pw_buy_bamboo_spear",spr_buy_item_flags(7),"arabian_spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_bamboo_spear", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=1)),
  ("pw_buy_war_spear",spr_buy_item_flags(4),"spear_i_2-3m","bo_weapon_big", spr_buy_item_triggers("itm_war_spear", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=1)),
  ("pw_buy_light_lance",spr_buy_item_flags(4),"spear_b_2-75m","bo_weapon_big", spr_buy_item_triggers("itm_light_lance", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=1)),
  ("pw_buy_lance",spr_buy_item_flags(5),"spear_d_2-8m","bo_weapon_big", spr_buy_item_triggers("itm_lance", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=2)),
  ("pw_buy_heavy_lance",spr_buy_item_flags(6),"spear_f_2-9m","bo_weapon_big", spr_buy_item_triggers("itm_heavy_lance", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=2)),
  ("pw_buy_awlpike",spr_buy_item_flags(7),"awl_pike_b","bo_weapon_big", spr_buy_item_triggers("itm_awlpike", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=2)),
  ("pw_buy_awlpike_long",spr_buy_item_flags(8),"awl_pike_a","bo_weapon_big", spr_buy_item_triggers("itm_awlpike_long", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=2)),
  ("pw_buy_pike",spr_buy_item_flags(9),"spear_a_3m","bo_weapon_big", spr_buy_item_triggers("itm_pike", resources=["itm_wood_pole", "itm_iron_bar"], skill_required=2)),
  ("pw_buy_bec_de_corbin_a",spr_buy_item_flags(17),"bec_de_corbin_a","bo_weapon", spr_buy_item_triggers("itm_bec_de_corbin_a", resources=["itm_wood_pole", "itm_iron_bar_med"], skill_required=3)),
  ("pw_buy_hunting_bow",spr_buy_item_flags(4),"hunting_bow","bo_weapon", spr_buy_item_triggers("itm_hunting_bow", resources=["itm_wood_pole"], skill_required=1)),
  ("pw_buy_short_bow",spr_buy_item_flags(5),"short_bow","bo_weapon", spr_buy_item_triggers("itm_short_bow", resources=["itm_wood_pole"], skill_required=1)),
  ("pw_buy_nomad_bow",spr_buy_item_flags(7),"nomad_bow","bo_weapon", spr_buy_item_triggers("itm_nomad_bow", resources=["itm_wood_pole"], skill_required=2)),
  ...
  ("pw_buy_khergit_bow",spr_buy_item_flags(14),"khergit_bow","bo_weapon", spr_buy_item_triggers("itm_khergit_bow", resources=["itm_wood_pole"], skill_required=3)),
  ("pw_buy_strong_bow",spr_buy_item_flags(18),"strong_bow","bo_weapon", spr_buy_item_triggers("itm_strong_bow", resources=["itm_wood_pole"], skill_required=4)),
  ...
  ("pw_buy_tab_shield_round_c",spr_buy_item_flags(11),"tableau_shield_round_2","bo_shield_round", spr_buy_item_triggers("itm_tab_shield_round_c", resources=["itm_board", "itm_iron_bar"], skill_required=2, tableau="tableau_round_shield_2")),
  ("pw_buy_tab_shield_round_d",spr_buy_item_flags(15),"tableau_shield_round_1","bo_shield_round", spr_buy_item_triggers("itm_tab_shield_round_d", resources=["itm_board", ("itm_iron_bar", 2)], skill_required=3, tableau="tableau_round_shield_1")),
  ...
  ("pw_buy_tab_shield_kite_c",spr_buy_item_flags(9),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_c", resources=[("itm_board", 2), "itm_iron_bar"], skill_required=2, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_d",spr_buy_item_flags(12),"tableau_shield_kite_2","bo_shield_kite", spr_buy_item_triggers("itm_tab_shield_kite_d", resources=[("itm_board", 2), "itm_iron_bar"], skill_required=3, tableau="tableau_kite_shield_2")),
  ("pw_buy_tab_shield_kite_cav_a",spr_buy_item_flags(7),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_a", resources=["itm_board", "itm_iron_bar"], skill_required=2, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_kite_cav_b",spr_buy_item_flags(10),"tableau_shield_kite_4","bo_shield_kite_small", spr_buy_item_triggers("itm_tab_shield_kite_cav_b", resources=["itm_board", "itm_iron_bar"], skill_required=3, tableau="tableau_kite_shield_4")),
  ("pw_buy_tab_shield_heater_b",spr_buy_item_flags(8),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_b", resources=[("itm_board", 2), "itm_iron_bar"], skill_required=1, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_c",spr_buy_item_flags(10),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_c", resources=[("itm_board", 2), "itm_iron_bar"], skill_required=2, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_d",spr_buy_item_flags(13),"tableau_shield_heater_1","bo_shield_heater", spr_buy_item_triggers("itm_tab_shield_heater_d", resources=[("itm_board", 2), "itm_iron_bar"], skill_required=3, tableau="tableau_heater_shield_1")),
  ("pw_buy_tab_shield_heater_cav_a",spr_buy_item_flags(7),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_a", resources=["itm_board", "itm_iron_bar"], skill_required=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_heater_cav_b",spr_buy_item_flags(10),"tableau_shield_heater_2","bo_shield_heater_small", spr_buy_item_triggers("itm_tab_shield_heater_cav_b", resources=["itm_board", "itm_iron_bar"], skill_required=3, tableau="tableau_heater_shield_2")),
  ("pw_buy_tab_shield_pavise_b",spr_buy_item_flags(10),"tableau_shield_pavise_2","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_b", resources=[("itm_board", 2)], skill_required=1, tableau="tableau_pavise_shield_2")),
  ("pw_buy_tab_shield_pavise_c",spr_buy_item_flags(15),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_c", resources=[("itm_board", 3), "itm_iron_bar"], skill_required=2, tableau="tableau_pavise_shield_1")),
  ("pw_buy_tab_shield_pavise_d",spr_buy_item_flags(20),"tableau_shield_pavise_1","bo_shield_pavise", spr_buy_item_triggers("itm_tab_shield_pavise_d", resources=[("itm_board", 3), "itm_iron_bar"], skill_required=3, tableau="tableau_pavise_shield_1")),
  ...
  ("pw_buy_tab_shield_small_round_b",spr_buy_item_flags(7),"tableau_shield_small_round_1","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_b", resources=["itm_board", "itm_iron_bar"], skill_required=2, tableau="tableau_small_round_shield_1")),
  ("pw_buy_tab_shield_small_round_c",spr_buy_item_flags(15),"tableau_shield_small_round_2","bo_shield_round_small", spr_buy_item_triggers("itm_tab_shield_small_round_c", resources=["itm_board", "itm_iron_bar"], skill_required=3, tableau="tableau_small_round_shield_2")),
  ...
  ("pw_ship_c",sokf_moveable|sokf_destructible|sokf_show_hit_point_bar,"pw_ship_c","bo_pw_ship_c", spr_ship_triggers(hit_points=10000, length=1400, width=300, sail="pw_ship_c_sail", sail_off="pw_ship_c_sail_off", ramp="pw_ship_c_ramp", collision="pw_ship_c_cd")),
  ...
  ("pw_ship_d",sokf_moveable|sokf_destructible|sokf_show_hit_point_bar,"pw_ship_d","bo_pw_ship_d", spr_ship_triggers(hit_points=7000, length=900, width=250, sail="pw_ship_d_sail", collision="pw_ship_d_cd")),
