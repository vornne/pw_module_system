...
try_for_agents                                    = 12   # (try_for_agents, <cur_agent_id>, [<position_no>], [<radius_fixed_point>]),
...
try_for_active_players                            = 16   # (try_for_active_players, <cur_player_id>, [<skip_server>]),
                                                         # Loops through all active players. If [<skip_server>] is set to non-zero, the server player (0) will be skipped
try_for_prop_instances                            = 17   # (try_for_prop_instances, <cur_instance_id>, [<scene_prop_kind_no>]),
                                                         # Loops through scene prop instances of [<scene_prop_kind_no>]. If [<scene_prop_kind_no>] is not set it will loop through all scene prop instances in the scene
...
str_index_of                                      = 2608 # (str_index_of, <destination>, <string_1>, <string_2>, [<start>], [<end>]),
...
str_last_index_of                                 = 2609 # (str_last_index_of, <destination>, <string_1>, <string_2>, [<start>], [<end>]),
...
str_to_num                                        = 2611 # (str_to_num, <destination_fixed_point>, <string_1>, [<use_fixed_point_multiplier>]),
...
str_compare                                       = 2612 # (str_compare, <destination>, <string_1>, <string_2>, [<case_insensitive>]),
                                                         # Stores the relationship between <string_1> and <string_2> into <destination> (-1: s1 < s2, 0: s1 = s2, 1: s1 > s2)
str_split                                         = 2613 # (str_split, <destination>, <string_register>, <string_1>, <delimiter>, [<skip_empty>], [<max>]),
...
str_store_trim                                    = 2617 # (str_store_trim, <string_register>, <string_1>, [<trim_mode>]),
...
str_store_replace                                 = 2618 # (str_store_replace, <string_register>, <string_1>, <string_2>, <string_3>),
...
str_store_substring                               = 2620 # (str_store_substring, <string_register>, <string_1>, [<start>], [<length>]),
...
str_store_join                                    = 2622 # (str_store_join, <string_register>, <start_string_register>, <count>, [<delimiter>]),
...
str_store_player_ip                               = 2631 # (str_store_player_ip, <string_register>, <player_id>), # Stores <player_id>'s IP address into <string_register> (works only on servers)
...
str_store_float                                   = 2634 # (str_store_float, <string_register>, <fp_register>, [<precision>]),
...
player_get_face_keys                              = 2900 # (player_get_face_keys, <face_key_register>, <player_id>), # Stores <player_id>'s face keys into <face_key_register>
player_set_face_keys                              = 2901 # (player_set_face_keys, <player_id>, <face_key_register>), # Sets <player_id>'s face keys to <face_key_register>
player_set_skin                                   = 2902 # (player_set_skin, <player_id>, <skin_no>), # Sets <player_id>'s skin (gender) to <skin_no> (requires network_compatible = 0 in wse_settings.ini)
player_stop_controlling_agent                     = 2903 # (player_stop_controlling_agent, <player_id>), # Gives <player_id>'s agent back to AI control (requires network_compatible = 0 in wse_settings.ini)
player_set_banner_id                              = 2904 # (player_set_banner_id, <player_id>, <banner_no>), # Sets <player_id>'s banner to <banner_no>
...
timer_reset                                       = 3028 # (timer_reset, <timer_register_no>, [<use_game_time>]),
...
agent_get_item_slot_ammo                          = 3305 # (agent_get_item_slot_ammo, <destination>, <agent_id>, <item_slot_no>), # Stores <agent_id>'s <item_slot_no> ammo count into <destination>
agent_set_item_slot_ammo                          = 3306 # (agent_set_item_slot_ammo, <agent_id>, <item_slot_no>, <value>), # Sets <agent_id>'s <item_slot_no> ammo count to <value>
agent_get_item_slot_hit_points                    = 3307 # (agent_get_item_slot_hit_points, <destination>, <agent_id>, <item_slot_no>), # Stores <agent_id>'s <item_slot_no> shield hitpoints into <destination>
agent_set_item_slot_hit_points                    = 3308 # (agent_set_item_slot_hit_points, <agent_id>, <item_slot_no>, <value>), # Sets <agent_id>'s <item_slot_no> shield hitpoints to <value>
agent_get_wielded_item_slot_no                    = 3309 # (agent_get_wielded_item_slot_no, <destination>, <agent_id>, [<hand_no>]), # Stores <agent_id>'s wielded item slot for [<hand_no>] into <destination>
agent_get_bone_position                           = 3310 # (agent_get_bone_position, <position_register>, <agent_id>, <bone_no>), # Stores <agent_id>'s <bone_no> position into <position_register>
agent_get_scale                                   = 3311 # (agent_get_scale, <destination_fixed_point>, <agent_id>), # Stores <agent_id>'s scale into <destination_fixed_point>
agent_set_forced_lod                              = 3312 # (agent_set_forced_lod, <agent_id>, <lod_level>), # Forces <agent_id>'s LOD level to <lod_level> (0 = auto)
agent_get_item_slot_flags                         = 3313 # (agent_get_item_slot_flags, <destination>, <agent_id>, <item_slot_no>), # Stores <agent_id>'s <item_slot_no> item slot flags into <destination>
agent_ai_get_move_target_position                 = 3314 # (agent_ai_get_move_target_position, <position_register>, <agent_id>), # Stores <agent_id>'s move target position agent into <position_register>
agent_set_horse                                   = 3315 # (agent_set_horse, <agent_id>, <horse_agent_id>), # Sets <agent_id>'s horse to <horse_agent_id> (-1 for no horse)
agent_ai_set_simple_behavior                      = 3316 # (agent_ai_set_simple_behavior, <agent_id>, <simple_behavior>, [<guaranteed_time>]),
...
agent_accelerate                                  = 3317 # (agent_accelerate, <agent_id>, <position_register_no>), # Uses x, y, z components of <position_register_no> to apply acceleration to <agent_id>
agent_set_item_slot_modifier                      = 3318 # (agent_set_item_slot_modifier, <agent_id>, <item_slot_no>, <item_modifier_no>), # Sets <agent_id>'s <item_slot_no> modifier to <item_modifier_no>
...
multiplayer_send_composite_message_to_player      = 3401 # (multiplayer_send_composite_message_to_player, <player_id>, <message_type>, <message_register>),
                                                         # Sends <message_register> with <message_type> to <player_id> (requires network_compatible = 0 in wse_settings.ini)
multiplayer_send_composite_message_to_server      = 3402 # (multiplayer_send_composite_message_to_server, <message_type>, <message_register>),
                                                         # Sends <message_register> with <message_type> to the server (requires network_compatible = 0 in wse_settings.ini)
...
multiplayer_message_put_string                    = 3407 # (multiplayer_message_put_string, <message_register>, <string>),
                                                         # Puts <string> into <message_register> (requires network_compatible = 0 in wse_settings.ini)
multiplayer_message_put_int                       = 3408 # (multiplayer_message_put_int, <message_register>, <value>, [<num_bits>]),
                                                         # Puts [<num_bits>] of <value> into <message_register> (requires network_compatible = 0 in wse_settings.ini)
multiplayer_message_put_position                  = 3409 # (multiplayer_message_put_position, <message_register>, <position_register>, [<local>]),
                                                         # Puts <position_register> into <9>. Set [<local>] to non-zero for small, relative positions (default: scene positions) (requires network_compatible = 0 in wse_settings.ini)
multiplayer_message_put_coordinate                = 3410 # (multiplayer_message_put_coordinate, <message_register>, <position_register>, [<local>]),
                                                         # Puts x, y, z coordinates from <position_register> into <message_register>.
                                                         # Set [<local>] to non-zero for small, relative positions (default: scene positions) (requires network_compatible = 0 in wse_settings.ini)
multiplayer_message_put_face_keys                 = 3411 # (multiplayer_message_put_face_keys, <message_register>, <face_keys_register>),
                                                         # Puts <face_keys_register> into <message_register> (requires network_compatible = 0 in wse_settings.ini)
multiplayer_cur_message_get_string                = 3412 # (multiplayer_cur_message_get_string, <string_register>),
                                                         # Stores a string from the current message register into <string_register> (requires network_compatible = 0 in wse_settings.ini)
multiplayer_cur_message_get_int                   = 3413 # (multiplayer_cur_message_get_int, <destination>, [<num_bits>]),
                                                         # Stores [<num_bits>] of an int from the current message register into <destination>.
                                                         # [<num_bits>] MUST match the number of bits sent (requires network_compatible = 0 in wse_settings.ini)
multiplayer_cur_message_get_position              = 3414 # (multiplayer_cur_message_get_position, <position_register>, [<local>]),
                                                         # Stores a position from the current message register into <position_register>.
                                                         # [<local>] MUST match the type sent (requires network_compatible = 0 in wse_settings.ini)
multiplayer_cur_message_get_coordinate            = 3415 # (multiplayer_cur_message_get_coordinate, <position_register>, [<local>]),
                                                         # Stores x, y, z coordinates from the current message register into <position_register>.
                                                         # [<local>] MUST match the type sent (requires network_compatible = 0 in wse_settings.ini)
multiplayer_cur_message_get_face_keys             = 3416 # (multiplayer_cur_message_get_face_keys, <face_keys_register>),
                                                         # Stores face keys from the current message register into <face_keys_register> (requires network_compatible = 0 in wse_settings.ini)
...
prop_instance_clear_attached_missiles             = 3601 # (prop_instance_clear_attached_missiles, <prop_instance_id>),
                                                         # Removes all attached missiles from <prop_instance_id>. Works only with dynamic scene props (non-retrievable missiles)
...
set_ally_collision_threshold                      = 3605 # (set_ally_collision_threshold, <low_boundary>, <high_boundary>),
                                                         # Changes the animation progress boundaries (in percents) that determine if attacks on allies will collide (default: 45% <= x <= 60%)
set_prop_collision_threshold                      = 3606 # (set_prop_collision_threshold, <attack_direction>, <low_boundary>, <high_boundary>),
...
particle_system_remove                            = 3607 # (particle_system_remove, [<particle_system_no>]),
...
get_spectated_agent_id                            = 3609 # (get_spectated_agent_id, <destination>), # Stores spectated agent id into <destination>
prop_instance_set_forced_lod                      = 3610 # (prop_instance_set_forced_lod, <prop_instance_id>, <lod_level>), # Forces <prop_instance_id>'s LOD level to <lod_level> (0 = auto)
prop_instance_set_variation_id                    = 3611 # (prop_instance_set_variation_id, <prop_instance_id>, <value>), # Sets <prop_instance_id>'s variation id to <value>
prop_instance_set_variation_id_2                  = 3612 # (prop_instance_set_variation_id_2, <prop_instance_id>, <value>), # Sets <prop_instance_id>'s variation id 2 to <value>
stop_time                                         = 3613 # (stop_time, <value>), # Stops/resumes the mission. Works only in singleplayer with cheat mode enabled.
cur_missile_get_path_point_position               = 3614 # (cur_missile_get_path_point_position, <position_register>, <path_point_no>),
                                                         # Stores the position of the missile's <path_point_no> (0-499) into <position_register> (can be used in ti_on_init_missile)
get_water_level                                   = 3615 # (get_water_level, <destination_fixed_point>), # Stores the water level into <destination_fixed_point>
cast_ray                                          = 3616 # (cast_ray, <destination>, <hit_position_register>, <ray_position_register>, [<ray_length_fixed_point>]),
                                                         # Casts a ray of length [<ray_length_fixed_point>] starting from <ray_position_register> and stores the closest hit position into <hit_position_register> (fails if no hits).
                                                         # If the body hit is a prop instance, its id will be stored into <destination>
prop_instance_set_vertex_keys_time_point          = 3617 # (prop_instance_set_vertex_keys_time_point, <prop_instance_id>, <time_point>), # Sets <prop_instance_id>'s mesh vertex keys time point to <time_point>
...
troop_get_face_keys                               = 3706 # (troop_get_face_keys, <face_key_register>, <troop_no>, [<alt>]),
                                                         # Stores <troop_no>'s face keys into <face_key_register>. if [<alt>] is non-zero the second pair of face keys is stored
troop_set_face_keys                               = 3707 # (troop_set_face_keys, <troop_no>, <face_key_register>, [<alt>]),
                                                         # Sets <troop_no>'s face keys to <face_key_register>. if [<alt>] is non-zero the second pair of face keys is set
...
position_get_vector_to_position                   = 4101 # (position_get_vector_to_position, <destination_fixed_point>, <dest_position_register>, <position_register_1>, <position_register_2>),
...
position_align_to_ground                          = 4102 # (position_align_to_ground, <position_register>, [<point_up>], [<set_z_to_ground_level>]),
...
edit_mode_get_selected_prop_instance              = 4602 # (edit_mode_get_selected_prop_instance, <destination>, <index>), # Stores the <index>th selected prop instance into into <destination>
edit_mode_select_prop_instance                    = 4603 # (edit_mode_select_prop_instance, <prop_instance_id>), # Stores the <1>th selected prop instance into <prop_instance_id>
edit_mode_deselect_prop_instance                  = 4604 # (edit_mode_deselect_prop_instance, <prop_instance_id>), # Stores the <1>th selected prop instance into <prop_instance_id>
...
edit_mode_set_highlighted_prop_instance           = 4606 # (edit_mode_set_highlighted_prop_instance, [<prop_instance_id>]), # Stores the <1>th selected prop instance into [<prop_instance_id>]
