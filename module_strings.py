...
Troop type, faction, gold, and outlaw rating are saved every few seconds, and if you get disconnected from the game, when you rejoin your previous stats will be given back, minus some gold. At peasant, ruffian, or brigand training stations, clicking use will switch faction to commoners or outlaws without respawning, keeping your previous class until you die; but after that you will respawn as the targeted troop, unless your previous troop type was peasant or serf. You can also switch factions by just clicking use if you are using the targeted troop type already. \
...
As admin, holding down right shift while voting overrides the poll."),
