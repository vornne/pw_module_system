    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        ...
        (presentation_set_duration, 0),
        (multiplayer_send_message_to_server, client_event_spectate),
      (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":player_id", 1, ":num_players"),
        ...
        (try_begin),
          (this_or_next|eq, "$g_list_players_event", client_event_admin_action),
          (eq, "$g_list_players_event", client_event_request_poll),
          (multiplayer_send_2_int_to_server, "$g_list_players_event", "$g_list_players_event_value", ":player_id"),
        (else_try),
          (multiplayer_send_int_to_server, "$g_list_players_event", ":player_id"),
        (try_end),
  ...
  ("respawn_time_counter", prsntf_read_only|prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_text_overlay, "$g_presentation_obj_respawn_counter_2", "str_empty_string", tf_center_justify|tf_with_outline),
