   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (create_button_overlay, reg0, "str_ban_player", 0),
        (assign, "$g_presentation_obj_escape_menu_ban_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        ...
        (assign, "$g_presentation_obj_escape_menu_ban_player", -1),
      (try_end),
      ...
      (try_begin),
        ...
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_ban_player", pos1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (presentation_set_duration, 0),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_ban_player"),
        (presentation_set_duration, 0),
      (else_try),
