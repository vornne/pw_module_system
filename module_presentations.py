   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, "$g_presentation_obj_escape_menu_kick_player", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (val_add, ":cur_y", escape_menu_item_height),

        (create_button_overlay, reg0, "str_ban_player_temp", 0),
        (assign, "$g_presentation_obj_escape_menu_ban_player_temp", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (val_add, ":cur_y", escape_menu_item_height),

        (create_button_overlay, reg0, "str_ban_player_perm", 0),
        (assign, "$g_presentation_obj_escape_menu_ban_player_perm", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_escape_menu_admin_panel", -1),
        (assign, "$g_presentation_obj_escape_menu_kick_player", -1),
        (assign, "$g_presentation_obj_escape_menu_ban_player_temp", -1),
        (assign, "$g_presentation_obj_escape_menu_ban_player_perm", -1),
      (try_end),
      ...
      (try_begin),
        ...
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_kick_player", pos1),

        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_ban_player_temp", pos1),

        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_escape_menu_ban_player_perm", pos1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_kick_player"),
        (presentation_set_duration, 0),
        (assign, "$g_list_players_action_string_id", "str_kick"),
        (assign, "$g_list_players_event", client_event_admin_kick_player),
        (start_presentation, "prsnt_list_players"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_ban_player_temp"),
        (presentation_set_duration, 0),
        (assign, "$g_list_players_action_string_id", "str_ban_temp"),
        (assign, "$g_list_players_event", client_event_admin_ban_player),
        (assign, "$g_list_players_event_value", 1),
        (start_presentation, "prsnt_list_players"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_ban_player_perm"),
        (presentation_set_duration, 0),
        (assign, "$g_list_players_action_string_id", "str_ban_perm"),
        (assign, "$g_list_players_event", client_event_admin_ban_player),
        (assign, "$g_list_players_event_value", 0),
        (start_presentation, "prsnt_list_players"),
      (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":player_id", 1, ":num_players"),
        ...
        (try_begin),
          (eq, "$g_list_players_event", client_event_admin_ban_player),
          (multiplayer_send_2_int_to_server, "$g_list_players_event", ":player_id", "$g_list_players_event_value"),
        (else_try),
