          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (else_try),
                ...
                (player_slot_eq, ":player_id", slot_player_has_faction_chest_key, 0),
              (else_try),
    ...
    (ti_on_presentation_run,
     [(try_begin),
        ...
        (try_for_range, ":chat_line_no", 0, chat_overlay_ring_buffer_size),
          (store_sub, ":overlay_troop_id", "$g_chat_overlay_ring_buffer_stored", ":chat_line_no"),
          (try_begin),
          ...
          (troop_get_slot, ":color", ":overlay_troop_id", slot_chat_overlay_color),
          (overlay_set_color, ":overlay_id", ":color"),
          (val_add, ":overlay_id", 1),
        (try_end),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (try_begin),
        ...
        (try_end),
      (else_try),
        (eq, ":string_id", "str_toggle_local_chat_overlay"),
        (try_begin),
