     ...
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (val_add, ":loop_end", 1),
          (assign, ":closest_sq_distance", sq(max_distance_to_use)),
          ...
          (try_end),
          (lt, ":closest_sq_distance", sq(max_distance_to_use)),
      ...
      (else_try),
        (is_between, ":string_id", "str_loot_head", "str_toggle_automatic_shadow_recalculation"),
        (try_begin),
          (neq, "$g_action_menu_confirm", -1),
          (neq, "$g_action_menu_confirm", ":string_id"),
          (assign, ":ask_confirm", 1),
        (else_try),
          ...
          (try_begin),
            ...
            (try_end),
          (else_try),
            (assign, ":closest_sq_distance", sq(max_distance_to_loot)),
            ...
            (try_end),
            (eq, ":closest_sq_distance", sq(max_distance_to_loot)),
