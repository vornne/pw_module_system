     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":player_id", 1, ":num_players"),
        ...
        (try_begin),
          ...
          (else_try),
            (eq, "$g_list_players_event", client_event_faction_admin_action),
            (eq, "$g_list_players_event_value", faction_admin_action_toggle_player_chest_key),
            (player_slot_eq, ":player_id", slot_player_has_faction_chest_key, 1),
          (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        ...
        (agent_get_player_id, ":player_id", "$g_target_agent_id"),
        (player_is_active, ":player_id"),
        (multiplayer_send_2_int_to_server, client_event_admin_action, ":action", ":player_id"),
      (else_try),
  ...
  ("faction_admin_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, "$g_presentation_obj_faction_admin_manage_chest_keys", "str_manage_chest_keys", tf_center_justify),
      (overlay_set_color, "$g_presentation_obj_faction_admin_manage_chest_keys", 0xFFFFFF),
      (overlay_set_size, "$g_presentation_obj_faction_admin_manage_chest_keys", pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_faction_admin_manage_chest_keys", pos1),
      (val_add, ":cur_y", escape_menu_item_height),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (else_try),
          (eq, ":object", "$g_presentation_obj_faction_admin_manage_chest_keys"),
          (assign, "$g_list_players_event_value", faction_admin_action_toggle_player_chest_key),
          (assign, "$g_list_players_action_string_id", "str_give_take_chest_key"),
        (else_try),
          (assign, ":found", 0),
        (try_end),
        (eq, ":found", 1),
     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":player_id", 1, ":max_players"),
        ...
        (else_try),
          ...
          (val_mul, ":player_score", 1 << stats_chart_score_shift),
          (val_mul, ":player_ranking", 1 << stats_chart_ranking_shift),
      ...
      (try_end),
      (val_sub, ":start_x", 100),
      (store_mul, ":cur_y", ":player_count", 20),
     ...
     [(store_trigger_param_1, ":object"),
      (try_begin),
        ...
        (try_begin),
          ...
          (store_mul, ":event_type", "$g_chat_box_event_type", net_chat_type_multiplier),
          (val_add, ":event", ":event_type"),
          (assign, ":continue", 1),
          (try_begin),
          ...
          (else_try),
            (player_is_active, "$g_target_player_id"),
            (player_slot_eq, "$g_target_player_id", slot_player_list_button_id, "$g_target_player_overlay_id"),
            (store_mul, ":target_player_id", "$g_target_player_id", net_chat_param_1_multiplier),
            (is_between, ":target_player_id", 0, net_value_upper_bound),
            (val_add, ":event", ":target_player_id"),
          (else_try),
            (assign, ":continue", 0),
          (try_end),
          (eq, ":continue", 1),
