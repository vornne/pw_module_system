...
before_mission_start_setup = (ti_before_mission_start, 0, 0, [],
...
after_mission_start_setup = (ti_after_mission_start, 0, 0, [],
...
player_joined = (ti_server_player_joined, 0, 0, [],
...
player_exit = (ti_on_player_exit, 0, 0, [],
   [(store_trigger_param_1, ":player_id"),
    (call_script, "script_cf_save_player_exit", ":player_id"),
    ])

agent_spawn = (ti_on_agent_spawn, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    (call_script, "script_on_agent_spawned", ":agent_id"),
    ])

agent_killed = (ti_on_agent_killed_or_wounded, 0, 0, [],
...
item_picked_up = (ti_on_item_picked_up, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    ...
    (call_script, "script_agent_adjust_stats_for_item", ":agent_id", ":item_id", 1, 1),
    ])
...
item_dropped = (ti_on_item_dropped, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    ...
    (call_script, "script_agent_adjust_stats_for_item", ":agent_id", ":item_id", 0, 1),
    ])

item_wielded = (ti_on_item_wielded, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    (store_trigger_param_2, ":item_id"),
    (call_script, "script_agent_adjust_stats_for_item", ":agent_id", ":item_id", 1, 0),
    ])

item_unwielded = (ti_on_item_unwielded, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    (store_trigger_param_2, ":item_id"),
    (call_script, "script_agent_adjust_stats_for_item", ":agent_id", ":item_id", 0, 0),
    ])

agent_mount = (ti_on_agent_mount, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
...
agent_dismount = (ti_on_agent_dismount, 0, 0, [],
   [(store_trigger_param_1, ":agent_id"),
    (store_trigger_param_2, ":horse_agent_id"),
    (agent_set_slot, ":horse_agent_id", slot_agent_horse_last_rider, ":agent_id"),
    (agent_set_slot, ":agent_id", slot_agent_last_horse_ridden, ":horse_agent_id"),
...
player_check_loop = (0, 0, 0.5,
   [(multiplayer_is_server),
    ...
    (try_for_range, ":player_id", "$g_loop_player_id", ":loop_end"),
      ...
      (try_end),
    (try_end),
    (eq, ":loop_end", ":max_players"),
    (assign, "$g_loop_player_id", 1),
    (try_begin),
   ...
   [(multiplayer_is_server),
    ...
    (else_try),
      ...
      (try_begin),
        ...
        (assign, "$g_loop_agent_last_checked", -1),
        (try_begin),
      ...
      (try_end),
    (try_end),
    (eq, "$g_loop_agent_last_checked", -2),
    ], [])

ship_movement_loop = (0, 0, 0.1,
   [(try_begin),
      (multiplayer_is_server),
...
herd_leader_movement_loop = (5, 0, 0, [],
   [(multiplayer_is_server),
    (le, "$g_loop_animal_herd_begin", 0),
      ...
      (try_for_range, ":herd_slot", 0, ":loop_end"),
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (store_random_in_range, ":move_time", 5, 31),
            (val_add, ":move_time", ":time"),
            (agent_set_slot, "$g_loop_animal_herd_leader", slot_agent_animal_move_time, ":move_time"),
            (call_script, "script_animal_move", "$g_loop_animal_herd_leader", "$g_loop_animal_herd_leader"),
          (else_try),
            (assign, ":loop_end", -1),
          (try_end),
        (else_try),
...
herd_follower_movement_loop = (0.5, 0, 0, [],
   [(multiplayer_is_server),
    ...
    (try_begin),
      ...
      (try_for_range, ":herd_slot", "$g_loop_animal_herd_begin", ":loop_end"),
        (scene_prop_get_slot, ":herd_agent_id", ":herd_manager", ":herd_slot"),
        (agent_is_active, ":herd_agent_id"),
...
herd_animal_count_check = (300, 0, 0, [],
   [(multiplayer_is_server),
...
herd_animal_spawn_check = (60, 0, 0, [],
   [(multiplayer_is_server),
    (try_begin),
...
static_presentations_setup = (ti_battle_window_opened, 0, 0, [],
   [(try_begin),
...
chat_resend_check = (0.3, 0.3, 0, [(troop_slot_eq, "trp_last_chat_message", slot_last_chat_message_not_recieved, 1)],
...
local_chat_pressed = (0, 0.05, 0, [(game_key_clicked, gk_local_chat),(call_script, "script_cf_no_input_presentation_active")],
...
faction_chat_pressed = (0, 0.05, 0, [(game_key_clicked, gk_faction_chat),(call_script, "script_cf_no_input_presentation_active")],
   [(multiplayer_get_my_player, ":player_id"),
...
admin_chat_pressed = (0, 0.05, 0, [(game_key_clicked, gk_admin_chat),(call_script, "script_cf_no_input_presentation_active")],
   [(try_begin),
      (multiplayer_get_my_player, ":player_id"),
...
money_bag_pressed = (0, 0, 0, [],
   [(game_key_clicked, gk_money_bag),
    (call_script, "script_cf_no_input_presentation_active"),
    (start_presentation, "prsnt_money_bag"),
    ])

animation_menu_pressed = (0, 0.05, 0, [(game_key_clicked, gk_animation_menu),(call_script, "script_cf_no_input_presentation_active")],
   [(try_begin),
