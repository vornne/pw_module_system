...
####################################################################################################################
  ...
  ["peasant","Peasant","a peasant",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_8|agi_8|pw_attr,wpex(50,50,50,1,1,30),knows_pw|knows_labouring_2|knows_riding_1,default_face_1,default_face_2],
  ["serf","Serf","a serf",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_ragged_shirt","itm_hatchet","itm_small_mining_pick"],
   str_5|agi_5|pw_attr,wpex(30,30,30,1,1,50),knows_pw|knows_labouring_5|knows_engineer_1|knows_tailoring_1|knows_herding_3|knows_riding_1,default_face_1,default_face_2],
  ["militia","Militia","a militia",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_9|pw_attr,wpex(70,60,70,10,20,50),knows_pw|knows_ironflesh_2|knows_power_strike_1|knows_athletics_2|knows_riding_1|knows_labouring_1|knows_herding_2,default_face_1,default_face_2],
  ["huntsman","Huntsman","a huntsman",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_9|agi_9|pw_attr,wpex(60,50,50,100,10,50),knows_pw|knows_ironflesh_1|knows_power_draw_2|knows_athletics_1|knows_riding_1|knows_labouring_1|knows_herding_3,default_face_1,default_face_2],
  ["craftsman","Craftsman","a craftsman",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_old_coarse_tunic"],
   str_8|agi_8|pw_attr,wpex(50,30,30,5,5,20),knows_pw|knows_riding_1|knows_engineer_2|knows_labouring_1|knows_tailoring_3,default_face_1,default_face_2],
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_linen_tunic"],
   str_8|agi_8|pw_attr,wpex(40,10,20,1,1,5),knows_pw|knows_riding_1|knows_wound_treatment_1|knows_labouring_1|knows_tailoring_2|knows_herding_1,default_face_1,default_face_2],
  ["footman","Footman","a footman",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_ragged_woolen_cap","itm_old_coarse_tunic","itm_old_tabard","itm_tattered_wrapping_boots","itm_crude_spear","itm_rusty_sword","itm_blunt_falchion"],
   str_15|agi_14|pw_attr,wpex(100,100,130,10,25,80),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_power_throw_2|knows_athletics_5|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["archer","Archer","an archer",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_tattered_headcloth","itm_old_coarse_tunic","itm_old_tabard","itm_tattered_wrapping_boots","itm_crude_bow","itm_bent_arrows"],
   str_14|agi_14|pw_attr,wpex(90,60,70,150,30,50),knows_pw|knows_ironflesh_4|knows_power_strike_2|knows_power_draw_4|knows_athletics_4|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["crossbowman","Crossbowman","a crossbowman",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_ragged_woolen_cap","itm_old_coarse_tunic","itm_old_tabard","itm_tattered_wrapping_boots","itm_flimsy_crossbow","itm_crude_bolts"],
  ...
  ["lancer","Lancer","a lancer",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_14|pw_attr,wpex(90,90,120,10,10,80),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_power_throw_2|knows_athletics_1|knows_riding_6,default_face_1,default_face_2],
  ["man_at_arms","Man at Arms","a man at arms",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|pw_attr,wpex(105,120,110,20,40,30),knows_pw|knows_ironflesh_4|knows_power_strike_4|knows_athletics_2|knows_riding_4,default_face_1,default_face_2],
  ["sergeant","Sergeant","a sergeant",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_old_tabard","itm_old_hide_boots","itm_rusty_sword","itm_worn_sword","itm_old_shield"],
   str_15|agi_15|pw_attr,wpex(110,125,110,20,50,40),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_athletics_5|knows_riding_2,default_face_1,default_face_2],
  ["engineer","Engineer","an engineer",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_12|pw_attr,wpex(90,80,100,30,45,50),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_athletics_2|knows_engineer_5|knows_riding_2|knows_looting_1|knows_sailing_4,default_face_1,default_face_2],
  ["master_smith","Master Smith","a master smith",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_12|agi_12|pw_attr,wpex(100,90,100,30,45,50),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_athletics_2|knows_engineer_7|knows_riding_2|knows_looting_2|knows_sailing_4,default_face_1,default_face_2],
  ["doctor","Doctor","a doctor",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_linen_tunic","itm_ripped_woolen_hose"],
   str_10|agi_10|pw_attr,wpex(70,50,50,10,10,30),knows_pw|knows_athletics_2|knows_power_strike_1|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
  ["sailor","Sailor","a sailor",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_ragged_woolen_cap","itm_old_coarse_tunic","itm_old_tabard","itm_club","itm_blunt_falchion"],
   str_14|agi_12|pw_attr,wpex(95,80,80,20,20,70),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_athletics_2|knows_sailing_9|knows_riding_1,default_face_1,default_face_2],
  ["traveler","Traveler","a traveler",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_13|pw_attr,wpex(60,50,50,10,10,60),knows_pw|knows_ironflesh_1|knows_power_strike_1|knows_athletics_4|knows_sailing_7|knows_riding_3|knows_labouring_1|knows_herding_1,default_face_1,default_face_2],
  ["lord","Lord","the lord",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|pw_attr,wpex(115,115,115,50,50,50),knows_pw|knows_leadership_1|knows_ironflesh_6|knows_power_strike_4|knows_athletics_2|knows_riding_5,default_face_1,default_face_2],
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_club","itm_spiked_club"],
   str_14|agi_12|pw_attr,wpex(80,80,80,10,20,80),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3|knows_riding_1|knows_looting_2,default_face_1,default_face_2],
  ["brigand","Brigand","a brigand",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_knife","itm_blunt_falchion"],
   str_12|agi_12|pw_attr,wpex(70,60,70,100,40,70),knows_pw|knows_ironflesh_2|knows_power_strike_1|knows_power_draw_3|knows_athletics_3|knows_riding_1|knows_looting_6|knows_sailing_4,default_face_1,default_face_2],
  ["mercenary","Mercenary","a mercenary",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_ragged_woolen_cap","itm_stained_felt_hat_b","itm_tattered_headcloth","itm_old_coarse_tunic","itm_old_tabard","itm_tattered_wrapping_boots","itm_old_hide_boots","itm_blunt_falchion","itm_rusty_sword","itm_crude_spear","itm_old_shield","itm_flimsy_crossbow","itm_crude_bolts"],
   str_14|agi_14|pw_attr,wpex(90,70,80,30,60,70),knows_pw|knows_ironflesh_3|knows_power_strike_2|knows_athletics_3|knows_riding_2|knows_engineer_1|knows_sailing_3|knows_tailoring_1,default_face_1,default_face_2],
