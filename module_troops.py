...
####################################################################################################################
  ...
  ["peasant","Peasant","a peasant",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_8|agi_8|int_4|cha_4|level(1),wpex(50,50,50,10,20,30),knows_labouring_2|knows_riding_1,default_face_1,default_face_2],
  ["serf","Serf","a serf",tf_guarantee_all,0,0,"fac_commoners",
   ...
   pw_str_5|agi_5|int_4|cha_4|level(1),wpex(30,30,30,10,10,10),knows_labouring_5|knows_engineer_1|knows_riding_1,default_face_1,default_face_2],
  ["militia","Militia","a militia",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_9|int_4|cha_4|level(1),wpex(70,60,70,30,50,50),knows_ironflesh_2|knows_power_strike_1|knows_athletics_2|knows_riding_1|knows_labouring_1,default_face_1,default_face_2],
  ["huntsman","Huntsman","a huntsman",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_9|agi_9|int_4|cha_4|level(1),wpex(60,50,50,100,50,50),knows_ironflesh_1|knows_power_draw_2|knows_athletics_1|knows_riding_1|knows_labouring_1,default_face_1,default_face_2],
  ["craftsman","Craftsman","a craftsman",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_8|agi_8|int_4|cha_4|level(1),wpex(50,30,30,20,50,30),knows_riding_1|knows_engineer_2|knows_labouring_1,default_face_1,default_face_2],
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_8|agi_8|int_4|cha_4|level(1),wpex(40,10,20,10,10,30),knows_riding_1|knows_wound_treatment_1|knows_labouring_1,default_face_1,default_face_2],
  ["footman","Footman","a footman",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|int_4|cha_4|level(1),wpex(100,100,130,30,50,80),knows_ironflesh_5|knows_power_strike_4|knows_power_throw_2|knows_athletics_5|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["archer","Archer","an archer",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_14|int_4|cha_4|level(1),wpex(90,70,60,150,50,50),knows_ironflesh_4|knows_power_strike_2|knows_power_draw_4|knows_athletics_4|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["crossbowman","Crossbowman","a crossbowman",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_14|int_4|cha_4|level(1),wpex(90,60,60,50,150,50),knows_ironflesh_3|knows_power_strike_3|knows_athletics_4|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ...
  ["man_at_arms","Man at Arms","a man at arms",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|int_4|cha_4|level(1),wpex(105,120,110,30,50,30),knows_ironflesh_4|knows_power_strike_4|knows_athletics_2|knows_riding_4,default_face_1,default_face_2],
  ["sergeant","Sergeant","a sergeant",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|int_4|cha_4|level(1),wpex(110,125,110,30,90,50),knows_ironflesh_5|knows_power_strike_4|knows_athletics_5|knows_riding_2,default_face_1,default_face_2],
  ...
  ["doctor","Doctor","a doctor",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_10|int_4|cha_4|level(1),wpex(70,50,50,10,20,20),knows_athletics_2|knows_power_strike_1|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
  ...
  ["lord","Lord","the lord",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_15|int_4|cha_4|level(1),wpex(115,115,115,50,50,50),knows_leadership_1|knows_ironflesh_6|knows_power_strike_3|knows_athletics_2|knows_riding_5,default_face_1,default_face_2],
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_15|agi_12|int_4|cha_4|level(1),wpex(80,80,80,50,50,80),knows_ironflesh_3|knows_power_strike_3|knows_athletics_3|knows_riding_1|knows_looting_2,default_face_1,default_face_2],
  ["brigand","Brigand","a brigand",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_12|agi_12|int_4|cha_4|level(1),wpex(70,60,70,100,80,80),knows_ironflesh_2|knows_power_strike_1|knows_power_draw_3|knows_athletics_3|knows_riding_1|knows_looting_6|knows_sailing_4,default_face_1,default_face_2],
  ["mercenary","Mercenary","a mercenary",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_14|int_4|cha_4|level(1),wpex(90,70,80,60,80,70),knows_ironflesh_3|knows_power_strike_1|knows_athletics_3|knows_riding_2|knows_engineer_1|knows_sailing_3,default_face_1,default_face_2],
