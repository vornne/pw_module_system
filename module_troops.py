...
####################################################################################################################
  ...
  ["master_smith","Master Smith","a master smith",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_padded_coif","itm_common_hood","itm_pelt_coat","itm_leather_jacket","itm_leather_boots","itm_nomad_boots","itm_rusty_sword","itm_worn_sword"],
  ...
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_head_wrappings","itm_nomad_vest","itm_nomad_armor","itm_wrapping_boots","itm_club","itm_spiked_club"],
