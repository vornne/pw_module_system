...
####################################################################################################################
  ...
  ["peasant","Peasant","a peasant",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_8|agi_8|pw_attr,wpex(50,30,30,0,0,30),knows_pw|knows_labouring_2|knows_tailoring_1|knows_riding_1,default_face_1,default_face_2],
  ...
  ["doctor","Doctor","a doctor",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_10|agi_10|pw_attr,wpex(70,40,50,10,20,30),knows_pw|knows_athletics_2|knows_power_strike_1|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
  ...
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_12|pw_attr,wpex(80,65,80,10,20,80),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3|knows_riding_1|knows_looting_2,default_face_1,default_face_2],
  ["brigand","Brigand","a brigand",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_knife","itm_blunt_falchion"],
   str_12|agi_12|pw_attr,wpex(70,40,70,100,60,70),knows_pw|knows_ironflesh_2|knows_power_strike_1|knows_power_draw_3|knows_athletics_3|knows_riding_1|knows_looting_6|knows_sailing_4,default_face_1,default_face_2],
