...
scripts = [
   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (try_begin),
          (gt, ":gold_amount", 0),
          (call_script, "script_cf_drop_money_bag", ":sender_player_id", ":gold_amount"),
        (else_try),
          (le, ":gold_amount", 0),
          (store_mul, ":instance_id", ":gold_amount", -1),
          (call_script, "script_cf_can_use_scene_prop", ":sender_player_id", ":instance_id", "spr_pw_money_bag"),
          (player_get_agent_id, ":agent_id", ":sender_player_id"),
          (call_script, "script_cf_use_money_bag", ":agent_id", ":instance_id"),
        (try_end),
      (else_try),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_for_range, ":money_bag_no", 0, ":money_bag_count"),
        ...
        (get_distance_between_positions, ":distance", pos1, pos2),
        (lt, ":distance", 100),
        (scene_prop_get_slot, ":existing_gold", reg0, slot_scene_prop_gold_value),
        (val_add, ":gold_amount", ":existing_gold"),
        (assign, ":money_bag_count", -1),
      (try_end),
      (eq, ":money_bag_count", -1),
    (else_try),
      (copy_position, pos2, pos1),
      (position_move_y, pos2, 50),
      (call_script, "script_reuse_or_spawn_scene_prop", "spr_pw_money_bag"),
  ...
  ("cf_use_money_bag",
   [(store_script_param, ":agent_id", 1),
    ...
    (agent_get_player_id, ":player_id", ":agent_id"),
    (player_is_active, ":player_id"),
    (call_script, "script_remove_scene_prop", ":instance_id"),
    (scene_prop_get_slot, ":gold_amount", ":instance_id", slot_scene_prop_gold_value),
    (gt, ":gold_amount", 0),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_gold_value, 0),
    (player_get_gold, ":player_gold", ":player_id"),
    (val_add, ":player_gold", ":gold_amount"),
    (player_set_gold, ":player_id", ":player_gold", max_correctly_displayed_gold),
    (call_script, "script_agent_play_sound", ":agent_id", "snd_money_received"),
    ]),
