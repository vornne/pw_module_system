...
scripts = [
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (player_set_slot, ":player_id", slot_player_has_faction_chest_key, 0),
          ...
          (else_try),
            ...
            (try_begin),
              ...
              (player_set_slot, ":player_id", slot_player_has_faction_chest_key, 1),
            (else_try),
  ...
  ("initialize_banner_info",
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h16", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h17", 0xFFd3d3cb),
  ...
  ("player_set_lord",
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_range, ":other_player_id", 1, ":max_players"),
      ...
      (player_get_slot, ":has_chest_key", ":other_player_id", slot_player_has_faction_chest_key),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":other_player_id", slot_player_has_faction_chest_key, ":has_chest_key"),
    (try_end),
  ...
  ("cf_faction_admin_action",
   [(store_script_param, ":action", 1),
    ...
    (else_try),
      ...
      (else_try),
        (eq, ":action", faction_admin_action_toggle_player_chest_key),
        (assign, ":key_slot", slot_player_has_faction_chest_key),
      (try_end),
      (gt, ":key_slot", -1),
      (player_is_active, ":value_1"),
      (player_slot_eq, ":value_1", slot_player_faction_id, ":faction_id"),
