    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            (le, reg1, 10),
            (call_script, "script_calculate_agent_riding_difficulty", ":agent_id", ":item_id"),
            (assign, "$g_extra_item_details_cannot_use", reg11),
  ...
  ("setup_agent_for_respawn",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (agent_get_position, pos1, ":agent_id"),
      (set_spawn_position, pos1),
      (store_random_in_range, ":imod", 0, 2),
...
scripts.extend([
  ...
  ("calculate_agent_riding_difficulty",
   [(store_script_param, ":agent_id", 1),
    (store_script_param, ":horse_item_id", 2),

    (item_get_slot, ":difficulty", ":horse_item_id", slot_item_difficulty),
    (assign, ":difficulty_riding", 0),
    (assign, ":cannot_ride", 0),
    (agent_get_troop_id, ":troop_id", ":agent_id"),
    (store_skill_level, ":riding", "skl_riding", ":troop_id"),
    (store_sub, ":level_difference", ":difficulty", ":riding"),
    (try_begin),
      (eq, ":level_difference", 1),
      (assign, ":difficulty_riding", 1),
    (else_try),
      (gt, ":level_difference", 1),
      (assign, ":cannot_ride", 1),
    (try_end),
    (assign, reg10, ":difficulty_riding"),
    (assign, reg11, ":cannot_ride"),
    ]),

  ("check_agent_riding_difficulty",
   [(store_script_param, ":agent_id", 1),
    (store_script_param, ":horse_agent_id", 2),
    (store_script_param, ":mounting", 3),
    ...
    (try_begin),
      ...
      (try_begin),
        (eq, ":mounting", 1),
        (agent_get_item_id, ":horse_item_id", ":horse_agent_id"),
        (call_script, "script_calculate_agent_riding_difficulty", ":agent_id", ":horse_item_id"),
        (agent_set_slot, ":agent_id", slot_agent_difficulty_riding, reg10),
        (try_begin),
          (eq, reg11, 1),
          (call_script, "script_agent_knock_off_horse", ":agent_id", ":horse_agent_id", -1),
        (try_end),
      (else_try),
        (this_or_next|agent_slot_eq, ":agent_id", slot_agent_difficulty_riding, 1),
        (this_or_next|agent_slot_eq, ":agent_id", slot_agent_cannot_attack, 1),
        (agent_slot_ge, ":agent_id", slot_agent_armor_speed_factor, 20),
        (agent_get_speed, pos4, ":agent_id"),
        (position_get_y, ":speed", pos4),
        (gt, ":speed", 200),
        (try_begin),
          (neg|agent_slot_eq, ":agent_id", slot_agent_cannot_attack, 1),
          (store_random_in_range, ":fall_chance", 0, 800),
          (val_add, ":fall_chance", ":speed"),
          (agent_get_slot, ":armor_speed_factor", ":agent_id", slot_agent_armor_speed_factor),
          (val_mul, ":armor_speed_factor", 2),
          (val_add, ":fall_chance", ":armor_speed_factor"),
          (le, ":fall_chance", 1000),
          (assign, ":speed", -1),
        (try_end),
        (neq, ":speed", -1),
        (call_script, "script_agent_knock_off_horse", ":agent_id", ":horse_agent_id", ":speed"),
      (try_end),
    (try_end),
    ]),

  ("agent_knock_off_horse",
   [(store_script_param, ":agent_id", 1),
    (store_script_param, ":horse_agent_id", 2),
    (store_script_param, ":speed", 3),

    (agent_start_running_away, ":horse_agent_id"),
    (agent_get_player_id, ":player_id", ":agent_id"),
    (try_begin),
      (player_is_active, ":player_id"),
    ...
    (else_try),
      (assign, ":sound", "snd_man_hit"),
    (try_end),
    (agent_play_sound, ":agent_id", ":sound"),
    (agent_get_item_id, ":horse_item_id", ":horse_agent_id"),
    (item_get_slot, ":difficulty", ":horse_item_id", slot_item_difficulty),
    (store_mul, ":fall_damage", ":difficulty", 3),
    (val_add, ":fall_damage", 20),
    (try_begin),
      (gt, ":speed", -1),
      (val_mul, ":fall_damage", ":speed"),
      (val_div, ":fall_damage", 400),
    (try_end),
    (agent_deliver_damage_to_agent, ":horse_agent_id", ":agent_id", ":fall_damage"),
    (agent_set_animation, ":agent_id", "anim_fall_off_horse"),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (call_script, "script_check_agent_riding_difficulty", ":agent_id", ":horse_agent_id", 0),
      (try_end),
    (try_end),
    ]),
