...
scripts = [
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (agent_equip_item, ":agent_id", "itm_invisible_head"),
          (else_try),
            (eq, ":item_type", itp_type_hand_armor),
            (agent_equip_item, ":agent_id", "itm_invisible_hand"),
          (try_end),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (ge, ":slot_no", 0),
          (try_begin),
            (le, ":slot_range_end", ":slot_no"),
            (store_add, ":slot_range_end", ":slot_no", 1),
          (try_end),
          (try_for_range, ":current_slot_no", ":slot_no", ":slot_range_end"),
      ...
      (else_try),
        ...
        (store_script_param, "$g_show_inventory_instance_id", 3),
        (try_begin),
      ...
      (else_try),
        ...
        (call_script, "script_chat_add_to_display_buffer", 0xFFFFDD8A),
      (else_try),
        (eq, ":event_type", server_event_local_chat_shout),
        (neg|str_is_empty, s0),
        (display_message, s0, 0xFFFF8C27),
        (call_script, "script_chat_add_to_display_buffer", 0xFFFF8C27),
      (else_try),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (store_div, ":chat_event_param_1", ":chat_event_type", net_chat_param_1_multiplier),
            (val_div, ":chat_event_type", net_chat_type_multiplier),
            (val_and, ":chat_event_type", net_chat_event_mask),
          (else_try),
  ...
  ("cf_execute_command",
   [(store_script_param, ":command", 1),
    ...
    (else_try),
      ...
      (assign, ":value", "$g_kill_commoner_no_loot"),
    (else_try),
      (eq, ":command", command_set_force_default_armor),
      (val_clamp, ":value", 0, 2),
      (assign, "$g_kill_commoner_no_loot", ":value"),
    (else_try),
  ...
  ("initialize_scene_globals",
   [
    ...
    (assign, "$g_loop_player_check_time", 0),
  ...
  ("chat_add_to_display_buffer",
   [(store_script_param, ":color", 1),

    (val_add, "$g_chat_overlay_ring_buffer_stored", 1),
    (try_begin),
      (neg|is_between, "$g_chat_overlay_ring_buffer_stored", chat_overlay_ring_buffer_begin, chat_overlay_ring_buffer_end),
      (assign, "$g_chat_overlay_ring_buffer_stored", chat_overlay_ring_buffer_begin),
    (try_end),
    (str_store_string, "$g_chat_overlay_ring_buffer_stored", s0),
    (store_sub, ":color_slot", "$g_chat_overlay_ring_buffer_stored", chat_overlay_ring_buffer_begin),
    (val_add, ":color_slot", slot_last_chat_message_buffer_color_begin),
    (troop_set_slot, "trp_last_chat_message", ":color_slot", ":color"),
    ]),
  ...
  ("initialize_banner_info",
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h08", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_h09", 0xFFd3d3cb),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (try_begin),
                (eq, ":wielded_item", ":item_id"),
                (agent_get_ammo, ":store_item_ammo", ":agent_id", 1),
                (gt, ":store_item_ammo", 0),
              (else_try),
                (assign, ":store_item_id", 0),
              (try_end),
            (try_end),
  ...
  ("player_get_spawn_point",
   [(store_script_param, ":player_id", 1),
    ...
    (try_end),
    (player_get_slot, ":requested_spawn_point", ":player_id", slot_player_requested_spawn_point),
    (try_begin),
      (is_between, ":requested_spawn_point", 1, 6),
      (val_sub, ":requested_spawn_point", 1),
      (store_add, reg0, ":entry_point_begin", ":requested_spawn_point"),
  ...
  ("player_check_stored_values",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (store_add, ":temp_index", ":player_index", player_array_outlaw_rating),
      (troop_set_slot, "trp_active_players_array", ":temp_index", ":outlaw_rating"),
  ...
  ("setup_player_joined",
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_range, ":faction_id", factions_begin, factions_end),
      ...
      (multiplayer_send_3_int_to_player, ":player_id", server_event_faction_set_slot, ":faction_id", slot_faction_is_active, 1),
    ...
    (try_begin),
      ...
      (store_add, ":temp_index", ":active_index", player_array_outlaw_rating),
      (troop_get_slot, ":outlaw_rating", "trp_active_players_array", ":temp_index"),
    ...
    (else_try),
      ...
      (store_random_in_range, ":starting_gold", 30, 100),
      (val_mul, ":starting_gold", "$g_starting_gold_multiplier"),
      (val_div, ":starting_gold", 100),
      (call_script, "script_player_adjust_gold", ":player_id", ":starting_gold", 0),
    (try_end),
    (try_for_range, ":other_player_id", 1, ":max_players"),
      (neq, ":other_player_id", ":player_id"),
      (player_is_active, ":other_player_id"),
  ...
  ("apply_consequences_for_agent_death",
   [(store_script_param, ":dead_agent_id", 1),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (display_message, "str_s0_killed_faction_member", 0xFFAA0000),
          (try_end),
        (else_try),
    ...
    (try_begin),
      ...
      (try_begin),
        (multiplayer_is_server),
        (this_or_next|eq, "$g_kill_commoner_no_loot", 0),
  ...
  ("player_drop_loot",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_end),
    (try_end),
    (assign, ":armor_value", 0),
    (try_for_range, ":player_slot", slot_player_equip_head, slot_player_equip_gloves + 1),
      (player_get_slot, ":item_id", ":player_id", ":player_slot"),
      (ge, ":item_id", all_items_begin),
      (store_item_value, ":value", ":item_id"),
      (val_add, ":armor_value", ":value"),
    (try_end),
    (try_begin),
      (gt, ":armor_value", 0),
    ...
    (try_begin),
      ...
      (agent_get_position, pos1, ":agent_id"),
      (call_script, "script_set_random_spawn_position", 50),
      (spawn_item, "itm_money_bag", 0, seconds_before_removing_dropped_item),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (gt, ":agent_id", -1),
        (agent_is_alive, ":agent_id"),
        (call_script, "script_agent_play_sound", ":agent_id", ":sound"),
      (try_end),
    (try_end),
    ]),
  ...
  ("redraw_castle_banners",
   [(store_script_param, ":castle_no", 1),
    ...
    (try_for_range, ":pole_no", 0, ":pole_count"),
      ...
      (assign, ":faction_id", reg0),
      (is_between, ":faction_id", castle_factions_begin, factions_end),
      (faction_get_slot, ":current_banner_items_begin", ":faction_id", slot_faction_castle_banner_type_begin),
      (try_begin),
        (eq, ":current_banner_items_begin", "itm_pw_banner_castle_fac_1b"),
        (assign, ":banner_items_begin", "itm_pw_banner_castle_fac_1a"),
      (else_try),
        (assign, ":banner_items_begin", "itm_pw_banner_castle_fac_1b"),
      (try_end),
      (try_begin),
        (eq, ":castle_no", -1),
        (faction_set_slot, ":faction_id", slot_faction_castle_banner_type_begin, ":banner_items_begin"),
      (else_try),
        (faction_set_slot, ":faction_id", slot_faction_castle_banner_type_begin, ":current_banner_items_begin"),
      (try_end),
      (store_sub, ":flag_item_id", ":faction_id", castle_factions_begin),
      (val_add, ":flag_item_id", ":banner_items_begin"),
    ...
    (try_begin),
      ...
      (try_for_range, ":other_player_id", 1, ":num_players"),
        ...
        (try_begin),
          ...
          (multiplayer_send_3_int_to_player, ":other_player_id", server_event_player_set_slot, ":player_id", slot_player_faction_id, ":faction_id"),
        (else_try),
          (multiplayer_send_4_int_to_player, ":other_player_id", server_event_player_set_slot, ":player_id", slot_player_faction_id, ":faction_id", ":outlawed"),
        (try_end),
      (try_end),
      (player_set_slot, ":player_id", slot_player_is_lord, 0),
      (player_get_unique_id, ":unique_id", ":player_id"),
  ...
  ("cf_change_faction",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      (assign, ":loop_end", slot_mission_data_castle_owner_faction_end),
      (try_for_range, ":castle_no", slot_mission_data_castle_owner_faction_begin, ":loop_end"),
        (store_add, ":castle_is_active_slot", slot_mission_data_castle_is_active_begin, ":castle_no"),
    ...
    (else_try),
      (assign, ":fail", 1),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_preset_message, "str_s1_doesnt_need_merc", preset_message_faction|preset_message_fail_sound, reg0),
    (try_end),
    (eq, ":fail", 0),
    (try_begin),
      (call_script, "script_cf_can_change_faction", ":player_id", ":faction_id"),
      (call_script, "script_change_faction", ":player_id", ":faction_id", 0),
    (else_try),
      (assign, ":fail", 1),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (gt, ":new_leadership", 0),
        (store_skill_level, ":old_leadership", "skl_leadership", ":player_troop_id"),
        (eq, ":old_leadership", 0),
        (player_set_slot, ":player_id", slot_player_non_lord_troop_id, ":player_troop_id"),
      (try_end),
  ...
  ("check_on_item_picked_up",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_end),
    (else_try),
      (eq, ":item_id", "itm_invisible_sword"),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (try_for_range, ":count", 1, 4),
            ...
            (store_mul, ":trunk_distance", ":count", 200),
      ...
      (try_begin),
        ...
        (try_for_range, ":unused", 0, ":resource_count"),
          ...
          (spawn_item, ":resource_item_id", ":resource_imod", seconds_before_removing_dropped_item),
        (try_end),
        (assign, ":break_effect", 1),
      (try_end),
    (else_try),
  ...
  ("add_resource_to_regrow_list",
   [(store_script_param, ":instance_id", 1),
    ...
    (store_add, ":loop_end", ":resources_count", slot_removed_resources_begin),
    (try_for_range, ":resource_slot", slot_removed_resources_begin, ":loop_end"),
    ...
    (try_begin),
      ...
      (troop_set_slot, "trp_removed_scene_props", slot_removed_resources_count, ":resources_count"),
    (try_end),
    ]),
  ...
  ("spawn_processed_resources",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_for_range, ":unused", 0, ":processed_item_count"),
      (set_spawn_position, pos1),
      (spawn_item, ":processed_item_id", 0, seconds_before_removing_dropped_item),
  ...
  ("cf_process_wood",
   [(store_script_param, ":agent_id", 1),
    ...
    (call_script, "script_agent_play_sound", ":agent_id", "snd_saw_wood"),
    ]),
  ...
  ("cf_process_iron",
   [(store_script_param, ":agent_id", 1),
    ...
    (call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", ":processed_item_count"),
    (call_script, "script_agent_play_sound", ":agent_id", "snd_blacksmith"),
    ]),
  ...
  ("cf_use_resource_stockpile",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      (assign, ":fail", 1),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_agent_play_sound, net_sound_mask, "snd_failure"),
    (try_end),
    (eq, ":fail", 0),
  ...
  ("cf_use_item_stockpile",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (store_mul, ":gold_reward", ":skill_required", craft_skill_reward_gold_multiplier),
      (try_begin),
  ...
  ("cf_hit_door",
   [(multiplayer_is_server),
    ...
    (try_end),
    (call_script, "script_cf_hit_repairable_scene_prop", ":instance_id", ":hit_damage", ":full_hit_points", destroy_scene_prop_hit_points, ":resource_class", ":agent_id", ":repair_active", 0),
    (assign, ":result", reg0),
    (try_begin),
  ...
  ("cf_use_rotate_door",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (else_try),
        (assign, ":fail", 1),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_preset_message, "str_door_bolted", preset_message_error, ":faction_id"),
      (try_end),
    (else_try),
      (neq, ":faction_id", "fac_commoners"),
      (neq, ":faction_id", ":player_faction_id"),
  ...
  ("cf_hit_chest",
   [(multiplayer_is_server),
    ...
    (call_script, "script_cf_hit_repairable_scene_prop", ":instance_id", ":hit_damage", ":full_hit_points", destroy_scene_prop_hit_points, item_class_wood, ":agent_id", 1, 0),
    (assign, ":result", reg0),
    (try_begin),
      (eq, ":result", repairable_hit),
      (call_script, "script_hit_scene_prop_play_sound", ":agent_id", ":instance_id", "snd_shield_hit_wood_metal"),
  ...
  ("cf_pick_lock",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (gt, ":wielded_item_id", -1),
      (item_get_slot, ":wielded_item_class", ":wielded_item_id", slot_item_class),
      (eq, ":wielded_item_class", item_class_lock_pick),
      (agent_get_troop_id, ":troop_id", ":agent_id"),
    ...
    (else_try),
      (assign, ":fail", 1),
      (call_script, "script_agent_play_sound", ":agent_id", "snd_hit_wood_wood"),
    (try_end),
    (eq, ":fail", 0),
    ]),
  ...
  ("cf_hit_bridge",
   [(multiplayer_is_server),
    ...
    (scene_prop_get_slot, ":full_hit_points", ":instance_id", slot_scene_prop_full_hit_points),
    (call_script, "script_cf_hit_repairable_scene_prop", ":instance_id", ":hit_damage", ":full_hit_points", destroy_scene_prop_hit_points, item_class_wood, ":agent_id", 1, ":script_damage"),
    (assign, ":result", reg0),
    (try_begin),
      (eq, ":result", repairable_hit),
      (particle_system_burst, "psys_dummy_straw", pos1, 30),
  ...
  ("cf_init_wall",
   [(store_script_param, ":instance_id", 1),
    ...
    (prop_instance_set_position, ":instance_id", pos1),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_destroyed),
    (scene_prop_set_slot, ":instance_id", slot_scene_prop_next_resource_hp, destroy_scene_prop_hit_points),
    (scene_prop_set_hit_points, ":instance_id", destroy_scene_prop_hit_points),
    ]),
  ...
  ("cf_use_inventory",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_slot_end"),
      ...
      (else_try),
        (try_begin),
          ...
          (multiplayer_send_4_int_to_player, ":player_id", server_event_scene_prop_set_slot, ":instance_id", ":slot_range_begin", ":item_id", ":inventory_slot"),
          (assign, ":slot_range_begin", -1),
        (else_try),
    ...
    (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
      (agent_get_item_slot, ":item_id", ":agent_id", ":equip_slot"),
      (val_max, ":item_id", 0),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", ":player_slot", ":item_id"),
      (val_add, ":player_slot", 1),
    (try_end),
  ...
  ("cf_use_cart",
   [(store_script_param, ":agent_id", 1),
    ...
    (position_get_y, ":relative_y_position", pos3),
    (try_begin),
      (neg|is_between, ":relative_y_position", -100, 100),
      (call_script, "script_cf_use_inventory", ":agent_id", ":instance_id"),
    (else_try),
      (agent_get_horse, ":horse_agent_id", ":agent_id"),
      (try_begin),
        (eq, ":horse", 1),
  ...
  ("cf_attach_cart",
   [(store_script_param, ":attach_agent_id", 1),
    ...
    (try_begin),
      ...
      (call_script, "script_check_agent_horse_speed_factor", ":agent_id", ":attach_agent_id"),
    (try_end),
    ]),
   ...
   [(store_script_param, ":attacked_agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (val_add, ":hit_points", ":damage_dealt"),
        (agent_set_hit_points, ":attacked_agent_id", ":hit_points", 1),
      ...
      (try_end),
    (else_try),
      (eq, ":weapon_item_id", "itm_herb_a"),
      (try_begin),
        (agent_get_troop_id, ":attacker_troop_id", ":attacker_agent_id"),
        (store_skill_level, ":skill_level", "skl_wound_treatment", ":attacker_troop_id"),
        (gt, ":skill_level", 0),
        (call_script, "script_cf_agent_consume_item", ":attacker_agent_id", "itm_herb_a", 1),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          (this_or_next|le, ":poisoner_agent_id", 0),
          (neg|agent_is_active, ":poisoner_agent_id"),
  ...
  ("check_remove_lost_horse",
   [(store_script_param, ":horse_agent_id", 1),
    ...
    (try_begin),
      ...
      (try_end),
      (call_script, "script_check_agent_horse_speed_factor", ":rider_agent_id", ":horse_agent_id"),
    (else_try),
      (gt, ":last_rider", -1),
      (try_begin),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (agent_set_horse_speed_factor, ":agent_id", 50),
        (try_end),
      (else_try),
        (gt, ":drowning_count", 0),
   ...
   [(store_script_param, ":admin_action", 1),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (else_try),
          ...
          (try_begin),
            (gt, ":horse", -1),
            (assign, ":freeze_scene_prop_id", "spr_freeze_horse_agent"),
          (else_try),
            (assign, ":freeze_scene_prop_id", "spr_freeze_agent"),
          (try_end),
          (agent_get_position, pos1, ":agent_id"),
      ...
      (else_try),
        (try_begin),
          ...
          (assign, ":head_item_id", "itm_black_helmet"),
          (assign, ":body_item_id", "itm_black_armor"),
          (assign, ":foot_item_id", "itm_black_greaves"),
          (assign, ":hand_item_id", "itm_gauntlets"),
        (else_try),
          (eq, ":admin_action", admin_action_get_invisible),
          (assign, ":head_item_id", "itm_invisible_head"),
          (assign, ":body_item_id", "itm_invisible_body"),
          (assign, ":foot_item_id", "itm_invisible_foot"),
          (assign, ":hand_item_id", "itm_invisible_hand"),
        (else_try),
          (assign, ":body_item_id", 0),
        (try_end),
        (neq, ":body_item_id", 0),
        (agent_get_item_slot, ":equipped_item_id", ":agent_id", ek_body),
        (try_begin),
          (eq, ":equipped_item_id", ":body_item_id"),
          (player_get_slot, ":head_item_id", ":target_player_id", slot_player_equip_head),
          (val_abs, ":head_item_id"),
          (try_begin),
            (lt, ":head_item_id", all_items_begin),
            (assign, ":head_item_id", "itm_woolen_cap"),
          (try_end),
          (player_get_slot, ":body_item_id", ":target_player_id", slot_player_equip_body),
          (val_abs, ":body_item_id"),
          (player_get_slot, ":foot_item_id", ":target_player_id", slot_player_equip_foot),
          (val_abs, ":foot_item_id"),
          (player_get_slot, ":hand_item_id", ":target_player_id", slot_player_equip_gloves),
          (val_abs, ":hand_item_id"),
          (try_begin),
            (lt, ":hand_item_id", all_items_begin),
            (assign, ":hand_item_id", "itm_leather_gloves"),
          (try_end),
        (else_try),
          (eq, ":admin_action", admin_action_get_invisible),
          (agent_equip_item, ":agent_id", "itm_invisible_sword"),
        (try_end),
        (call_script, "script_change_armor", ":agent_id", ":head_item_id"),
        (call_script, "script_change_armor", ":agent_id", ":body_item_id"),
        (call_script, "script_change_armor", ":agent_id", ":foot_item_id"),
        (call_script, "script_change_armor", ":agent_id", ":hand_item_id"),
      (else_try),
    ...
    (else_try),
      ...
      (try_for_agents, ":horse_agent_id"),
        (agent_get_item_id, ":horse_item_id", ":horse_agent_id"),
        (eq, ":horse_item_id", "itm_test_horse"),
        (agent_get_rider, ":rider_agent_id", ":horse_agent_id"),
        (try_begin),
          (le, ":rider_agent_id", -1),
          (agent_fade_out, ":horse_agent_id"),
    ...
    (else_try),
      ...
      (try_for_range, ":ship_slot", slot_ship_array_begin, ":loop_end"),
        ...
        (scene_prop_get_slot, ":sail_instance_id", ":hull_instance_id", slot_scene_prop_linked_sail_off),
        (try_begin),
          (gt, ":sail_instance_id", -1),
          (prop_instance_set_position, ":sail_instance_id", pos1),
        (try_end),
        (scene_prop_get_slot, ":ramp_instance_id", ":hull_instance_id", slot_scene_prop_linked_ramp),
        (try_begin),
          (gt, ":ramp_instance_id", -1),
