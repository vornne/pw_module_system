   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
        (try_begin),
          (call_script, "script_cf_player_add_equipped_item", ":player_id", ":troop_id", ":equip_slot"),
        (else_try),
          (assign, ":item_id", reg0),
      ...
      (try_end),
      (try_begin),
        (call_script, "script_cf_player_add_equipped_item", ":player_id", ":troop_id", ek_horse),
      (else_try),
        (init_position, pos2),
  ...
  ("player_add_spawn_items",
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_range, ":equip_slot", ek_item_0, ek_horse + 1),
      (player_get_slot, ":item_id", ":player_id", ":player_slot"),
      (val_abs, ":item_id"),
      (player_get_item_id, ":equipped_item_id", ":player_id", ":equip_slot"),
      (try_begin),
        (neq, ":item_id", ":equipped_item_id"),
        (this_or_next|ge, ":item_id", all_items_begin),
        (gt, ":equipped_item_id", -1),
        (try_begin),
          (lt, ":item_id", all_items_begin),
          (try_begin),
            (ge, ":equip_slot", ek_head),
            (store_sub, ":item_id", ":equip_slot", ek_head),
            (val_add, ":item_id", "itm_no_head"),
          (else_try),
            (assign, ":item_id", "itm_no_item"),
          (try_end),
        (try_end),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_player_respawn_in_place", ":player_id"),
        (else_try),
          (player_get_slot, ":spawn_entry", ":player_id", slot_player_spawn_entry_point),
          (player_spawn_new_agent, ":player_id", ":spawn_entry"),
        (try_end),
      (else_try),
        (assign, ":horse_item_id", -1),
      (try_end),
      (neq, ":horse_item_id", "itm_no_horse"),
