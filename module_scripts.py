   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (call_script, "script_chat_add_to_display_buffer", local_chat_color),
      (else_try),
        (eq, ":event_type", server_event_local_chat_shout),
        (neg|str_is_empty, s0),
        (display_message, s0, local_chat_shout_color),
        (call_script, "script_chat_add_to_display_buffer", local_chat_shout_color),
      (else_try),
  ...
  ("chat_add_to_display_buffer",
   [(store_script_param, ":color", 1),
    ...
    (try_begin),
      ...
      (assign, "$g_chat_overlay_ring_buffer_stored", chat_overlay_ring_buffer_begin),
    (try_end),
    (troop_set_name, "$g_chat_overlay_ring_buffer_stored", s0),
    (troop_set_slot, "$g_chat_overlay_ring_buffer_stored", slot_chat_overlay_color, ":color"),
    ]),
