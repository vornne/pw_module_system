...
scripts = [
  ...
  ("cf_check_drop_resource",
   [(store_script_param, ":instance_id", 1),
    ...
    (store_script_param, ":random_adjustment", 3),
  ...
  ("cf_hit_tree",
   [(multiplayer_is_server),
    ...
    (try_begin),
      ...
      (try_end),
      (try_begin),
        (call_script, "script_cf_check_drop_resource", ":instance_id", ":hit_points_for_resource", 0),
  ...
  ("cf_hit_regrowing_resource",
   [(multiplayer_is_server),
    ...
    (try_begin),
      ...
      (else_try),
        (call_script, "script_cf_check_drop_resource", ":instance_id", ":hit_points_for_resource", ":random_hit_points_adjustment"),
        (assign, ":resource_count", reg0),
        (try_for_range, ":unused", 0, ":resource_count"),
          (try_begin),
