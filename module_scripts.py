   ...
   [(store_script_param, ":instance_id", 1),
    ...
    (try_begin),
      ...
      (try_for_agents, ":agent_id"),
        ...
        (get_distance_between_positions, ":distance", pos60, pos61),
        (le, ":distance", max_distance_to_play_sound),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_scene_prop_play_sound, ":instance_id", ":sound_id"),
      (try_end),
    (try_end),
    ]),
  ...
  ("play_sound_at_position",
   [(store_script_param, ":sound_id", 1),
    ...
    (try_for_agents, ":agent_id"),
      ...
      (le, ":distance", max_distance_to_play_sound),
      (multiplayer_send_4_int_to_player, ":player_id", server_event_play_sound_at_position, ":sound_id", ":pos_x", ":pos_y", ":pos_z"),
    (try_end),
    ]),
