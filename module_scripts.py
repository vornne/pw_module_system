...
scripts = [
  ...
  ("initialize_banner_info",
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j17", 0xFFb5b6ad),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j18", 0xFF812528),
