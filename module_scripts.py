...
scripts = [
  ...
  ("cf_player_add_default_troop_item",
   [(store_script_param, ":player_id", 1),
    ...
    (store_script_param, ":use_current", 5),

    (try_begin),
      (eq, ":use_current", 1),
      (player_get_item_id, ":item_id", ":player_id", ":equip_slot"),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (player_add_spawn_item, ":player_id", ":equip_slot", reg0),
      (else_try),
        (assign, ":fail", 1),
      (try_end),
    (try_end),
  ...
  ("player_add_default_troop_items",
   [(store_script_param, ":player_id", 1),
    ...
    (store_script_param, ":use_current", 3),

    (try_begin),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_0, ":troop_id", slot_troop_equipment_one_hand_begin, ":use_current"),
    (else_try),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_0, ":troop_id", slot_troop_equipment_two_hand_begin, ":use_current"),
    (else_try),
      (eq, ":use_current", 0),
      (player_add_spawn_item, ":player_id", ek_item_0, "itm_no_item"),
    (try_end),
    (try_begin),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_1, ":troop_id", slot_troop_equipment_shield_begin, ":use_current"),
    (else_try),
      (eq, ":use_current", 0),
      (player_add_spawn_item, ":player_id", ek_item_1, "itm_no_item"),
    (try_end),
    (assign, ":ranged_item_type", itp_type_thrown),
    (try_begin),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_2, ":troop_id", slot_troop_equipment_ranged_begin, ":use_current"),
      (item_get_type, ":ranged_item_type", reg0),
      (try_begin),
        (neq, ":ranged_item_type", itp_type_thrown),
        (try_begin),
          (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_3, ":troop_id", slot_troop_equipment_ammo_begin, ":use_current"),
          (assign, ":ammo_item", reg0),
          ...
          (try_for_range, ":ammo_slot", slot_troop_equipment_ammo_begin + 1, ":ammo_slot_end"),
            ...
            (try_begin),
              ...
              (player_add_spawn_item, ":player_id", ek_item_3, ":ammo_item"),
        ...
        (else_try),
          (eq, ":use_current", 0),
          (player_add_spawn_item, ":player_id", ek_item_3, "itm_no_item"),
        (try_end),
      (try_end),
    (else_try),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_item_2, ":troop_id", slot_troop_equipment_two_hand_begin, ":use_current"),
    (else_try),
      (eq, ":use_current", 0),
      (player_add_spawn_item, ":player_id", ek_item_2, "itm_no_item"),
    (try_end),
    (try_begin),
      (eq, ":use_current", 0),
    ...
    (try_end),
    (try_begin),
      (call_script, "script_cf_player_add_default_troop_item", ":player_id", ek_horse, ":troop_id", slot_troop_equipment_horse_begin, ":use_current"),
    (else_try),
      (eq, ":use_current", 0),
      (player_get_item_id, ":item_id", ":player_id", ek_horse),
      (ge, ":item_id", all_items_begin),
      (player_add_spawn_item, ":player_id", ek_horse, "itm_no_horse"),
    (try_end),
    ]),
  ...
  ("player_add_default_troop_armor",
   [(store_script_param, ":player_id", 1),
    ...
    (assign, ":player_slot", slot_player_default_armor_head),
    (assign, ":bought_slot", slot_player_bought_armor_head),
    (try_for_range, ":equip_slot", ek_head, ek_gloves + 1),
      (try_begin),
        (this_or_next|eq, ":use_current", 0),
        (neg|player_slot_ge, ":player_id", ":bought_slot", all_items_begin),
        (try_begin),
          (call_script, "script_cf_troop_get_random_equipment", ":troop_id", ":troop_slot"),
          (player_add_spawn_item, ":player_id", ":equip_slot", reg0),
        ...
        (else_try),
          (eq, ":use_current", 0),
          (store_sub, ":invalid_item_id", ":equip_slot", ek_head),
          (val_add, ":invalid_item_id", "itm_no_head"),
          (player_add_spawn_item, ":player_id", ":equip_slot", ":invalid_item_id"),
        (try_end),
      (try_end),
      (val_add, ":troop_slot", troop_slot_count_per_equipment_type),
      (val_add, ":player_slot", 1),
      (val_add, ":bought_slot", 1),
    (try_end),
    ]),

  ("player_add_stored_default_troop_armor",
   [(store_script_param, ":player_id", 1),

    (assign, ":player_slot", slot_player_default_armor_head),
    (try_for_range, ":equip_slot", ek_head, ek_gloves + 1),
      (player_get_slot, ":default_item_id", ":player_id", ":player_slot"),
      (val_add, ":player_slot", 1),
      (ge, ":default_item_id", all_items_begin),
      (player_add_spawn_item, ":player_id", ":equip_slot", ":default_item_id"),
    (try_end),
    ]),

  ("player_add_current_spawn_items",
   [(store_script_param, ":player_id", 1),
    (store_script_param, ":troop_id", 2),
    ...
    (try_begin),
      ...
      (try_for_range, ":equip_slot", ek_item_0, ek_item_3 + 1),
        ...
        (else_try),
          (player_add_spawn_item, ":player_id", ":equip_slot", "itm_no_item"),
          (spawn_item, ":item_id"),
        (try_end),
      (try_end),
      (try_begin),
        ...
        (try_end),
      (try_end),
      (assign, ":bought_armor_slot", slot_player_bought_armor_head),
      (try_for_range, ":equip_slot", ek_head, ek_gloves + 1),
        (player_get_slot, ":item_id", ":player_id", ":bought_armor_slot"),
        (val_add, ":bought_armor_slot", 1),
        (ge, ":item_id", all_items_begin),
        (try_begin),
          (call_script, "script_cf_check_troop_can_equip_item", ":troop_id", ":item_id"),
        ...
        (else_try),
          (store_sub, ":invalid_item_id", ":equip_slot", ek_head),
          (val_add, ":invalid_item_id", "itm_no_head"),
          (player_set_slot, ":player_id", ":bought_armor_slot", ":invalid_item_id"),
        (try_end),
      (try_end),
      (assign, ":use_current", 1),
    (else_try),
      (assign, ":use_current", 0),
    (try_end),
    (call_script, "script_player_add_default_troop_items", ":player_id", ":troop_id", ":use_current"),
    (call_script, "script_player_add_default_troop_armor", ":player_id", ":troop_id", ":use_current"),
    ]),
  ...
  ("player_respawn_in_place",
   [(store_script_param, ":player_id", 1),
    ...
    (try_end),
    (player_set_slot, ":player_id", slot_player_spawn_at_marker, 1),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          (player_slot_eq, ":player_id", slot_player_spawn_at_marker, 0),
          (neg|player_is_busy_with_menus, ":player_id"),
          (call_script, "script_player_add_default_troop_armor", ":player_id", ":troop_id", 0),
          (player_spawn_new_agent, ":player_id", 0),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (call_script, "script_player_add_default_troop_items", ":player_id", ":troop_id", 0),
  ...
  ("agent_clear_bought_armor",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (agent_get_player_id, ":player_id", ":agent_id"),
      (player_is_active, ":player_id"),
      (try_for_range, ":bought_armor_slot", slot_player_bought_armor_head, slot_player_bought_armor_gloves + 1),
        (player_set_slot, ":player_id", ":bought_armor_slot", 0),
      (try_end),
    (try_end),
    ]),
  ...
  ("setup_player_joined",
   [(store_script_param, ":player_id", 1),
    ...
    (player_set_team_no, ":player_id", team_active_players),
  ...
  ("cf_change_troop",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (call_script, "script_player_add_current_spawn_items", ":player_id", ":troop_id"),
      (player_set_troop_id, ":player_id", ":troop_id"),
      (call_script, "script_player_respawn_in_place", ":player_id", ":agent_id"),
    (try_end),
    ]),
  ...
  ("cf_change_armor",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (val_add, ":player_slot", slot_player_bought_armor_head),
