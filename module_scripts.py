  ...
  ("cf_hit_bridge", # server: handle damaging and repairing bridges; should be called from ti_on_scene_prop_hit
   [(multiplayer_is_server),
    ...
    (else_try),
      ...
      (try_begin),
        (gt, ":distance", 0),
        (store_div, ":animation_time", ":distance", 4),
        (val_mul, ":distance", -1),
        (position_move_z, pos2, ":distance"),
      (else_try),
        (position_get_z, ":animation_time", pos2),
        (store_sub, ":animation_time", z_position_to_hide_object, ":animation_time"),
        (val_div, ":animation_time", 4),
