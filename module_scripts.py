...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_k06", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_k07", 0xFFb5b6ad),
