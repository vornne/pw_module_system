   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", client_event_admin_kick_player),
        (try_begin),
          (player_is_admin, ":sender_player_id"),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", client_event_admin_ban_player),
        (try_begin),
          (player_is_admin, ":sender_player_id"),
          (store_script_param, ":target_player_id", 3),
          (store_script_param, ":ban_length", 4),
          (player_is_active, ":target_player_id"),
          (ban_player, ":target_player_id", ":ban_length", ":sender_player_id"),
        (try_end),
      (else_try),
