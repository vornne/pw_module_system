...
scripts = [
   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", client_event_change_faction_banner),
        (store_script_param, ":banner_mesh", 3),
        (try_begin),
          ...
          (try_for_range, ":other_faction_id", factions_begin, ":loop_end"),
            (faction_slot_eq, ":other_faction_id", slot_faction_banner_mesh, ":banner_mesh"),
            (assign, ":loop_end", -1),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", client_event_spectate),
  ...
  ("cf_can_change_faction",
   [(store_script_param, ":player_id", 1),
    ...
    (eq, reg1, 0),
    (try_begin),
      (player_slot_ge, ":player_id", slot_player_outlaw_rating, outlaw_rating_outlawed),
