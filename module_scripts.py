  ...
  ("cart_set_detached_position",
   [(store_script_param, ":instance_id", 1),
    ...
    (try_begin),
      ...
      (position_get_distance_to_terrain, ":height", pos2),
      (ge, ":height", 100),
      (val_div, ":height", 3),
      (prop_instance_animate_to_position, ":instance_id", pos2, ":height"),
    (else_try),
      (position_set_z_to_ground_level, pos1),
