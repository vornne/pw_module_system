...
scripts = [
  ...
  ("cf_use_item_stockpile",
   [(store_script_param, ":agent_id", 1),
    (store_script_param, ":instance_id", 2),
    (store_script_param, ":resource_1_item_id", 3),
    (store_script_param, ":resource_2_item_id", 4),
    (store_script_param, ":resource_3_item_id", 5),
    (store_script_param, ":resource_4_item_id", 6),
    ...
    (else_try),
      (assign, ":fail", 1),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_preset_message, "str_wrong_resources", preset_message_yellow|preset_message_fail_sound),
    (try_end),
    (eq, ":fail", 0),
