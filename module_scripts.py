...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l04", 0xFF003279),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l10", 0xFF073400),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l21", 0xFF427079),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m09", 0xFFbabbb2),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m10", 0xFF313031),
  ...
  ("scene_adjust_weather_situation", # server: periodically adjust the position and intensity of weather systems in the scene
   [
    ...
    (try_for_range, ":instance_no", 0, ":num_instances"),
      ...
      (try_begin), # change the acceleration of the precipitation intensity, so it doesn't just fluctuate over a small range
