...
scripts = [
  ...
  ("redraw_castle_banners",
   [(store_script_param, ":redraw_type", 1),
    (try_begin),
      (eq, ":redraw_type", redraw_all_banners),
    (else_try),
    ...
    (try_begin),
      (eq, ":redraw_type", redraw_faction_banners),
      (faction_get_slot, ":banner_variant", ":faction_id", slot_faction_castle_banner_variant),
      (val_add, ":banner_variant", 1),
      (val_mod, ":banner_variant", 2),
      (faction_set_slot, ":faction_id", slot_faction_castle_banner_variant, ":banner_variant"),
    (try_end),
    (try_for_range, ":type", 0, 2),
      (gt, ":redraw_type", -1),
      (try_begin),
        (eq, ":type", 0),
        (assign, ":pole_scene_prop_id", "spr_pw_castle_capture_point"),
        (assign, ":begin_item_id", "itm_pw_banner_castle_fac_1a"),
      (else_try),
        (assign, ":pole_scene_prop_id", "spr_pw_castle_wall_banner"),
        (assign, ":begin_item_id", "itm_pw_banner_wall_fac_1a"),
      (try_end),
