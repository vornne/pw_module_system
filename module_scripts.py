...
scripts = [
   ...
   [(store_script_param, ":instance_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (call_script, "script_scene_prop_get_item_crafting_reward", ":instance_id"),
        (assign, "$g_extra_item_details_2_value", reg0),
        (assign, "$g_extra_item_details_2_string_id", "str_crafting_reward_reg0"),
        (try_begin),
          (gt, "$g_extra_item_details_2_value", 0),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (agent_slot_eq, ":target_agent_id", slot_agent_died_normally, 1),
          (player_get_agent_id, ":agent_id", ":sender_player_id"),
          (agent_is_active, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          ...
          (get_sq_distance_between_positions, ":sq_distance", pos1, pos2),
          (lt, ":sq_distance", sq(max_distance_to_loot)),
  ...
  ("initialize_banner_info",
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j04", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j05", 0xFFb5b6ad),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (try_for_range, ":other_faction_id", castle_factions_begin, ":loop_end"),
        ...
        (eq, ":wielded_item_id", ":banner_item_id"),
        (assign, ":loop_end", -1),
        (assign, ":capture_faction_id", ":other_faction_id"),
      (try_end),
      (eq, ":loop_end", -1),
    (else_try),
      (assign, ":castle_no", -1),
  ...
  ("redraw_castle_banners",
   [(store_script_param, ":redraw_type", 1),
    ...
    (else_try),
      ...
      (is_between, ":castle_or_faction",  slot_mission_data_castle_owner_faction_begin, slot_mission_data_castle_owner_faction_end),
    (else_try),
      (eq, ":redraw_type", redraw_faction_banners),
      (is_between, ":castle_or_faction", castle_factions_begin, factions_end),
    (else_try),
    ...
    (try_begin),
      ...
      (try_end),
      (call_script, "script_redraw_castle_banner_kind", ":redraw_type", ":castle_or_faction", "spr_pw_castle_capture_point", "itm_pw_banner_castle_fac_1a"),
      (call_script, "script_redraw_castle_banner_kind", ":redraw_type", ":castle_or_faction", "spr_pw_castle_wall_banner", "itm_pw_banner_wall_fac_1a"),
    (try_end),
    ]),
  ...
  ("redraw_castle_banner_kind",
   [(store_script_param, ":redraw_type", 1),
    ...
    (try_for_range, ":pole_no", 0, ":pole_count"),
      ...
      (else_try),
        (eq, ":redraw_type", redraw_castle_banners),
        (eq, reg1, ":castle_or_faction"),
      (else_try),
        (eq, ":redraw_type", redraw_faction_banners),
        (eq, reg0, ":castle_or_faction"),
      (else_try),
        (assign, reg1, -1),
      (try_end),
      (gt, reg1, -1),
  ...
  ("cf_sell_horse",
   [(store_script_param, ":agent_id", 1),
    ...
    (call_script, "script_scene_prop_get_gold_value", ":instance_id", ":item_id", 0),
    (store_mul, ":gold_value", reg0, sell_item_gold_multiplier),
    (val_mul, ":gold_value", ":horse_hit_points"),
    (val_div, ":gold_value", 10000),
    (call_script, "script_player_adjust_gold", ":player_id", ":gold_value", 1),
    ]),
  ...
  ("agent_adjust_stats_for_item",
   [(store_script_param, ":agent_id", 1),
    (store_script_param, ":item_id", 2),
    (store_script_param, ":is_wielded", 3),
    #(store_script_param, ":picked_up_or_dropped", 4),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (lt, ":crossbow", 100),
        (agent_set_accuracy_modifier, ":agent_id", ":crossbow"),
        (agent_set_reload_speed_modifier, ":agent_id", ":crossbow"),
      (else_try),
        (eq, ":is_wielded", 0),
        (agent_set_accuracy_modifier, ":agent_id", 100),
        (agent_set_reload_speed_modifier, ":agent_id", 100),
      (try_end),
    (try_end),
    ]),
  ...
  ("scene_prop_adjust_hit",
   [(store_script_param, ":instance_id", 1),
    ...
    (try_begin),
      ...
      (agent_get_slot, ":hunger_factor", ":agent_id", slot_agent_food_amount),
      (store_sub, ":hunger_factor", max_food_amount, ":hunger_factor"),
      (val_mul, ":hunger_factor", ":hardness"),
      (val_mul, ":hunger_factor", ":hit_damage"),
      (val_div, ":hunger_factor", max_food_amount * 10),
  ...
  ("scene_prop_get_item_crafting_reward",
   [(store_script_param, ":instance_id", 1),

    (scene_prop_get_slot, ":item_id", ":instance_id", slot_scene_prop_item_id),
    (call_script, "script_scene_prop_get_gold_value", ":instance_id", ":item_id", 0),
    (store_mul, ":gold_reward", reg0, craft_price_gold_reward_multiplier),
    ...
    (scene_prop_get_slot, ":stock_count", ":instance_id", slot_scene_prop_stock_count),
    (store_sub, ":stock_count_multiplier", ":design_target_stock_count", ":stock_count"),
    (try_begin),
      (gt, ":stock_count_multiplier", 0),
      (val_mul, ":gold_reward", ":stock_count_multiplier"),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (get_sq_distance_between_positions, ":sq_distance", pos1, pos2),
        (le, ":sq_distance", sq(max_distance_to_use + 200)),
      (else_try),
  ...
  ("check_agent_health",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      (agent_is_alive, ":agent_id"),
      (gt, ":poison_amount", 0),
      (store_mul, ":damage", ":poison_amount", 3),
      (val_min, ":damage", 10),
   ...
   [(store_script_param, ":dead_agent_id", 1),
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (val_add, "$g_time_last_herd_animal_disappeared", 35),
        ...
        (try_end),
        (agent_get_slot, ":fed_meat_count", ":dead_agent_id", slot_agent_animal_meat_count),
        (val_add, ":meat_count", ":fed_meat_count"),
        (agent_set_slot, ":dead_agent_id", slot_agent_animal_meat_count, ":meat_count"),
        (agent_set_slot, ":dead_agent_id", slot_agent_animal_hide_count, ":hide_count"),
      (try_end),
    (try_end),
    ]),
  ...
  ("cf_use_butchering_knife",
   [(store_script_param, ":agent_id", 1),
    ...
    (assign, ":found", 0),
    (agent_get_slot, ":carcass_agent_id", ":agent_id", slot_agent_hunting_last_carcass),
    (try_begin),
      (agent_is_active, ":carcass_agent_id"),
      (neg|agent_is_alive, ":carcass_agent_id"),
      (this_or_next|agent_slot_ge, ":carcass_agent_id", slot_agent_animal_meat_count, 1),
      (agent_slot_ge, ":carcass_agent_id", slot_agent_animal_hide_count, 1),
      (agent_get_position, pos2, ":carcass_agent_id"),
      (get_sq_distance_between_positions, ":sq_distance", pos1, pos2),
      (lt, ":sq_distance", sq(max_distance_to_use)),
      (assign, ":found", 1),
    (else_try),
      ...
      (try_for_agents, ":other_agent_id"),
        ...
        (this_or_next|agent_slot_ge, ":other_agent_id", slot_agent_animal_meat_count, 1),
        (agent_slot_ge, ":other_agent_id", slot_agent_animal_hide_count, 1),
        (agent_get_position, pos2, ":other_agent_id"),
        (get_sq_distance_between_positions, ":sq_distance", pos1, pos2),
        (lt, ":sq_distance", sq(max_distance_to_use)),
        (assign, ":found", 1),
        (assign, ":carcass_agent_id", ":other_agent_id"),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_carcass, ":carcass_agent_id"),
      (try_end),
      (try_begin),
        (eq, ":found", 0),
        (agent_set_slot, ":agent_id", slot_agent_hunting_last_carcass, -1),
    ...
    (try_end),
    (eq, ":found", 1),
    (agent_get_slot, ":hide_count", ":carcass_agent_id", slot_agent_animal_hide_count),
    (try_begin),
      (gt, ":hide_count", 0),
      (val_sub, ":hide_count", 1),
      (agent_set_slot, ":carcass_agent_id", slot_agent_animal_hide_count, ":hide_count"),
      (call_script, "script_set_random_spawn_position", 50),
      (spawn_item, "itm_raw_hide", 0, "$g_spawn_item_prune_time"),
    (else_try),
      (agent_get_slot, ":meat_count", ":carcass_agent_id", slot_agent_animal_meat_count),
      (gt, ":meat_count", 0),
      (val_sub, ":meat_count", 1),
      (agent_set_slot, ":carcass_agent_id", slot_agent_animal_meat_count, ":meat_count"),
      (call_script, "script_set_random_spawn_position", 50),
   ...
   [(store_script_param, ":animal_agent_id", 1),
    ...
    (try_for_range, ":unused", 0, ":loop_end"),
      ...
      (try_begin),
        ...
        (try_begin),
          (eq, ":animal_agent_id", ":leader_agent_id"),
          (agent_slot_eq, ":animal_agent_id", slot_agent_animal_times_stuck, 0),
  ...
  ("animal_hit",
   [(store_script_param, ":animal_agent_id", 1),
    ...
    (else_try),
      ...
      (agent_set_slot, ":animal_agent_id", slot_agent_animal_meat_count, 1),
      (assign, ":damage_result", 0),
    (else_try),
   ...
   [(store_script_param, ":attacker_agent_id", 1),
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (store_random_in_range, ":speed", 1, 10),
   ...
   [(store_script_param, ":admin_action", 1),
    ...
    (else_try),
      ...
      (try_for_agents, ":horse_agent_id"),
        ...
        (agent_slot_eq, ":horse_agent_id", slot_agent_animal_grow_time, 0),
        (agent_get_attached_scene_prop, ":attached_instance_id", ":horse_agent_id"),
