...
scripts = [
    ...
    (else_try),
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (try_begin),
              ...
              (call_script, "script_deduct_gold", ":sender_player_id", faction_cost_change_name),
              (faction_set_name, ":faction_id", s0),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (call_script, "script_deduct_gold", ":sender_player_id", faction_cost_change_banner),
      ...
      (else_try),
        ...
        (else_try),
          ...
          (call_script, "script_reward_gold", ":sender_player_id", ":gold_amount"),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (player_set_gold, ":player_id", ":gold", max_correctly_displayed_gold),
      (try_end),
    (try_end),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_reward_gold", ":player_id", ":gold_requested"),
        (try_end),
  ...
  ("cf_drop_money_bag_item",
   [(store_script_param, ":player_id", 1),
    ...
    (call_script, "script_deduct_gold", ":player_id", ":gold_amount"),
    (agent_get_position, pos1, ":agent_id"),
    (init_position, pos2),
  ...
  ("cf_use_item_stockpile",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (call_script, "script_reward_gold", ":player_id", ":gold_reward"),
      (val_add, ":stack_count", 1),
    (else_try),
      (assign, ":fail", 1),
  ...
  ("request_poll",
   [(store_script_param, ":poll_type", 1),
    ...
    (try_begin),
      ...
      (call_script, "script_deduct_gold", ":requester_player_id", ":gold_cost"),
