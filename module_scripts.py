...
scripts = [
  ...
  ("cf_use_ship_climb_side",
   [(store_script_param, ":agent_id", 1),
    ...
    (store_mul, ":neg_width", ":hull_width", -1),
    (neg|is_between, ":relative_y", ":neg_width", ":hull_width"),
    (try_begin),
      (lt, ":relative_y", 0),
      (assign, ":hull_width", ":neg_width"),
    (try_end),
   ...
   [(store_script_param, ":hull_instance_id", 1),
    ...
    (else_try),
      ...
      (try_for_range, ":ship_array_slot", 1, ":ship_array_end"),
        ...
        (try_end),
        (eq, ":continue", 1),
        (prop_instance_intersects_with_prop_instance, ":hull_instance_id", ":other_hull_instance_id"),
        (assign, ":crashed", 1),
      (try_end),
