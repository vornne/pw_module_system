...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l16", 0xFF7d0404),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l17", 0xFF2d5b01),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l18", 0xFF313031),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l19", 0xFFbabbb2),
