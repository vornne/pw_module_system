...
scripts = [
  ...
  ("initialize_scene_globals",
   [
    ...
    (assign, "$g_loop_plant_to_check", 0),
  ...
  ("player_change_check_outlaw_rating",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      (neq, ":add_rating", 0),
      (val_add, ":outlaw_rating", ":add_rating"),
      (player_set_slot, ":player_id", slot_player_outlaw_rating, ":outlaw_rating"),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_outlaw_rating, ":outlaw_rating"),
    (try_end),
    (try_begin),
  ...
  ("player_drop_loot",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
      ...
      (store_mul, ":gold_loot", ":gold", ":loot_multiplier"),
  ...
  ("cf_hit_tree",
   [(multiplayer_is_server),
    ...
    (store_script_param, ":fell_tree_hit_points", 4),
    (store_script_param, ":hit_points_for_resource", 5),
    (store_script_param, ":hardness", 6),
    (store_script_param, ":resource_imod", 7),
    (store_script_param, ":regrow_interval", 8),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_add_plant_to_regrow_list", ":instance_id", ":regrow_interval"),
        (else_try),
  ...
  ("add_plant_to_regrow_list",
   [(store_script_param, ":instance_id", 1),
    ...
    (troop_get_slot, ":plants_count", "trp_removed_scene_props", slot_removed_plants_count),
    (store_add, ":loop_end", ":plants_count", slot_removed_plants_begin),
    (try_for_range, ":plant_slot", slot_removed_plants_begin, ":loop_end"),
      (neg|troop_slot_ge, "trp_removed_scene_props", ":plant_slot", 1),
      (troop_set_slot, "trp_removed_scene_props", ":plant_slot", ":instance_id"),
      (assign, ":loop_end", -1),
    (try_end),
    (try_begin),
      (neq, ":loop_end", -1),
      (troop_set_slot, "trp_removed_scene_props", ":loop_end", ":instance_id"),
      (val_add, ":plants_count", 1),
      (troop_set_slot, "trp_removed_scene_props", slot_removed_plants_count, ":plants_count"),
    (try_end),
    ]),
  ...
  ("cf_plant_animation_finished",
   [(multiplayer_is_server),
    (store_script_param, ":instance_id", 1),
    (store_script_param, ":full_hit_points", 2),
  ...
  ("cf_hit_plant",
   [(multiplayer_is_server),
    ...
    (store_script_param, ":resource_item_id", 5),
    (store_script_param, ":hardness", 6),
    (store_script_param, ":tool_class", 7),
    (store_script_param, ":skill_id", 8),
    (store_script_param, ":regrow_interval", 9),
    (store_script_param, ":sound_id", 10),

    (scene_prop_get_slot, ":state", ":instance_id", slot_scene_prop_state),
    (try_begin),
      (eq, ":state", scene_prop_state_active),
      (call_script, "script_scene_prop_adjust_hit", ":instance_id", ":hit_damage", ":hardness", ":tool_class", ":skill_id", 21),
      (assign, ":agent_id", reg0),
      (assign, ":hit_damage", reg1),
      (assign, ":hit_points", reg2),
      (try_begin),
      ...
      (try_begin),
        (is_between, ":sound_id", 0, "snd_sounds_end"),
        (call_script, "script_hit_scene_prop_play_sound", ":agent_id", ":instance_id", ":sound_id"),
      (try_end),
    (else_try),
      (assign, ":hit_damage", 0),
      (scene_prop_set_hit_points, ":instance_id", ":full_hit_points"),
  ...
  ("cf_process_iron",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        (eq, ":resource_item_id", "itm_iron_bar_med"),
        (assign, ":processed_item_id", "itm_iron_bar"),
      (else_try),
        (eq, ":resource_item_id", "itm_iron_bar_long"),
        (assign, ":processed_item_id", "itm_iron_bar_med"),
      (try_end),
    (else_try),
   ...
   [(store_script_param, ":attacked_agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (store_agent_hit_points, ":relative_hit_points", ":attacked_agent_id", 0),
        (try_begin),
          (lt, ":relative_hit_points", 50),
          (store_mul, ":healing", ":skill_level", 2),
          (val_add, ":hit_points", ":healing"),
        (try_end),
  ...
  ("check_agent_health",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (gt, ":poison_amount", 0),
      (assign, ":damage", 5),
      (val_div, ":poison_amount", 5),
      (val_add, ":damage", ":poison_amount"),
      (val_min, ":damage", 10),
      (store_agent_hit_points, ":hit_points", ":agent_id", 1),
   ...
   [(store_script_param, ":admin_action", 1),
    ...
    (else_try),
      ...
      (else_try),
        ...
        (call_script, "script_change_armor", ":agent_id", "itm_black_helmet"),
        (call_script, "script_change_armor", ":agent_id", "itm_black_armor"),
        (call_script, "script_change_armor", ":agent_id", "itm_black_greaves"),
        (call_script, "script_change_armor", ":agent_id", "itm_gauntlets"),
      (else_try),
        (eq, ":admin_action", admin_action_get_invisible),
        (call_script, "script_change_armor", ":agent_id", "itm_invisible_head"),
        (call_script, "script_change_armor", ":agent_id", "itm_invisible_body"),
        (call_script, "script_change_armor", ":agent_id", "itm_invisible_foot"),
        (call_script, "script_change_armor", ":agent_id", "itm_invisible_hand"),
      (else_try),
