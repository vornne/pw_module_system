...
scripts = [
  ...
  ("initialize_banner_info",
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j06", 0xFF812528),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j07", 0xFFb5b6ad),
