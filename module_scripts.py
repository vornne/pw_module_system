...
scripts.extend([
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l03", 0xFFbabbb2),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l04", 0xFF313031),
