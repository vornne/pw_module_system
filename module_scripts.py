    ...
    (try_for_range, ":net_no", 0, ":net_num"),
      ...
      (try_for_range, ":school_no", 0, ":loop_end"),
        (try_begin),
          ...
          (scene_prop_get_slot, ":fish_count", ":school_instance_id", slot_scene_prop_stack_count),
          (gt, ":fish_count", 0),
      ...
      (try_begin),
        ...
        (scene_prop_set_slot, ":school_instance_id", slot_scene_prop_stack_count, ":fish_count"),
      (try_end),
    (try_end),
    ]),
