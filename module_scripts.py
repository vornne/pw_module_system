...
scripts = [
  ...
  ("cf_agent_pick_lock",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      (ge, ":random", ":looting"),
      (call_script, "script_agent_play_sound", ":agent_id", "snd_pick_lock_fail"),
    (try_end),
    (lt, ":random", ":looting"),
    ]),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (try_begin),
        ...
        (scene_prop_set_slot, ":linked_door_instance_id", slot_scene_prop_unlocked, 0),
      (try_end),
      (call_script, "script_agent_play_sound", ":agent_id", "snd_lock"),
      (assign, ":fail", 0),
    (try_end),
    (eq, ":fail", 0),
    ]),
  ...
  ("cf_pick_chest_lock",
   [(store_script_param, ":agent_id", 1),
    ...
    (else_try),
      ...
      (call_script, "script_agent_play_sound", ":agent_id", "snd_pick_lock_fail"),
    (try_end),
      (call_script, "script_cf_agent_pick_lock", ":agent_id", 1000),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_unlocked, 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_state, scene_prop_state_destroyed),
      (assign, ":fail", 0),
    (try_end),
