...
scripts = [
  ...
  ("game_get_use_string",
   [(store_script_param, ":instance_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        (neq, ":stock_count_update_time", 0),
        (scene_prop_get_slot, reg1, ":instance_id", slot_scene_prop_stock_count),
        (str_store_string, s0, "str_stock_count_reg1_s0"),
      (try_end),
  ...
  ("initialize_game_rules",
   [(assign, "$g_respawn_period", 5),
    ...
    (troop_set_slot, "trp_militia", slot_troop_spawn_health_percent, 75),
    (troop_set_slot, "trp_huntsman", slot_troop_spawn_health_percent, 75),
    ...
    (troop_set_slot, "trp_footman", slot_troop_spawn_health_percent, 60),
    (troop_set_slot, "trp_archer", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_crossbowman", slot_troop_spawn_health_percent, 55),
    (troop_set_slot, "trp_lancer", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_man_at_arms", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_sergeant", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_engineer", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_master_smith", slot_troop_spawn_health_percent, 40),
    (troop_set_slot, "trp_doctor", slot_troop_spawn_health_percent, 70),
    (troop_set_slot, "trp_sailor", slot_troop_spawn_health_percent, 60),
    (troop_set_slot, "trp_traveler", slot_troop_spawn_health_percent, 70),
    (troop_set_slot, "trp_lord", slot_troop_spawn_health_percent, 35),
    ...
    (troop_set_slot, "trp_mercenary", slot_troop_spawn_health_percent, 90),
  ...
  ("cf_sell_horse",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (get_distance_between_positions, ":distance", pos20, pos21),
      (le, ":distance", max_distance_to_use),
      (assign, ":error_string_id", 0),
      (assign, reg0, 1),
      (player_set_slot, ":player_id", slot_player_last_action_time, ":time"),
  ...
  ("cf_craft_item_stockpile",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (store_sub, ":gold_reward", 100, ":stock_count"),
      (val_clamp, ":gold_reward", 0, 101),
      (val_clamp, ":average_level", 0, 11),
      (val_mul, ":gold_reward", ":average_level"),
  ...
  ("cf_use_fishing_tool",
   [(multiplayer_is_server),
    ...
    (else_try),
      ...
      (try_end),
      (gt, ":num_instances", -1),
      (agent_set_slot, ":agent_id", slot_agent_fishing_last_school, 0),
    (try_end),
    (eq, ":num_instances", -1),
  ...
  ("cf_use_butchering_knife",
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (get_distance_between_positions, ":distance", pos1, pos2),
      (lt, ":distance", max_distance_to_use),
      (assign, ":found", 1),
    (else_try),
      (agent_get_player_id, ":player_id", ":agent_id"),
      (player_is_active, ":player_id"),
   ...
   [(store_script_param, ":animal_agent_id", 1),
    ...
    (try_for_range, ":herd_slot", 0, ":loop_end"),
      ...
      (try_begin),
        ...
        (get_distance_between_positions, ":distance", pos1, pos50),
        (try_begin),
          (le, ":distance", max_distance_to_include_in_herd),
          (assign, ":found_herd", 1),
        (else_try),
          (assign, ":loop_end", -1),
        (try_end),
